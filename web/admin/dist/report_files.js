! function() {
    ...
    1: [function(e, t, a) {
        "use strict";
        var l = e("./lib");
        window.ReportFileAdapter = l.ReportFileAdapter
    }, {
        "./lib": 2
    }],
    2: [function(e, t, a) {
        ...
        var s = function(e) {
            ...
            return function(e, t) {
                ...
                key: "getDataMapping",
                value: function() {
                    return ["id", "icon", "attachment", "employee", "name"]
                }
            }, {
                key: "getHeaders",
                value: function() {
                ...
                value: function(e, t) {
                    var a = '<div style="width:80px;"><img class="tableActionButton" src="_BASE_images/download.png" style="cursor:pointer;" rel="tooltip" title="Download" onclick="download(\'_attachment_\');return false;"></img>_delete_</div>';
                    return a = (a = (a = (a = this.showDelete ? a.replace("_delete_", '<img class="tableActionButton" src="_BASE_images/delete.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Delete" onclick="modJs.deleteRow(_id_);return false;"></img>') : a.replace("_delete_", "")).replace(/_id_/g, e)).replace(/_attachment_/g, t[2])).replace(/_BASE_/g, this.baseUrl)
                }
            }]), t
        }();
        t.exports = {
...
//# sourceMappingURL=report_files.js.map