! function() {
    ...
    1: [function(e, t, a) {
        "use strict";
        var l = e("./lib");
        window.OvertimeCategoryAdapter = l.OvertimeCategoryAdapter, window.EmployeeOvertimeAdminAdapter = l.EmployeeOvertimeAdminAdapter
    }, {
        "./lib": 2
    }],
    2: [function(e, t, a) {
        ...
        var c = function(e) {
            ...
            d = function(e) {
                function t(e, a, l, i) {
                    ...
                    return r.itemName = "OvertimeRequest", r.itemNameLower = "overtimerequest", r.modulePathName = "overtime", r
                }
        ...
        t.exports = {
            OvertimeCategoryAdapter: c,
            EmployeeOvertimeAdminAdapter: d
        }
    }, {
        "../../../api/AdapterBase": 4,
        "../../../api/ApproveAdminAdapter": 5
    }],
    3: [function(e, t, a) {
        "use strict";
        ...
        var s = function(e) {
            ...
            return function(e, t) {
                ...
                value: function(e, t) {
                    ...
                    return a = (a = Object.keys(l).length > 0 ? a.replace("_status_", '<img class="tableActionButton" src="_BASE_images/run.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Change Status" onclick="modJs.openStatus(_id_, \'_cstatus_\');return false;"></img>') : a.replace("_status_", "")).replace("_logs_", '<img class="tableActionButton" src="_BASE_images/log.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="View Logs" onclick="modJs.getLogs(_id_);return false;"></img>'), a = this.showDelete ? a.replace("_delete_", '<img class="tableActionButton" src="_BASE_images/delete.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Delete" onclick="modJs.deleteRow(_id_);return false;"></img>') : a.replace("_delete_", ""), a = (a = (a = (a = this.showEdit ? a.replace("_edit_", '<img class="tableActionButton" src="_BASE_images/edit.png" style="cursor:pointer;" rel="tooltip" title="Edit" onclick="modJs.edit(_id_);return false;"></img>') : a.replace("_edit_", "")).replace(/_id_/g, e)).replace(/_BASE_/g, this.baseUrl)).replace(/_cstatus_/g, t[this.getStatusFieldPosition()])
                }
            }, {
                key: "isSubProfileTable",
                value: function() {
    ...
    7: [function(e, t, a) {
        ...
        var s = function(e) {
            ...
            return function(e, t) {
                ...
                value: function(e) {
                    for (var t = '<table class="table table-condensed table-bordered table-striped" style="font-size:14px;"><thead><tr><th>Notes</th></tr></thead><tbody>_days_</tbody></table> ', a = e.data, l = "", i = "", r = 0; r < a.length; r++) {
                ...
                value: function() {
                    ...
                    if (a.checkValues()) {
                        ...
                        if (this.doCustomFilterValidation(l)) {
                            var r = $("#" + e[0]).val();
                            "" === r && (r = "[]");
                            for (var s = JSON.parse(r), o = {}, u = -1, c = [], d = 0; d < s.length; d++) {
                                var h = s[d];
