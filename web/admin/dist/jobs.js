        ...
        var c = function(e) {
            ...
            d = function(e) {
                ...
                return u(t, n.default), i(t, [{
                    key: "getDataMapping",
                    value: function() {
                        return ["id", "name", "currency", "min_salary", "max_salary"]
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
                    ...
                    value: function() {
                        return [
                            ...
                            ["currency", {
                                label: "Currency",
                                type: "select2",
                                "remote-source": ["CurrencyType", "code", "name"]
                            }],
                            ["min_salary", {
                                label: "Min Salary",
                                type: "text",
                    ...
                    value: function(e) {
                        try {
                            if (parseFloat(e.min_salary) > parseFloat(e.max_salary)) return "Min Salary should be smaller than Max Salary"
                        } catch (e) {}
                        return null
                    }
                }]), t
