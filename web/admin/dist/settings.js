...
})()(
    {
        1: [
            function (e, t, a) {
                "use strict";
                var l = e("./lib");
                window.SettingAdapter = l.SettingAdapter;
            },
            { "./lib": 2 },
        ],
        2: [
                    ...
                    return (
                        ...
                        i(t, [
                            ...
                            },
                            {
                                key: "getHeaders",
                                value: function () {
                                    return [{ sTitle: "ID", bVisible: !1 }, { sTitle: "Name" }, { sTitle: "Value" }, { sTitle: "Details" }];
                                },
                            },
                            {
                                key: "getFormFields",
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    var a = '<div style="width:80px;"><img class="tableActionButton" src="_BASE_images/edit.png" style="cursor:pointer;" rel="tooltip" title="Edit" onclick="modJs.edit(_id_);return false;"></img></div>';
                            ...
                            },
                            {
                                key: "edit",
                                value: function (e) {
                                    this.loadRemoteDataForSettings(), r(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "edit", this).call(this, e);
                                },
                            },
                            {
                                key: "fillForm",
                                value: function (e) {
                                    var a = e[this.getMetaFieldForRendering("value")],
                                        l = null;
                                    "" !== a && void 0 !== a && (l = [["id", { label: "ID", type: "hidden" }], JSON.parse(a)]),
                                        r(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "fillForm", this).call(this, e, null, l),
                                        $("#helptext").html(e.description);
                                },
                            },
                            {
                                ...
                                value: function () {
                                    var e = [],
                                        t = null;
                                    for (var a in (e.push(["country", { label: "Country", type: "select2multi", "remote-source": ["Country", "id", "name"] }]),
                                    e.push(["countryCompany", { label: "Country", type: "select2", "remote-source": ["Country", "code", "name"] }]),
                                    e.push(["currency", { label: "Currency", type: "select2multi", "remote-source": ["CurrencyType", "id", "code+name"] }]),
                                    e.push(["nationality", { label: "Nationality", type: "select2multi", "remote-source": ["Nationality", "id", "name"] }]),
                                    e.push(["supportedLanguage", { label: "Value", type: "select2", "allow-null": !1, "remote-source": ["SupportedLanguage", "name", "description"] }]),
                                    e))
                                        if (void 0 !== (t = e[a])[1]["remote-source"] && null !== t[1]["remote-source"]) {
                                            var l = t[1]["remote-source"][0] + "_" + t[1]["remote-source"][1] + "_" + t[1]["remote-source"][2];
                                            (this.fieldMasterDataKeys[l] = !1), (this.sourceMapping[t[0]] = t[1]["remote-source"]);
                                            var i = { callBack: "initFieldMasterDataResponse" };
                                            (i.callBackData = [l]), this.getFieldValues(t[1]["remote-source"], i);
                                        }
                                },
                            },
                            {
