! function() {
    ...
    1: [function(e, t, a) {
        "use strict";
        var l = e("./lib");
        window.StaffMedicalAdapter = l.StaffMedicalAdapter, window.DependantMedicalAdapter = l.DependantMedicalAdapter
    }, {
        "./lib": 2
    }],
    2: [function(e, t, a) {
        ...
        var c = function(e) {
                ...
                return u(t, n.default), i(t, [{
                    key: "getDataMapping",
                    value: function() {
                        return ["id","employee", "from_date", "to_date", "admission_type", "type_of_illness", "medication_given", "cost", "hospital", "physician", "status"]
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
                    ...
                    value: function() {
                        return [
                            ...
                            [ "admission_type", {
                                ...
                                "allow-null":true,
                                "null-label":"Select", 
                                "source":[["In-Patient","In-Patient"],["Out-Patient","Out-Patient"]]
                            }],
                            [ "type_of_illness", {
                                "label":"Illness Type",
            ...
            d = function(e) {
                ...
                return u(t, n.default), i(t, [{
                    key: "getDataMapping",
                    value: function() {
                        return ["id", "employee", "from_date", "to_date", "dependant_name", "admission_type", "type_of_illness", "medication_given", "cost", "hospital", "physician", "status"]
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
                    ...
                    value: function(e) {
                        return void 0 !== e.status && null !== e.status && "" !== e.status || (e.status = "Approved"), e
                    }
                }, {
                    key: "getHelpLink",
                    value: function() {
        ...
        t.exports = {
            ...
            DependantMedicalAdapter: d,
            EmployeeTrainingSessionAdapter: h
        }
    }, {
        "../../../api/AdapterBase": 4
    }],
