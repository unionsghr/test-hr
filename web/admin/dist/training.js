! function() {
    ...
    1: [function(e, t, a) {
        "use strict";
        var l = e("./lib");
        window.CourseAdapter = l.CourseAdapter, window.TrainingSessionAdapter = l.TrainingSessionAdapter, window.EmployeeTrainingSessionAdapter = l.EmployeeTrainingSessionAdapter
    }, {
        "./lib": 2
    }],
    2: [function(e, t, a) {
        ...
        var c = function(e) {
                ...
                return u(t, n.default), i(t, [{
                    key: "getDataMapping",
                    value: function() {
                        return ["id", "code", "name", "coordinator", "trainer", "paymentType"]
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
                    ...
                    value: function() {
                        return [
                            ...
                            ["currency", {
                                label: "Currency",
                                type: "select2",
                                "remote-source": ["CurrencyType", "code", "code+name"]
                            }],
                            ["cost", {
                                label: "Cost",
                                type: "text",
            ...
            h = function(e) {
                ...
                return u(t, n.default), i(t, [{
                    key: "getDataMapping",
                    value: function() {
                        return ["id", "employee", "trainingSession", "status"]
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
