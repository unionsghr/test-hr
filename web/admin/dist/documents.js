...
})()(
    {
        1: [
            function (e, t, a) {
                "use strict";
                var l = e("./lib");
                (window.DocumentAdapter = l.DocumentAdapter), (window.CompanyDocumentAdapter = l.CompanyDocumentAdapter), (window.EmployeeDocumentAdapter = l.EmployeeDocumentAdapter);
            },
            { "./lib": 2 },
        ],
        2: [
            function (e, t, a) {
                        ...
                        return (
                            ...
                            i(t, [
                                ...
                                },
                                {
                                    key: "getHeaders",
                                    value: function () {
                                        return [{ sTitle: "ID", bVisible: !1 }, { sTitle: "Name" }, { sTitle: "Details" }];
                                    },
                                },
                                {
                                    key: "getFormFields",
                                    value: function () {
                                        return [
                                            ...
                                            [
                                                ...
                                                {
                                                    label: "Notify Expiry Before One Month",
                                                    type: "select",
                                                    source: [
                                                        ["Yes", "Yes"],
                                                        ["No", "No"],
                                            ...
                                            [
                                                ...
                                                {
                                                    label: "Notify Expiry Before One Week",
                                                    type: "select",
                                                    source: [
                                                        ["Yes", "Yes"],
                                                        ["No", "No"],
                                            ...
                                            [
                                                ...
                                                {
                                                    label: "Notify Expiry Before One Day",
                                                    type: "select",
                                                    source: [
                                                        ["Yes", "Yes"],
                                                        ["No", "No"],
                        ...
                        return (
                            ...
                            i(t, [
                                ...
                                },
                                {
                                    key: "getHeaders",
                                    value: function () {
                                        return [{ sTitle: "ID", bVisible: !1 }, { sTitle: "Name" }, { sTitle: "Details" }, { sTitle: "Status" }];
                                    },
                                },
                                {
                                    key: "getFormFields",
                        ...
                        return (
                            ...
                            i(t, [
                                ...
                                },
                                {
                                    key: "getHeaders",
                                    value: function () {
                                        return [{ sTitle: "ID", bVisible: !1 }, { sTitle: "Employee" }, { sTitle: "Document" }, { sTitle: "Details" }, { sTitle: "Date Added" }, { sTitle: "Status" }, { sTitle: "Attachment", bVisible: !1 }];
                                    },
                                },
                                {
                                    key: "getFormFields",
                                ...
                                },
                                {
                                    ...
                                    value: function (e, t) {
                                        ...
                                        return (a = (a = (a = a.replace(/_id_/g, e)).replace(/_attachment_/g, t[6])).replace(/_BASE_/g, this.baseUrl));
                                    },
                                },
                                {
                ...
                t.exports = { DocumentAdapter: c, CompanyDocumentAdapter: d, EmployeeDocumentAdapter: h };
            },
            { "../../../api/AdapterBase": 4 },
        ],
        3: [
                        ...
                        l(t, [
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    ...
                                    (s.key = r), (s.table = e[0]), $.post(this.moduleRelativeURL, { t: e[0], key: e[1], value: e[2], method: l, methodParams: i, a: "getFieldValues" }, s, "json");
                                },
                            },
                            {
                                key: "setAdminProfile",
                                        ...
                                        if (e.hasOwnProperty(u)) {
                                            if (((n = ""), (s = null), "select" === (i = this.getMetaFieldValues(u, o)).type || "select2" === i.type)) {
                                                if (void 0 !== i["remote-source"] && null != i["remote-source"])
                                                    (a = i["remote-source"]),
                                                        "NULL" === e[u] ? (n = void 0 !== i["null-label"] && null != i["null-label"] ? i["null-label"] : "Not Selected") : (s = n = this.fieldMasterData[a[0] + "_" + a[1] + "_" + a[2]][e[u]]);
                                    ...
                                    for (var i = 0; i < a.length; i++)
                                        if ("date" === a[i][1].type) "0000-00-00" !== e[a[i][0]] && "" !== e[a[i][0]] && null != e[a[i][0]] && void 0 !== e[a[i][0]] && $(t + " #" + a[i][0] + "_date").datepicker("setValue", e[a[i][0]]);
                                            ...
                                            if ("0000-00-00 00:00:00" !== e[a[i][0]] && "" !== e[a[i][0]] && null != e[a[i][0]] && void 0 !== e[a[i][0]]) {
                                                ...
                                                $(t + " #" + a[i][0] + "_datetime")
                                                    .data("datetimepicker")
                                                    .setLocalDate(new Date(n[0], parseInt(n[1], 10) - 1, n[2], s[0], s[1], s[2]));
                                            }
