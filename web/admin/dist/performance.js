...
})()(
    {
        1: [
            function (e, t, a) {
                "use strict";
                var l = e("./lib");
                (window.ReviewTemplateAdapter = l.ReviewTemplateAdapter), (window.PerformanceReviewAdminAdapter = l.PerformanceReviewAdminAdapter), (window.ReviewFeedbackAdminAdapter = l.ReviewFeedbackAdminAdapter);
            },
            { "./lib": 2 },
        ],
        2: [
            function (e, t, a) {
                        ...
                        return (
                            ...
                            i(t, [
                                ...
                                },
                                {
                                    key: "getHeaders",
                                    value: function () {
                                        return [{ sTitle: "ID", bVisible: !1 }, { sTitle: "Name" }, { sTitle: "Description" }];
                                    },
                                },
                                {
                                    key: "getFormFields",
                                    value: function () {
                                        return [
                                            ...
                                            ["name", { label: "Name", type: "text", help: "Unique name for the form" }],
                                            ...
                                            [
                                                "items",
                                                {
                                                    ...
                                                    form: [
                                                        ["name", { label: "Question ID", type: "text", validation: "" }],
                                                        ["field_label", { label: "Question", type: "text", validation: "" }],
                                                        [
                                                            "field_type",
                                                            {
                                                                label: "Field Type",
                                                        ...
                                                        ["field_options", { label: "Options", type: "textarea", validation: "none" }],
                                                        ["field_help", { label: "Help", type: "text", validation: "none" }],
                                                    ],
                                                    html:
                                                        '<div id="#_id_#" class="panel panel-default"><div class="panel-heading"><b>#_field_label_#</b> #_delete_##_edit_#</div><div class="panel-body">Type: <b>#_field_type_#</b><br/>Validation: <b>#_field_validation_#</b><br/>Help Text: <b>#_field_help_#</b></div></div>',
                                                    validation: "",
                                                    "custom-validate-function": function (e) {
                                                        var t,
                                                            a = { valid: !0 };
                                                        if (
                                                            ((null !== (t = e.name) && /^[a-z][a-z0-9._]+$/.test(t)) || ((a.message = "Invalid name, should have lower case letters, numbers or _"), (a.valid = !1)),
                                                            ["select", "select2", "select2multi"].indexOf(e.field_type) >= 0 &&
                                                                (("" !== e.field_options && void 0 !== e.field_options && null !== e.field_options) ||
                                                                    ((a.message = "Please type in option to be added to select field. Input one option per line"), (a.valid = !1))),
                                                            ["id", "form", "employee", "status", "created", "updated"].indexOf(e.name) >= 0 && ((a.message = "Selected name is not allowed"), (a.valid = !1)),
                                                            !1 === a.valid)
                                                        )
                                                            return a;
                                                        var l = [e.name],
                                                        ...
                                                        if (
                                                            (l.push({}),
                                                            (l[1].label = e.field_label),
                                                            (l[1].type = e.field_type),
                                                            (l[1].validation = e.field_validation),
                                                            void 0 !== e.field_help && null !== e.field_help && "" !== e.field_help && (l[1].help = e.field_help),
                                                            ["select", "select2", "select2multi"].indexOf(e.field_type) >= 0)
                                                        ) {
                                                            ("" !== e.field_options && void 0 !== e.field_options && null !== e.field_options) ||
                                                                ((a.message = "Please type in option to be added to select field. Input one option per line"), (a.valid = !1));
                                                            var r = [];
                                                            i = e.field_options.split(/\r?\n/);
                                                            for (var n = 0; n < i.length; n++) r.push([i[n], i[n]]);
                                                            l[1].source = r;
                                                        }
                                                        return (null !== e.field_validation && void 0 !== e.field_validation) || ((l[1].validation = ""), (e.field_validation = "")), (e.data = JSON.stringify(l)), (a.params = e), a;
                                                    },
                                                },
                                            ],
                                        ];
                            ...
                            i(t, [
                                {
                                    key: "getDataMapping",
                                    value: function () {
                                        return ["id", "employee", "coordinator", "form", "status", "review_date", "self_assessment_due", "review_period_start", "review_period_end"];
                                    },
                                },
                                {
                                    key: "getHeaders",
                                    value: function () {
                                        return [
                                            { sTitle: "ID", bVisible: !1 },
                                            { sTitle: "Employee" },
                                            { sTitle: "Coordinator" },
                                            { sTitle: "Template" },
                                            { sTitle: "Status" },
                                            { sTitle: "Review Date" },
                                            { sTitle: "Self Assessment Due On" },
                                            { sTitle: "Review Period Start" },
                                            { sTitle: "Review Period End" },
                                        ];
                                    },
                                },
                                {
                                            ...
                                            aoColumnDefs: [
                                                {
                                                    fnRender: function (t, a) {
                                                        return e.preProcessRemoteTableDates(t, a, "MMM d, yyyy HH:mm");
                                                    },
                                                    aTargets: [5],
                                                },
                                                {
                                                    fnRender: function (t, a) {
                                                        return e.preProcessRemoteTableDates(t, a, "MMM d, yyyy");
                                                    },
                                                    aTargets: [6],
                                                },
                                                {
                                ...
                                {
                                    key: "preProcessRemoteTableDates",
                                    value: function (e, t, a) {
                                        return Date.parse(t).toString(a);
                                    },
                                },
                                {
                                    key: "preProcessTableData",
                                    value: function (e) {
                                        return (e[5] = Date.parse(e[5]).toString("MMM d, yyyy HH:mm")), e;
                                    },
                                },
                                {
                                    key: "getFormFields",
                                    value: function () {
                                        return [
                                            ["id", { label: "ID", type: "hidden" }],
                                            ["employee", { label: "Employee", type: "select2", sort: "none", "allow-null": !1, "remote-source": ["Employee", "id", "first_name+last_name", "getActiveSubordinateEmployees"] }],
                                            ["coordinator", { label: "Coordinator", type: "select2", sort: "none", "allow-null": !1, "remote-source": ["Employee", "id", "first_name+last_name"] }],
                                            ["attendees", { label: "Attendees", type: "select2multi", sort: "none", "allow-null": !0, "remote-source": ["Employee", "id", "first_name+last_name"] }],
                                            ["form", { label: "Template", type: "select2", "remote-source": ["ReviewTemplate", "id", "name"] }],
                                            [
                                                "status",
                                                {
                                                    label: "Status",
                                            ...
                                            ["review_date", { label: "Review Date", type: "datetime" }],
                                            ["review_period_start", { label: "Review Period Start Date", type: "date", help: "Start date of the employment period considered for this review" }],
                                            ["review_period_end", { label: "Review Period End Date", type: "date", help: "End date of the employment period considered for this review" }],
                                            ["self_assessment_due", { label: "Self Assessment Due Date", type: "date", help: "Due date for the self assessment" }],
                                            [
                                                "notes",
                                                {
                                                    label: "Notes",
                                                    type: "datagroup",
                                                    form: [["note", { label: "Note", type: "textarea", validation: "" }]],
                                                    html:
                                                        '<div id="#_id_#" class="panel panel-default"><div class="panel-body">#_delete_##_edit_#<span style="color:#999;font-size:13px;font-weight:bold">Date: #_date_#</span><hr/>#_note_#</div></div>',
                                                    validation: "none",
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        return [
                                            ["id", { label: "ID", type: "hidden" }],
                                            ["employee", { label: "Employee", type: "placeholder", sort: "none", "allow-null": !1, "remote-source": ["Employee", "id", "first_name+last_name", "getActiveSubordinateEmployees"] }],
                                            ["coordinator", { label: "Coordinator", type: "placeholder", sort: "none", "allow-null": !1, "remote-source": ["Employee", "id", "first_name+last_name"] }],
                                        ];
                                    },
                                },
                                {
                                    ...
                                    value: function () {
                                        return [
                                            ["employee", { label: "Employee", type: "select2", "allow-null": !0, "null-label": "All Employees", "remote-source": ["Employee", "id", "first_name+last_name"] }],
                                            [
                                                "status",
                                                {
                                                    label: "Status",
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
                                            a = JSON.stringify({ id: e }),
                                            l = [];
                                        (l.callBackData = []),
                                            l.callBackData.push(t),
                                            (l.callBackSuccess = "showConfigViewSuccessCallBack"),
                                            (l.callBackFail = "showConfigViewFailCallBack"),
                                            this.customAction("getFormData", "admin=performance", a, l);
                                    },
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        var t = this.getPlaceHolderFormFields(),
                                            a = [],
                                            l = JSON.parse(e.items);
                                        for (var i in l) a.push(JSON.parse(l[i].data));
                                        return t.concat(a);
                                    },
                                },
                                {
                                    ...
                                    value: function (e, t) {
                                        ...
                                        for (var i = this.templates.formTemplate, r = "", n = this.getMergedConfigFields(e), o = 0; o < n.length; o++) {
                                            a || "hidden" === n[o][1].type || (n[o][1].type = "placeholder");
                                            var s = this.getMetaFieldForRendering(n[o][0]);
                                            if ("" === s || void 0 === s) r += this.renderFormField(n[o]);
                                            else {
                                                var u = l[s];
                                                "" !== u && null != u && "" !== u.trim() ? (r += this.renderFormField(JSON.parse(u))) : (r += this.renderFormField(n[o]));
                                            }
                                        }
                                        i = (i = i.replace(/_id_/g, this.getTableName() + "_submit")).replace(/_fields_/g, r);
                                        var d = void 0,
                                            c = this.generateRandom(14);
                                        this.showFormOnPopup ? (d = $('<div class="reviewBlock popupForm" data-content="Form"></div>')).attr("id", c) : (d = $("#" + this.getTableName() + "Form")),
                                            d.html(i),
                                            d.find(".datefield").datepicker({ viewMode: 2 }),
                                            d.find(".timefield").datetimepicker({ language: "en", pickDate: !1 }),
                                            d.find(".datetimefield").datetimepicker({ language: "en" }),
                                            d.find(".select2Field").each(function () {
                                                $(this).select2().select2("val", $(this).find("option:eq(0)").val());
                                            }),
                                            d.find(".select2Multi").each(function () {
                                                $(this)
                                                    .select2()
                                        ...
                                        for (var h = 0; h < n.length; h++) "datagroup" === n[h][1].type && d.find("#" + n[h][0]).data("field", n[h]);
                                        !1 === this.showSave || !1 === a
                                            ? d.find(".saveBtn").remove()
                                            : (d.find(".saveBtn").off(),
                                              d.find(".saveBtn").data("modJs", this),
                                              d.find(".saveBtn").on("click", function () {
                                                  return $(this).data("modJs").save(), !1;
                                              })),
                                            !1 === this.showCancel
                                                ? d.find(".cancelBtn").remove()
                                                : (d.find(".cancelBtn").off(),
                                                  d.find(".cancelBtn").data("modJs", this),
                                                  d.find(".cancelBtn").on("click", function () {
                                                      return $(this).data("modJs").cancel(), !1;
                                                  })),
                                            this.showFormOnPopup
                                                ? (this.showMessage("Edit", "", null, null, !0), $("#plainMessageModel .modal-body").html(""), $("#plainMessageModel .modal-body").append(d), null != l && this.fillForm(l, "#" + c, n))
                                                : ($("#" + this.getTableName() + "Form").show(), $("#" + this.getTableName()).hide(), null != l && this.fillForm(l, null, n)),
                                            this.postRenderForm(l, d);
                                    },
                                },
                                {
                                    key: "getActionButtonsHtml",
                                    value: function (e, t) {
                                        var a = '<div style="width:140px;">_edit__configure__delete__view__clone_</div>';
                                        return (
                                            (a = a.replace(
                                                "_view_",
                                                '<img class="tableActionButton" src="_BASE_images/view.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Fill Form" onclick="modJs.viewFullPerformanceReview(\'_id_\');return false;"></img>'
                                            )),
                                            (a = this.showAddNew
                                                ? a.replace(
                                                      "_clone_",
                                            ...
                                            (a = this.showDelete
                                                ...
                                                : a.replace("_delete_", "")),
                                            (this.showConfigure = !0),
                                            (a = this.showConfigure
                                                ? a.replace(
                                                      "_configure_",
                                                      '<img class="tableActionButton" src="_BASE_images/run.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Fill Form" onclick="modJs.showConfigView(\'_id_\');return false;"></img>'
                                                  )
                                                : a.replace("_configure_", "")),
                                            (a = (a = (a =
                                                (this.showEdit && "Admin" === this.user.user_level) || (this.showEdit && "Completed" !== t[3])
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        var a = JSON.stringify(t),
                                            l = [];
                                        (l.callBackData = []),
                                            (l.callBackSuccess = "viewFullPerformanceReviewSuccessCallback"),
                                            (l.callBackFail = "viewFullPerformanceReviewFailCallback"),
                                            this.customAction("viewFullPerformanceReview", "admin=performance", a, l);
                                    },
                                },
                                {
                                    key: "viewFullPerformanceReviewSuccessCallback",
                                    value: function (e) {
                                        this.renderPerformanceReview(e);
                                    },
                                },
                                {
                                    key: "viewFullPerformanceReviewFailCallback",
                                    value: function (e) {
                                        this.showMessage("Error occurred while getting performance review", e);
                                    },
                                },
                                {
                                    key: "renderPerformanceReview",
                                    value: function (e) {
                                        var t = e[0],
                                            a = e[1],
                                            l = this.getCustomTemplate("performanceReview.html");
                                        (l = l.replace(/_id_/g, t.id)),
                                            $("#" + this.getTableName() + "Form").html(l),
                                            $("#" + this.getTableName() + "Form #name").html(t.employee_Name),
                                            (this.currentUserId = t.employee),
                                            $("#" + this.getTableName() + "Form #profile_image_" + t.id).attr("src", t.image),
                                            $("#" + this.getTableName() + "Form #coordinator").html(t.coordinator_Name),
                                            $("#" + this.getTableName() + "Form #period").html(Date.parse(t.review_period_start).toString("MMM d, yyyy") + "/" + Date.parse(t.review_period_end).toString("MMM d, yyyy")),
                                            $("#" + this.getTableName() + "Form #review_date").html(Date.parse(t.review_date).toString("MMM d, yyyy HH:mm")),
                                            $("#" + this.getTableName() + "Form #status").html(t.status);
                                        var i = "";
                                        for (var r in t.questions) {
                                            "" !== i && (i += "<hr/>");
                                            var n = "<h5><b>#_question_#</b></h5><h5>#_answer_#</h5>";
                                            i += n = (n = n.replace("#_question_#", r)).replace("#_answer_#", t.questions[r]);
                                        }
                                        $("#selfAssessmentQuestions").html(i);
                                        var o = "";
                                        for (var s in a) {
                                            var u = a[s],
                                                d =
                                                    '<div class="row" style="margin-left:10px;margin-top:20px;"><div class="panel panel-default" style="width:97.5%;"><div class="panel-heading"><h4>#_title_#</h4></div><div class="panel-body">#_questions_#</div></div></div>';
                                            for (var c in ((d = d.replace("#_title_#", this.gt("Feedback"))), (i = ""), u.questions)) {
                                                "" !== i && (i += "<hr/>");
                                                var h = "<h5><b>#_question_#</b></h5><h5>#_answer_#</h5>";
                                                i += h = (h = h.replace("#_question_#", c)).replace("#_answer_#", u.questions[c]);
                                            }
                                            o += d = d.replace("#_questions_#", i);
                                        }
                                        $("#tabPageFeedback").html(o);
                                        var f = "";
                                        for (var p in t.notes) {
                                            "" !== f && (f += "<hr/>");
                                            var m = "<h5>#_note_#</h5>";
                                            f += m = m.replace("#_note_#", t.notes[p].note);
                                        }
                                        "" !== f ? $("#reviewNotes").html(f) : $("#reviewNotes").hide(), $("#" + this.getTableName() + "Form").show(), $("#" + this.getTableName()).hide();
                                    },
                                },
                                {
                            ...
                            i(t, [
                                {
                                    key: "getDataMapping",
                                    value: function () {
                                        return ["id", "review", "employee", "form", "status"];
                                    },
                                },
                                {
                                    key: "getHeaders",
                                    value: function () {
                                        return [{ sTitle: "ID", bVisible: !1 }, { sTitle: "Performance Review" }, { sTitle: "Employee" }, { sTitle: "Template" }, { sTitle: "Status" }];
                                    },
                                },
                                {
                                    key: "getFormFields",
                                    value: function () {
                                        return [
                                            ["id", { label: "ID", type: "hidden" }],
                                            ["review", { label: "Performance Review", type: "select2", sort: "none", "allow-null": !1, "remote-source": ["PerformanceReview", "id", "name"] }],
                                            [
                                                "employee",
                                                { label: "Employee", type: "select2", sort: "none", "allow-null": !0, "null-label": "None", "remote-source": ["Employee", "id", "first_name+last_name", "getActiveSubordinateEmployees"] },
                                            ],
                                            ["form", { label: "Template", type: "select2", "remote-source": ["ReviewTemplate", "id", "name"] }],
                                            [
                                                "status",
                                ...
                                },
                                {
                                    key: "showConfigView",
                                    value: function (e) {
                                        var t = { id: e, type: "ReviewFeedback" },
                                            a = JSON.stringify(t),
                                            l = [];
                                        (l.callBackData = []), (l.callBackSuccess = "showConfigViewSuccessCallBack"), (l.callBackFail = "showConfigViewFailCallBack"), this.customAction("getFormDataFeedback", "admin=performance", a, l);
                                    },
                                },
                                {
                                    key: "showConfigViewSuccessCallBack",
                                ...
                                },
                                {
                                    ...
                                    value: function (e, t) {
                                        var a = t;
                                        this.preRenderForm(a);
                                        for (var l = this.templates.formTemplate, i = "", r = this.getMergedConfigFields(e), n = 0; n < r.length; n++) {
                                        ...
                                        l = (l = l.replace(/_id_/g, this.getTableName() + "_submit")).replace(/_fields_/g, i);
                                        var u = void 0,
                                            d = this.generateRandom(14);
                                        this.showFormOnPopup ? (u = $('<div class="reviewBlock popupForm" data-content="Form"></div>')).attr("id", d) : (u = $("#" + this.getTableName() + "Form")),
                                            u.html(l),
                                            u.find(".datefield").datepicker({ viewMode: 2 }),
                                            u.find(".timefield").datetimepicker({ language: "en", pickDate: !1 }),
                                            u.find(".datetimefield").datetimepicker({ language: "en" }),
                                        ...
                                        for (var c = 0; c < r.length; c++) "datagroup" === r[c][1].type && u.find("#" + r[c][0]).data("field", r[c]);
                                        !1 === this.showSave
                                            ? u.find(".saveBtn").remove()
                                            : (u.find(".saveBtn").off(),
                                              u.find(".saveBtn").data("modJs", this),
                                              u.find(".saveBtn").on("click", function () {
                                                  return $(this).data("modJs").save(), !1;
                                              })),
                                            !1 === this.showCancel
                                                ? u.find(".cancelBtn").remove()
                                                : (u.find(".cancelBtn").off(),
                                                  u.find(".cancelBtn").data("modJs", this),
                                                  u.find(".cancelBtn").on("click", function () {
                                                      return $(this).data("modJs").cancel(), !1;
                                                  })),
                                            this.showFormOnPopup
                                                ? (this.showMessage("Edit", "", null, null, !0),
                                                  $("#plainMessageModel .modal-body").html(""),
                                                  $("#plainMessageModel .modal-body").append(u),
                                                  void 0 !== a && null != a && this.fillForm(a, "#" + d, r))
                                                : ($("#" + this.getTableName() + "Form").show(), $("#" + this.getTableName()).hide(), void 0 !== a && null != a && this.fillForm(a, null, r)),
                                            this.postRenderForm(a, u);
                                    },
                                },
                                {
                                    key: "getActionButtonsHtml",
                                    value: function (e, t) {
                                        var a = '<div style="width:120px;">_edit__configure__delete__clone_</div>';
                                        return (
                                            (a = this.showAddNew
                                                ? a.replace(
                                                      "_clone_",
                ...
                t.exports = { ReviewTemplateAdapter: d, PerformanceReviewAdminAdapter: c, ReviewFeedbackAdminAdapter: h };
            },
            { "../../../api/AdapterBase": 4 },
        ],
        3: [
                        ...
                        i(e, [
                            ...
                            },
                            {
                                ...
                                value: function (e, t, a) {
                                    ...
                                    for (var o = [], s = [], u = null, d = null, c = 0; c < i.length; c++)
                                        if (void 0 !== (u = i[c])[1]["remote-source"] && null !== u[1]["remote-source"]) {
                                            ...
                                            for (var f = 0; f < u[1].form.length; f++)
                                                if (void 0 !== (d = u[1].form[f])[1]["remote-source"] && null !== d[1]["remote-source"]) {
                                                    var p = d[1]["remote-source"][0] + "_" + d[1]["remote-source"][1] + "_" + d[1]["remote-source"][2];
                                                    s.indexOf(p) < 0 && (o.push(d), s.push(p));
                                                }
                            ...
                            { key: "postRenderForm", value: function (e, t) {} },
                            {
                                ...
                                value: function (e, t) {
                                    ...
                                    for (var s = $('<div id="' + t[0] + '_div_inner"></div>'), u = 0; u < a.length; u++) {
                                        ...
                                        i))
                                            void 0 !== (n = i[d]) && null != n && "string" == typeof n && (n = n.replace(/(?:\r\n|\r|\n)/g, "<br />")), (l = l.replace("#_" + d + "_#", n));
                                ...
                                value: function () {
                                    ...
                                    if (a.checkValues()) {
                                        ...
                                        if (this.doCustomFilterValidation(l)) {
                                            var r = $("#" + e[0]).val();
                                            "" === r && (r = "[]");
                                            for (var o = JSON.parse(r), s = {}, u = -1, d = [], c = 0; c < o.length; c++) {
                                                var h = o[c];
                                                h.id === t && ((s = h), (u = c)), d.push(h);
                                            }
                                            (l.id = s.id), (d[u] = l), void 0 !== e[1]["sort-function"] && null != e[1]["sort-function"] && d.sort(e[1]["sort-function"]), (r = JSON.stringify(d)), $("#" + e[0]).val(r);
