! function() {
    ...
    1: [function(e, t, a) {
        "use strict";
        var l = e("./lib");
        window.UserAdapter = l.UserAdapter, window.UserRoleAdapter = l.UserRoleAdapter
    }, {
        "./lib": 2
    }],
    2: [function(e, t, a) {
        ...
        var c = function(e) {
                ...
                return u(t, r.default), l(t, [{
                    ...
                    key: "postRenderForm",
                    value: function(e, t) {
                        null != e && void 0 !== e || t.find("#changePasswordBtn").remove()
                    }
                }, {
                    key: "changePassword",
                    value: function() {
                    ...
                    value: function(e, t) {
                        var a = e[0];
                        e[1] ? this.showMessage("Create User", "An email has been sent to " + a.email + " with a temporary password to login.") : this.showMessage("Create User", "User created successfully. But there was a problem sending welcome email."), this.get([])
                    }
                }, {
                    ...
                    value: function(e) {
                        var t = null;
                        return "Admin" !== e.user_level && "Other" !== e.user_level && "NULL" === e.employee && (t = "For this user type, you have to assign an employee when adding or editing the user.<br/>", t += " You may create a new employee through 'Admin'->'Employees' menu"), t
                    }
                }, {
                    key: "save",
                    value: function() {
                        var e = new i.default(this.getTableName() + "_submit", !0, {
                            ShowPopup: !1,
                        ...
                        if (e.checkValues()) {
                            ...
                            if (null == a) {
                                ...
                                if (t.csrf = $("#" + this.getTableName() + "Form").data("csrf"), null != l && void 0 !== l && "" !== l) t.id = l, this.add(t, []);
                                else {
                                    var r = JSON.stringify(t),
                                        s = [];
                                    s.callBackData = [], s.callBackSuccess = "saveUserSuccessCallBack", s.callBackFail = "saveUserFailCallBack", this.customAction("saveUser", "admin=users", r, s)
                                }
                            } else this.showMessage("Error Saving User", a)
                        }
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        var a = {
                            ...
                            l = JSON.stringify(a),
                            i = [];
                        i.callBackData = [], i.callBackSuccess = "changePasswordSuccessCallBack", i.callBackFail = "changePasswordFailCallBack", this.customAction("changePassword", "admin=users", l, i)
                    }
                }, {
            ...
            d = function(e) {
                ...
                return u(t, r.default), l(t, [{
                    ...
                    key: "postRenderForm",
                    value: function(e, t) {
                        t.find("#changePasswordBtn").remove()
                    }
                }, {
                    key: "getFormFields",
                    value: function() {
        ...
        var n = function(e) {
            ...
            return function(e, t) {
                ...
                value: function(e, t) {
                    ...
                    null != s && "SUCCESS" === s.status && (t.callBackData.push(s.data), null !== t.callBackSuccess && void 0 !== t.callBackSuccess && t.callBackData.push(t.callBackSuccess), a.callFunction(t.callBack, t.callBackData));
                    var n = function e(l) {
                        if ("SUCCESS" === l.status) {
                    ...
                    n.key = r, n.table = e[0], $.post(this.moduleRelativeURL, {
                        t: e[0],
                        key: e[1],
                        value: e[2],
                        method: l,
            ...
            return i(e, [{
                ...
                value: function(e, t, a) {
                    ...
                    var i = this.getFormFields(),
                        r = this.getFilters();
                    if (null != r)
                        for (var s = 0; s < r.length; s++)(null == (l = this.getMetaFieldValues(r[s][0], i)) || "select" !== l.type && "select2" !== l.type && "select2multi" !== l.type) && i.push(r[s]);
                    for (var n = [], o = [], u = null, c = null, d = 0; d < i.length; d++)
                        ...
                        for (var f = 0; f < u[1].form.length; f++)
                            if (void 0 !== (c = u[1].form[f])[1]["remote-source"] && null !== c[1]["remote-source"]) {
                                ...
                                o.indexOf(p) < 0 && (n.push(c), o.push(p))
                            }
                ...
                value: function(e) {
                    ...
                    this.showActionButtons() && (s.aoColumnDefs = [{
                        fnRender: this.getActionButtons,
                        aTargets: [this.getDataMapping().length]
                    }]);
                    var n = this.getCustomTableParams();
                    $.extend(s, n), $("#" + e + " #grid").dataTable(s), $(".dataTables_paginate ul").addClass("pagination"), $(".dataTables_length").hide(), $(".dataTables_filter input").addClass("form-control"), $(".dataTables_filter input").attr("placeholder", "Search"), $(".dataTables_filter label").contents().filter(function() {
                        return 3 === this.nodeType
                    }).remove(), $(".tableActionButton").tooltip()
                }
            }, {
                ...
                value: function(e, t, a, l, i, r) {
                    var s = this,
                        n = "#yesnoModel";
                    void 0 !== t && null != t || (t = ""), $(n + "Label").html(e), $(n + "Body").html(t), null != a && $(n + "YesBtn").html(a), null != l && $(n + "NoBtn").html(l), $(n + "YesBtn").off().on("click", function() {
                ...
                value: function(e, t) {
                    var a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
                        ...
                        r = this,
                        s = "";
                    s = i ? "#plainMessageModel" : "#messageModel", $(s).off(), i ? this.renderModel("plainMessage", e, t) : this.renderModel("message", e, t), null != a ? ($(s).modal({
                        show: !0
                ...
                value: function(e, t, a, l, i) {
                    var r = this,
                        s = "";
                    s = i ? "#dataMessageModel" : "#messageModel", $(s).unbind("hide"), i ? this.renderModelFromDom("dataMessage", e, t) : this.renderModelFromDom("message", e, t), null != a ? ($(s).modal({
                        show: !0
                    }), $(s).on("hidden.bs.modal", function() {
                        a.apply(r, l), $(".modal-backdrop").remove()
                    })) : $(s).modal({
                ...
                key: "save",
                value: function(e, t) {
                    var a = new s.default(this.getTableName() + "_submit", !0, {
                        ShowPopup: !1,
                        LabelErrorClass: "error"
                    });
                    if (a.checkValues()) {
                ...
                key: "filterQuery",
                value: function() {
                    var e = new s.default(this.getTableName() + "_filter", !0, {
                        ShowPopup: !1,
                        LabelErrorClass: "error"
                    });
                    if (e.checkValues()) {
                    ...
                    for (var u in null == i && (i = []), e)
                        if (e.hasOwnProperty(u)) {
                            if (s = "", n = null, "select" === (i = this.getMetaFieldValues(u, o)).type || "select2" === i.type) {
                                if (void 0 !== i["remote-source"] && null != i["remote-source"]) a = i["remote-source"], "NULL" === e[u] ? s = void 0 !== i["null-label"] && null != i["null-label"] ? i["null-label"] : "Not Selected" : n = s = this.fieldMasterData[a[0] + "_" + a[1] + "_" + a[2]][e[u]];
                ...
                value: function(e) {
                    ...
                    o.attr("id", n), o.html(t), o.find(".datefield").datepicker({
                        viewMode: 2
                ...
                value: function(e, t) {
                    ...
                    n.attr("id", s), n.html(a), n.find(".datefield").datepicker({
                        viewMode: 2
                    }), n.find(".timefield").datetimepicker({
                        language: "en",
                        pickDate: !1
                    }), n.find(".datetimefield").datetimepicker({
                        language: "en"
                    }), n.find(".colorpick").colorpicker(), tinymce.init({
                        selector: "#" + n.attr("id") + " .tinymce",
                        height: "400"
                    ...
                    }), this.currentDataGroupField = e, this.showDomElement("Add " + e[1].label, n, null, null, !0), void 0 !== t && null != t ? this.fillForm(t, "#" + this.getTableName() + "_field_" + e[0], e[1].form) : this.setDefaultValues("#" + this.getTableName() + "_field_" + e[0], e[1].form), $(".groupAddBtn").off(), void 0 !== t && null != t && void 0 !== t.id ? $(".groupAddBtn").on("click", function(e) {
                        e.preventDefault(), e.stopPropagation();
                        try {
                            modJs.editDataGroup()
                        } catch (e) {
                ...
                value: function() {
                    ...
                    var a = new s.default(this.getTableName() + "_field_" + e[0], !0, {
                        ShowPopup: !1,
                        LabelErrorClass: "error"
                    });
                    if (a.checkValues()) {
                        ...
                        $("#" + e[0] + "_div").html(""), $("#" + e[0] + "_div").append(n), this.makeDataGroupSortable(e, $("#" + e[0] + "_div_inner")), $("#" + e[0]).val(i), this.orderDataGroup(e), this.closeDataMessage(), this.showMessage("Item Added", "This change will be effective only when you save the form")
                    }
                    return !0
                }
            }, {
                ...
                value: function() {
                    var e = this.currentDataGroupField,
                        ...
                        a = new s.default(this.getTableName() + "_field_" + e[0], !0, {
                            ShowPopup: !1,
                            LabelErrorClass: "error"
                        });
                    if (a.checkValues()) {
                    ...
                    for (var i = 0; i < a.length; i++)
                        ...
                        if ("0000-00-00 00:00:00" !== e[a[i][0]] && "" !== e[a[i][0]] && null != e[a[i][0]] && void 0 !== e[a[i][0]]) {
                            var r = e[a[i][0]].split(" "),
                                s = r[0].split("-"),
                                n = r[1].split(":");
                            $(t + " #" + a[i][0] + "_datetime").data("datetimepicker").setLocalDate(new Date(s[0], parseInt(s[1], 10) - 1, s[2], n[0], n[1], n[2]))
                        }
