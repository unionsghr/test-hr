...
})()(
  {
    1: [
      function (e, t, a) {
        "use strict";
        var l = e("./lib");
        (window.LeaveTypeAdapter = l.LeaveTypeAdapter),
          (window.LeaveRuleAdapter = l.LeaveRuleAdapter),
          (window.LeavePeriodAdapter = l.LeavePeriodAdapter),
          (window.WorkDayAdapter = l.WorkDayAdapter),
          (window.HoliDayAdapter = l.HoliDayAdapter),
        //   (window.LeaveAllowanceAdapter = l.LeaveAllowanceAdapter),
          (window.EmployeeLeaveAdapter = l.EmployeeLeaveAdapter),
          (window.LeaveGroupAdapter = l.LeaveGroupAdapter),
          (window.LeaveGroupEmployeeAdapter = l.LeaveGroupEmployeeAdapter),
          (window.LeaveStartingBalanceAdapter = l.LeaveStartingBalanceAdapter);
      },
      { "./lib": 2 },
    ],
    2: [
      function (e, t, a) {
        ...
        var l,
          i = function e(t, a, l) {
            ...
            if (void 0 === i) {
              ...
              return null === r ? void 0 : e(r, a, l);
            }
            if ("value" in i) return i.value;
            var n = i.get;
            return void 0 !== n ? n.call(l) : void 0;
          },
          r = (function () {
            function e(e, t) {
          ...
          n = e("../../../api/AdapterBase"),
          o = (l = n) && l.__esModule ? l : { default: l };
        function s(e, t) {
          if (!(e instanceof t))
            ...
            return (
              ...
              r(t, [
                ...
                },
                {
                  ...
                  value: function () {
                    return [
                      ...
                      [
                        "name",
                        { label: "Leave Name", type: "text", validation: "" },
                      ],
                      [
                        "leave_gl",
                        {
                          ...
                          type: "text",
                          validation:"none", 
                          help: "Entry Point for Finance Leave Allowance GL, for the purpose of payments.",
                        },
                      ],
                    ]
                      .concat(d)
                      .concat([
                        ...
                        [
                          "leave_group",
                          {
                            ...
                            type: "select2",
                            "allow-null": !0,
                            "remote-source": ["LeaveGroup", "id", "name"],
                          },
                        ],
                ...
                },
                {
                  ...
                  value: function (e) {
                    return e.carried_forward_percentage > 100 ||
                      e.carried_forward_percentage < 0
                      ? "Percentage of leave carried forward should be between 0 and 100"
                      : null;
                  },
                },
                {
                  ...
                  value: function () {
                    return [
                      ...
                      [
                        "exp_days",
                        {
                          label: "Required Experience (Days)",
                          type: "text",
                          validation: "number",
                          help: "Number of experience in days required for this rule to be applied to the employee. 0 to discard experience. Experience is calculated by taking difference in days between joined date and start date of current leave period",
                        },
                      ],
                      [
                        "department",
              ...
              r(t, [
                {
                  key: "getDataMapping",
                  value: function () {
                    var e = ["id", "name", "date_start", "date_end"];
                    return (
                      !0 === this.countryBasedLeavePeriods && e.push("country"),
                      e
                    );
                  },
                },
                {
                  key: "getHeaders",
                  value: function () {
                    return !0 === this.countryBasedLeavePeriods
                      ? [
                ...
                },
                {
                  ...
                  value: function () {
                    var e = [
                      ...
                      [
                        "date_start",
                        { label: "Period Start", type: "date", validation: "" },
                      ],
                      [
                        "date_end",
                        { label: "Period End", type: "date", validation: "" },
                      ],
                    ];
                    return (
                      !0 === this.countryBasedLeavePeriods &&
                        e.push([
                          "country",
                          {
                            label: "Country",
                ...
                {
                  key: "checkLeavePeriods",
                  value: function () {
                    for (var e = 0, t = 0; t < this.sourceData.length; t++) e++;
                    e < 1 &&
                      this.showMessage(
                        "Error",
                        "You should at least have one leave period."
                      );
                  },
                },
                {
                  ...
                  value: function (e) {
                    ...
                    (l.callBackData = []),
                      (l.callBackSuccess =
                        "getLeaveDaysReadonlySuccessCallBack"),
                      (l.callBackFail = "getLeaveDaysReadonlyFailCallBack"),
                      this.customAction(
                        "getLeaveDaysReadonly",
                        "admin=leaves",
                        a,
                        l
                      );
                ...
                {
                  key: "setCountryBasedLeavePeriods",
                  value: function (e) {
                    this.countryBasedLeavePeriods = e;
                  },
                },
                {
                  key: "getHelpLink",
            ...
            return (
              ...
              r(t, [
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    var a =
                      '<div style="width:50px;"><img class="tableActionButton" src="_BASE_images/edit.png" style="cursor:pointer;" rel="tooltip" title="Edit" onclick="modJs.edit(_id_);return false;"></img>__DeleteButton__</div>';
                    return (
                      void 0 !== t[3] && null !== t[3] && "" !== t[3]
                        ? (a = a.replace(
                            /__DeleteButton__/g,
                        ...
                        : ((t[3] = "For All Countries"),
                          (a = a.replace(/__DeleteButton__/g, ""))),
                      (a = (a = a.replace(/_id_/g, e)).replace(
                        /_BASE_/g,
                        this.baseUrl
                      ))
                    );
                ...
                },
                {
                  ...
                  value: function () {
                    return { bPaginate: !1, bFilter: !1, bInfo: !1 };
                  },
                },
                {
                  key: "doCustomValidation",
                  value: function (e) {
                    return (void 0 !== this.currentId &&
                      null != this.currentId) ||
                      "NULL" !== e.country
                      ? null
                      : "Workday can not be added";
                  },
                },
                {
                  key: "getHelpLink",
            ...
            return (
              ...
              r(t, [
                ...
                },
                {
                  ...
                  value: function () {
                    return [
                      ...
                      [
                        "dateh",
                        { label: "Date", type: "date", validation: "" },
                      ],
                      [
                        "status",
                        {
                ...
                },
                {
                  ...
                  value: function (e, a) {
                    return (
                      (void 0 !== a[4] && null !== a[4] && "" !== a[4]) ||
                        (a[4] = "For All Countries"),
                      i(
                        t.prototype.__proto__ ||
                          Object.getPrototypeOf(t.prototype),
        ...
        //           key: "getDataMapping",
        //           value: function () {
        //             return ["id", "name", "leave_type", "leave_period", "posting_date"];
        //           },
        //         },
        //         {
        //           key: "getHeaders",
        ...
        //               [
        //                 "leave_type",
        //                 { label: "Leave Type", type: "text", validation: "" },
        //               ],
        //               [
        //                 "leave_period",
        //                 {
        ...
        //   })(),
          y = (function (e) {
            function t(e, a, l, i) {
              ...
              var r = u(
                this,
                (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, a, l, i)
              );
            ...
            return (
              ...
              r(t, [
                ...
                },
                {
                    ...
                    value: function () {
                        return [
                            ...
                            ["employee", { label: "Employee", type: "select", "allow-null": !1, "remote-source": ["Employee", "id", "first_name+middle_name+last_name"] }],
                            ...
                            ["req_allowance", { label: "Request Allowance", type: "select", source: [["Yes", "Yes"],["No", "No"]], }],
                        ];
                    },
                },
                {
                ...
                },
                {
                  ...
                  value: function (e) {
                    for (var t = 0, a = 0; a < e.length; a++)
                      "Full Day" === e[a].leave_type
                        ? (t += 1)
                        : "Half Day - Morning" === e[a].leave_type
                        ? (t += 0.5)
                        : "Half Day - Afternoon" === e[a].leave_type
                        ? (t += 0.5)
                        : "1 Hour - Morning" === e[a].leave_type
                        ? (t += 0.125)
                        : "2 Hours - Morning" === e[a].leave_type
                        ? (t += 0.25)
                        : "3 Hours - Morning" === e[a].leave_type
                        ? (t += 0.375)
                        : "1 Hour - Afternoon" === e[a].leave_type
                        ? (t += 0.125)
                        : "2 Hours - Afternoon" === e[a].leave_type
                        ? (t += 0.25)
                        : "3 Hours - Afternoon" === e[a].leave_type &&
                          (t += 0.375);
                    return t;
                  },
                },
                ...
                },
                {
                  ...
                  value: function (e) {
                    var t =
                        '<table class="table table-condensed table-bordered table-striped" style="font-size:14px;"><thead><tr><th>Leave Date</th><th>Leave Type</th></tr></thead><tbody>_days_</tbody></table> ',
                      a =
                        '<table class="table table-condensed table-bordered table-striped" style="font-size:14px;"><thead><tr><th>Notes</th></tr></thead><tbody>_days_</tbody></table> ',
                      l = e[0],
                      i = e[1],
                      r = e[2],
                      n = e[3],
                      ...
                      u = "",
                      c = "",
                      d = this.calculateNumberOfLeaves(l);
                    d > i.availableLeaves
                      ? (s +=
                          '<span class="label label-info">Number of Leaves requested (' +
                          d +
                          ")</span><br/>")
                      : (s +=
                          '<span class="label label-success">Number of Leaves requested (' +
                          d +
                          ")</span><br/>");
                    for (var p = 0; p < l.length; p++)
                      u += "<tr><td>_date_</td><td>_type_</td></tr>"
                        .replace(
                          /_date_/g,
                          Date.parse(l[p].leave_date).toString(
                            "MMM d, yyyy (dddd)"
                          )
                        )
                        .replace(/_type_/g, l[p].leave_type);
                    for (var h = 0; h < o.length; h++)
                      c +=
                        '<tr><td><span class="logTime label label-default">_date_</span>&nbsp;&nbsp;<b>_status_</b><br/>_note_</td></tr>'
                          .replace(/_date_/g, o[h].time)
                          .replace(
                            /_status_/g,
                            o[h].status_from + " -> " + o[h].status_to
                          )
                          .replace(/_note_/g, o[h].note);
                    null !== n &&
                      void 0 !== n.details &&
                      null !== n.details &&
                      "" !== n.details &&
                      ((s += "<br/><b>Reason for Applying leave:</b><br/>"),
                      (s += n.details + "<br/><br/>")),
                      (s += "<br/>"),
                      (s += t = t.replace("_days_", u)),
                      "" !== c && (s += a = a.replace("_days_", c)),
                      null !== i.attachment &&
                        void 0 !== i.attachment &&
                        "" !== i.attachment &&
                        (s +=
                          ...
                          i.attachment +
                          "',modJs.getLeaveDaysReadonly,[" +
                          r +
                          ']);" style="cursor:pointer;">View Attachment <i class="icon-play-circle"></i></label>'),
                      this.showMessage("Leave Days", s);
                      window.timeUtils.convertToRelativeTime($(".logTime"));
                  },
                },
                {
                  ...
                  value: function (e) {
                    this.showMessage(
                      "Error",
                      "Error Occured while Reading leave days from Server"
                    );
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function (e) {
                    for (
                      var t = [], a = this.getDataMapping(), l = 0;
                      l < e.length;
                      l++
                    ) {
                ...
                {
                  key: "remoteTableSkipEmployeeRestriction",
                  value: function () {
                    return !0;
                  },
                },
                ...
                },
                {
                  ...
                  value: function (e, t, p) {                     
                      ...
                      $("#leave_status").html(this.getLeaveOptions(t)),
                      $("#leave_status").val(t),
                      $("#_employee_Id").val(e),
                      (this.leaveStatusChangeId = e);
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function (e) {
                    this.showMessage(
                      "Error",
                      "Error occured while changing leave status"
                    );
                  },
                },
                // {
                ...
                },
                {
                  ...
                  value: function () {
                    return [
                        ...
                        [
                          "note",
                          { label: "Note", type: "textarea", validation: "none" },
                        ],
                      ];
                  },
                },
        ...
        t.exports = {
          LeaveTypeAdapter: p,
          LeaveRuleAdapter: h,
          LeavePeriodAdapter: f,
          WorkDayAdapter: v,
          HoliDayAdapter: m,
        //   LeaveAllowanceAdapter: c,
          EmployeeLeaveAdapter: y,
          LeaveGroupAdapter: g,
          LeaveGroupEmployeeAdapter: b,
          LeaveStartingBalanceAdapter: _,
        };
      },
      { "../../../api/AdapterBase": 4 },
    ],
                    ...
                    value: function (e) {
                      ...
                      var a = function (e) {
                          ...
                          if (jQuery.inArray(r, t.inputTypes) >= 0) {
                            ...
                            void 0 !== s &&
                            null != s &&
                            void 0 !== t.validator[s] &&
                            null != t.validator[s]
                              ? (u = t.validator[s](a))
                              : ((u =
                                  !t.validateAll ||
                                  (void 0 !== s && null != s && "none" === s) ||
                                  t.validator.input(a)),
                                (t.formObject[i] = a)),
                              u
          ...
          return (
            i(e, [
                  ...
                  for (
                    ...
                    if (
                      ...
                      for (var h = 0; h < u[1].form.length; h++)
                        if (
                          void 0 !== (c = u[1].form[h])[1]["remote-source"] &&
                          ...
                          var f =
                            ...
                            "_" +
                            c[1]["remote-source"][2];
                          s.indexOf(f) < 0 && (o.push(c), s.push(f));
                        }
                  for (var v = 0; v < o.length; v++) {
                    ...
                    if (
                      ...
                      var y =
                        ...
                        "_" +
                        m[1]["remote-source"][2];
                      (this.fieldMasterDataKeys[y] = !1),
                        (this.sourceMapping[m[0]] = m[1]["remote-source"]);
                      var g = { callBack: "initFieldMasterDataResponse" };
                      (g.callBackData = [y]),
                        null != e && (g.callBackSuccess = e),
                        this.getFieldValues(m[1]["remote-source"], g);
                    }
                  }
                },
              },
              ...
              },
              {
                ...
                value: function (e) {
                  var t = this.getHeaders();
                  for (var a in (t.push({ sTitle: "", sClass: "center" }), t))
                  ...
                  for (var u in (null == i && (i = []), e))
                    if (e.hasOwnProperty(u)) {
                      if (
                        ((n = ""),
                        (o = null),
                        "select" === (i = this.getMetaFieldValues(u, s)).type ||
                          "select2" === i.type)
                      ) {
                        if (
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  s.attr("id", o),
                    ...
                    s
                      .find(".timefield")
                      .datetimepicker({ language: "en", pickDate: !1 }),
                ...
                value: function (e) {
                  ...
                  for (
                    ...
                    if ("" === n || void 0 === n)
                      ...
                      var o = e[n];
                      "" !== o && null != o && void 0 !== o && "" !== o.trim()
                        ? (l += this.renderFormField(JSON.parse(o)))
                        : (l += this.renderFormField(i[r]));
                    }
                  }
                  a = (a = a.replace(
                  ...
                  if (
                    ...
                    this.showMessage("Edit", "", null, null, !0),
                      ...
                      $("#plainMessageModel .modal-body").append(s);
              ...
              { key: "postRenderForm", value: function (e, t) {} },
              {
                ...
                value: function (e, t) {
                  ...
                  for (
                    var s = $('<div id="' + t[0] + '_div_inner"></div>'), u = 0;
                    u < a.length;
                    u++
                  ) {
                    for (var c in ((i = a[u]),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var a = new n.default(
                    this.getTableName() + "_field_" + e[0],
                    !0,
                    { ShowPopup: !1, LabelErrorClass: "error" }
                  );
                  if (a.checkValues()) {
                    var l = a.getFormParameters();
                    if (
                ...
                value: function () {
                  ...
                  if (a.checkValues()) {
                    ...
                    if (this.doCustomFilterValidation(l)) {
                      ...
                      "" === r && (r = "[]");
                      for (
                        var o = JSON.parse(r), s = {}, u = -1, c = [], d = 0;
                        d < o.length;
                        d++
                      ) {
                        var p = o[d];
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  for (var r = 0; r < l.length; r++) {
                    ...
                    a += s = (s = s.replace("_id_", n)).replace(
                      "_val_",
                      this.gt(o)
                    );
                  }
              ...
              },
              {
                ...
                value: function (e, t) {
                  var a =
                    '<div style="width:120px;">_edit__status__delete__clone_</div>';
                  return (
                    (a = this.showAddNew
                      ? a.replace(
                          "_clone_",
                    ...
                    (a = this.showAddNew
                      ? a.replace(
                          "_status_",
                          '<img class="tableActionButton" src="_BASE_images/run.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Status" onclick="modJs.copyRow(_id_);return false;"></img>'
                        )
                      : a.replace("_clone_", "")),
                    (a = this.showDelete
                      ? a.replace(
