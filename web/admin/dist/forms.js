! function () {
  ...
  1: [function (e, t, a) {
    "use strict";
    var l = e("./lib");
    window.FormAdapter = l.FormAdapter, window.EmployeeFormAdminAdapter = l.EmployeeFormAdminAdapter
  }, {
    "./lib": 2
  }],
  2: [function (e, t, a) {
          ...
          return [
            ...
            ["items", {
              ...
              "custom-validate-function": function (e) {
                ...
                if (null != (t = e.name) && /^[a-z][a-z0-9._]+$/.test(t) || (a.message = "Invalid name, should have lower case letters, numbers or _", a.valid = !1), ["select", "select2", "select2multi"].indexOf(e.field_type) >= 0 && ("" !== e.field_options && void 0 !== e.field_options && null !== e.field_options || (a.message = "Please type in option to be added to select field. Input one option per line", a.valid = !1)), ["id", "form", "employee", "status", "created", "updated"].indexOf(e.name) >= 0 && (a.message = "Selected name is not allowed", a.valid = !1), !1 === a.valid) return a;
                var l = [e.name];
                if (l.push({}), l[1].label = e.field_label, l[1].type = e.field_type, l[1].validation = e.field_validation, void 0 !== e.field_help && null !== e.field_help && "" !== e.field_help && (l[1].help = e.field_help), ["select", "select2", "select2multi"].indexOf(e.field_type) >= 0) {
                  "" !== e.field_options && void 0 !== e.field_options && null !== e.field_options || (a.message = "Please type in option to be added to select field. Input one option per line", a.valid = !1);
        ...
        return u(t, n.default), i(t, [{
          ...
          value: function (e) {
            var t = {
              ...
              a = JSON.stringify(t),
              l = [];
            l.callBackData = [], l.callBackSuccess = "showConfigViewSuccessCallBack", l.callBackFail = "showConfigViewFailCallBack", this.customAction("getFormData", "admin=forms", a, l)
          }
        }, {
          ...
          value: function (e, t) {
            ...
            this.showFormOnPopup ? (u = $('<div class="reviewBlock popupForm" data-content="Form"></div>')).attr("id", d) : u = $("#" + this.getTableName() + "Form"), u.html(l), u.find(".datefield").datepicker({
              viewMode: 2
            ...
            })), this.showFormOnPopup ? (this.showMessage("Edit", "", null, null, !0), $("#plainMessageModel .modal-body").html(""), $("#plainMessageModel .modal-body").append(u), null != a && this.fillForm(a, "#" + d, r)) : ($("#" + this.getTableName() + "Form").show(), $("#" + this.getTableName()).hide(), null != a && this.fillForm(a, null, r)), this.postRenderForm(a, u)
          }
        }, {
    ...
    var o = function () {
      ...
      return i(e, [{
        ...
        value: function (e) {
          ...
          var approval;
          $.ajax({
            url: "../../../../rokel_hrm/core/approveEmployeeForm.php",
            type: "post",
            contentType: "application/json",
            dataType: "json",
            async: false,
            ...
            success: function (data, textStatus, jQxhr) {
              if (data.message_code == "222") {
                alert("The Hr form has been approved, but employee has no email available to be notified");
              } else {
                alert("The Hr form has been approved, an email will be sent to the employee");
              }
