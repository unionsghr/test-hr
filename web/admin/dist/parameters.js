...
})()(
    {
        1: [
            function (e, t, a) {
                "use strict";
                var l = e("./lib");
                (window.CountryAdapter = l.CountryAdapter),
                (window.ProvinceAdapter = l.ProvinceAdapter),
                (window.CurrencyTypeAdapter = l.CurrencyTypeAdapter),
                (window.NationalityAdapter = l.NationalityAdapter),
                (window.ImmigrationStatusAdapter = l.ImmigrationStatusAdapter),
                (window.EthnicityAdapter = l.EthnicityAdapter);
                (window.CodeCreationAdapter = l.CodeCreationAdapter);
                (window.CodeDetailsAdapter = l.CodeDetailsAdapter);
            },
            { "./lib": 2 },
        ],
        2: [
            function (e, t, a) {
                        ...
                        return (
                            ...
                            l(t, [
                                ...
                                },
                                {
                                    key: "getHeaders",
                                    value: function () {
                                        return [{ sTitle: "ID", bVisible: !1 }, { sTitle: "Code" }, { sTitle: "Name" }];
                                    },
                                },
                                {
                                    key: "getFormFields",
                        ...
                        return (
                            ...
                            l(t, [
                                ...
                                },
                                {
                                    key: "getHeaders",
                                    value: function () {
                                        return [{ sTitle: "ID", bVisible: !1 }, { sTitle: "Code" }, { sTitle: "Name" }, { sTitle: "Country" }];
                                    },
                                },
                                {
                                    key: "getFormFields",
                                ...
                                },
                                {
                                    key: "getFilters",
                                    value: function () {
                                        return [["country", { label: "Country", type: "select2", "remote-source": ["Country", "code", "name"] }]];
                                    },
                                },
                            ]),
                            t
                            ...
                            l(t, [
                                {
                                    key: "getDataMapping",
                                    value: function () {
                                        return ["id", "code", "name","numeric_code","xcg_rate","imprest_gl","imprest_contra","description"];
                                ...
                                },
                                {
                                    key: "getHeaders",
                                    value: function () {
                                        return [{ sTitle: "ID", bVisible: !1 }, 
                                                { sTitle: "Code" }, 
                                                { sTitle: "Name" }, 
                                                { sTitle: "Numeric Code" }, 
                                                { sTitle: "Current Rate" },
                                                { sTitle: "Imprest GL" },
                                                { sTitle: "Imprest Contra" },
                                                { sTitle: "Description" }
                                            ];
                                    },
                                },
                                {
                                    ...
                                    value: function () {
                                        return [
                                            ...
                                            ["code", { label: "Code", type: "text", validation: "" }],
                                            ["name", { label: "Name", type: "text", validation: "" }],
                                            ["numeric_code", { label: "Numeric Code", type: "text", validation: "none" }],
                                            ["xcg_rate", { label: "Exchange Rate", type: "text", validation: "none" }],
                                            ["imprest_gl", { label: "Imprest GL", type: "text", validation: "none" }],
                                            ["imprest_contra", { label: "Imprest Contra", type: "text", validation: "none" }],
                                            ["description", { label: "Narration", type: "textarea", validation: "none" }]
                                        ];
                                    },
                                },
                            ]),
                            ...
                            l(t, [
                                {
                                    key: "getDataMapping",
                                    value: function () {
                                        return ["id", "code_type", "description","status"];
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        return [
                                            ["id", { label: "ID", type: "hidden" }],
                                            ["code_type", { label: "Code Type", type: "text", validation: "" }],
                                            ["description", { label: "Description", type: "text", validation: "none" }],
                                            [
                                                "status",
                                                {
                                                  label: "Status",
                            ...
                            l(t, [
                                {
                                    key: "getDataMapping",
                                    value: function () {
                                        return ["id", "code_type", "actual_code","description","status"];
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        return [
                                            ["id", { label: "ID", type: "hidden" }],
                                            ["code_type", { label: "Code Type", type: "select2", "remote-source": ["CodeCreation", "code_type", "description"] }],
                                            ["actual_code", { label: "Actual Code", type: "text", validation: "none" }],
                                            ["description", { label: "Description", type: "text", validation: "none" }],
                                            [
                                                "status",
                                                {
                ...
                t.exports = { CountryAdapter: c, ProvinceAdapter: d, CurrencyTypeAdapter: h, NationalityAdapter: f, ImmigrationStatusAdapter: p, EthnicityAdapter: v, CodeCreationAdapter: g, CodeDetailsAdapter: j };
            },
            { "../../../api/AdapterBase": 4, "../../../api/IdNameAdapter": 6 },
        ],
        3: [
            function (e, t, a) {
                "use strict";
        ...
        4: [
            ...
            { "../api-common/RequestCache": 3, "./ModuleBase": 7 },
        ],
        5: [
            function (e, t, a) {
                "use strict";
