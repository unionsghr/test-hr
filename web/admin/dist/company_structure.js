! function() {
    ...
    1: [function(e, t, a) {
        "use strict";
        var l = e("./lib");
        window.CompanyStructureAdapter = l.CompanyStructureAdapter, window.CompanyGraphAdapter = l.CompanyGraphAdapter
    }, {
        "./lib": 2
    }],
    2: [function(e, t, a) {
                    ...
                    value: function() {
                        return [
                            ...
                            ["timezone", {
                                ...
                                type: "select2",
                                "allow-null": !1,
                                "remote-source": ["Timezone", "name", "details", "getTimezonesWithOffset"]
                            }],
                            ["parent", {
                ...
                return u(t, c), i(t, [{
                    ...
                    value: function(e) {
                        for (var t = {
                                ...
                                name: "",
                                children: []
                            }, a = null, l = 0; l < e.length; l++) e[l].name = e[l].title, null != e[l].parent && void 0 !== e[l].parent && null != (a = this.findParent(e, e[l].parent)) && (void 0 !== a.children && null != a.children || (a.children = []), a.children.push(e[l]));
                    ...
                    value: function(e, t) {
                        for (var a = 0; a < e.length; a++)
                            if (e[a].title === t || e[a].title === t) return e[a];
                        return null
                    }
                }, {
                    key: "createTable",
                    value: function(e) {
                        ...
                        var t = this.sourceData,
                            ...
                            i = 5e3 - l[1] - l[3],
                            r = 1e3 - l[0] - l[2],
                            n = d3.layout.tree().size([r, i]);
                        this.diagonal = d3.svg.diagonal().projection(function(e) {
                            return [e.y, e.x]
                        }), this.vis = d3.select("#tabPageCompanyGraph").append("svg:svg").attr("width", i + l[1] + l[3]).attr("height", r + l[0] + l[2]).append("svg:g").attr("transform", "translate(" + l[3] + "," + l[0] + ")");
                        var o = a;
                        o.x0 = r / 2, o.y0 = 0, this.update(o, n, o)
                    }
                }, {
                    key: "update",
                    value: function(e, t, a) {
                        ...
                        var n = l.vis.selectAll("g.node").data(r, function(e) {
                                return e.id || (e.id = ++l.nodeIdCounter)
                            }),
                            o = n.enter().append("svg:g").attr("class", "node").attr("transform", function(t) {
                                return "translate(" + e.y0 + "," + e.x0 + ")"
                            }).on("click", function(e) {
                                l.toggle(e), l.update(e, t, a)
                            });
                        o.append("svg:circle").attr("r", 1e-6).style("fill", function(e) {
                            return e._children ? "lightsteelblue" : "#fff"
                        }), o.append("svg:text").attr("x", function(e) {
                        ...
                        var s = n.transition().duration(i).attr("transform", function(e) {
                            return "translate(" + e.y + "," + e.x + ")"
                        });
                        s.select("circle").attr("r", 4.5).style("fill", function(e) {
                            return e._children ? "lightsteelblue" : "#fff"
                        }), s.select("text").style("fill-opacity", 1);
                        var u = n.exit().transition().duration(i).attr("transform", function(t) {
                            return "translate(" + e.y + "," + e.x + ")"
                        }).remove();
                        u.select("circle").attr("r", 1e-6), u.select("text").style("fill-opacity", 1e-6);
                        var c = l.vis.selectAll("path.link").data(t.links(r), function(e) {
                            return e.target.id
                        });
                        c.enter().insert("svg:path", "g").attr("class", "link").attr("d", function(t) {
                            var a = {
                                x: e.x0,
                                y: e.y0
                            };
                        ...
                        }).transition().duration(i).attr("d", l.diagonal), c.transition().duration(i).attr("d", l.diagonal), c.exit().transition().duration(i).attr("d", function(t) {
                            var a = {
                                x: e.x,
                                y: e.y
                            };
                    ...
                    value: function(e) {
                        for (var t = 0; t < this.sourceData.length; t++)
                            if (this.sourceData[t].id == e) return this.sourceData[t];
                        return null
                    }
                }, {
                    key: "fixCyclicParent",
                    value: function(e) {
                        for (var t = "", a = 0; a < e.length; a++) {
                            var l = e[a],
                                i = l,
                                r = {};
                            for (r[i.id] = 1; null != i.parent && null != i.parent;) {
                                var n = this.getSourceDataById(i.parent);
                                if (null == n) break;
                                if (1 == r[n.id]) {
                                    t = l.title + "'s parent structure set to " + n.title + "<br/>", l.parent = null;
                                    break
                                }
                                r[n.id] = 1, i = n
                            }
        ...
        t.exports = {
            CompanyStructureAdapter: c,
            CompanyGraphAdapter: d
        }
    }, {
        "../../../api/AdapterBase": 4
    }],
...
//# sourceMappingURL=company_structure.js.map