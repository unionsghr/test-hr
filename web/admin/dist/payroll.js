! function () {
        ...
        var c = function (e) {
            ...
            p = function (e) {
                ...
                return d(t, n.default), l(t, [{
                    key: "getDataMapping",
                    value: function () {
                        return ["id", "name", "pay_period", "department", "type", "pay_month", "status", "documentRef"]
                    }
                }, {
                    key: "getHeaders",
                    value: function () {
                    ...
                    value: function () {
                        return [
                            ...
                            ["type", {
                                label: "Payment Type",
                                type: "select2",
                                "remote-source": ["PaymentType", "name", "name"],
                                sort: "none"
                            }],
                            ["pay_month", {
                ...
                },
                {
                        ...
                        $.ajax({
                            ...
                            success: function (data, textStatus, jQxhr) {
                                ...
                                if (data.responseCode == '000') {
                                    ...
                                    // alert(JSON.stringify(payroll_summary)); return false;
                        ...
                        function thousands_separators(num)
                    {
                        ...
                        <tr>
                            <th>Casual Labour</th>
                            <td>${payroll_summary.casual_labour}</td>                            
                        </tr>
                        <tr>
                            <th>Car Allowance</th>
                            <td>${payroll_summary.car_allowance}</td>                            
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th>Stewards Allowance</th>
                            <td>${payroll_summary.stewards_allowance}</td>                            
                        </tr>
                        <tr>
                            <th>Displacement Allowance</th>
                            <td>${payroll_summary.displacement_allowance}</td>                            
                        </tr>
                        <tr>
                            <th>Audit Allowance</th>
                            <td>${payroll_summary.audit_allowance}</td>                            
                        </tr>
                        <tr>
                            <th>Word Processing Allowance</th>
                            <td>${payroll_summary.word_processing}</td>                            
                        </tr>
                        <tr>
                            <th>Sundry Allowance</th>
                            <td>${payroll_summary.sundry_allowance}</td>                            
                        </tr>
                        <tr>
                            <th>Bonus</th>
                            <td>${payroll_summary.bonus}</td>                            
                        </tr>
                        <tr>
                            <th>Duty Allowance</th>
                            <td>${payroll_summary.duty_allowance}</td>                            
                        </tr>
                        <tr>
                        <th>Overtime Allowance</th>
                        <td>${payroll_summary.overtime}</td>                            
                    </tr>
                        <tr>
                            <th>Gross Salary</th>
                        ...
                        <tr>
                            <th>Employer NASSIT(10%)</th>
                            <td>${payroll_summary.employer_nassit}</td>                            
                        </tr>
                        <tr>
                            <th>Employee NASSIT(5%)</th>
                        ...
                        <tr>
                            <th>Staff Association</th>
                            <td>${payroll_summary.staff_association}</td>                            
                        </tr>
                        <tr>
                            <th>PAYE</th>
                        ...
                        <tr>
                            <th>Posting Date</th>
                            <td>${payroll_summary.posting_date}</td>                            
                        </tr>
                        <tr>
                            <th>Verified by</th>
                        ...
                        <tr>
                            ...
                            <td>${payroll_summary.documentRef}</td>                            
                        </tr>
            ...
            h = function (e) {
                ...
                },
                {
                    ...
                    key: "downloadPayrollExcel",
                    value: function () {

                        var e = document.createElement("a");
                        e.setAttribute("href", "data:excel/plain;charset=utf-8," + encodeURIComponent(this.getCSVData())), e.setAttribute("download", "payroll_" + this.payrollId + ".csv"), e.style.display = "none", document.body.appendChild(e), e.click(), document.body.removeChild(e)
                    }
                },
                {
                    //returns payroll data to be downloaded in pdf format
                    key: "downloadPayrollPdf",
                    value: function () {
    ...
    6: [function (e, t, a) {
        ...
        var r = function () {
            ...
            {
                key: "getTableTopButtonForPayrollEmployeeHtml",
                value: function () {
                    var e = "";
                    return this.getShowAddNew() && (e = '<button onclick="modJs.renderForm();return false;" class="btn btn-small btn-primary">' +
                        ...
                        (e +=
                            '<button onclick="modJs.downloadEmployeePayrollExcel();return false;" class="btn btn-small btn-primary">' +
                            this.gt("Download(Excel)") +
                            ' <i class="fa fa-download"></i></button>'),
                        (e += "&nbsp;&nbsp;"),
                        (e +=
                            '<button onclick="modJs.downloadEmployeePayrollPdf();return false;" class="btn btn-small btn-primary">' +
            ...
            {
                key: "getTableTopButtonForPayrollColumnHtml",
                value: function () {
                    var e = "";
                    return this.getShowAddNew() && (e = '<button onclick="modJs.renderForm();return false;" class="btn btn-small btn-primary">' +
                        this.gt(this.getAddNewLabel()) + ' <i class="fa fa-plus"></i></button>'),
                        null != this.getFilters() && ("" !== e && (e += "&nbsp;&nbsp;"),
                            e += '<button onclick="modJs.showFilters();return false;" class="btn btn-small btn-primary">' + this.gt("Filter") + ' <i class="fa fa-filter"></i></button>', e += "&nbsp;&nbsp;", this.filtersAlreadySet ? e += '<button id="__id___resetFilters" onclick="modJs.resetFilters();return false;" class="btn btn-small btn-default">__filterString__ <i class="fa fa-times"></i></button>' : e += '<button id="__id___resetFilters" onclick="modJs.resetFilters();return false;" class="btn btn-small btn-default" style="display:none;">__filterString__ <i class="fa fa-times"></i></button>'),
                        (e +=
                            '<button onclick="modJs.downloadPayrollColumnExcel();return false;" class="btn btn-small btn-primary">' +
                            this.gt("Download(Excel)") +
                            ' <i class="fa fa-download"></i></button>'),
                        (e += "&nbsp;&nbsp;"),
                        (e +=
                            '<button onclick="modJs.downloadPayrollColumnPdf();return false;" class="btn btn-small btn-primary">' +
                            this.gt("Download(pdf)") +
                            ' <i class="fa fa-download"></i></button>'),
                        (e = e.replace(/__id__/g, this.getTableName())), "" !== (e = "" !== this.currentFilterString && null != this.currentFilterString ? e.replace(/__filterString__/g, this.currentFilterString) : e.replace(/__filterString__/g, "Reset Filters")) && (e = '<div class="row"><div class="col-xs-12">' + e + "</div></div>"), e
                }
            ...
            {
                key: "getTableTopButtonForPayrollHtml",
                value: function () {
                    var e = "";
                    return this.getShowAddNew() && (e = '<button onclick="modJs.renderForm();return false;" class="btn btn-small btn-primary">' +
                        this.gt(this.getAddNewLabel()) + ' <i class="fa fa-plus"></i></button>'),
                        null != this.getFilters() && ("" !== e && (e += "&nbsp;&nbsp;"),
                            e += '<button onclick="modJs.showFilters();return false;" class="btn btn-small btn-primary">' + this.gt("Filter") + ' <i class="fa fa-filter"></i></button>', e += "&nbsp;&nbsp;", this.filtersAlreadySet ? e += '<button id="__id___resetFilters" onclick="modJs.resetFilters();return false;" class="btn btn-small btn-default">__filterString__ <i class="fa fa-times"></i></button>' : e += '<button id="__id___resetFilters" onclick="modJs.resetFilters();return false;" class="btn btn-small btn-default" style="display:none;">__filterString__ <i class="fa fa-times"></i></button>'),
                        (e +=
                            '<button onclick="modJs.downloadPayrollExcel();return false;" class="btn btn-small btn-primary">' +
                            this.gt("Download(Excel)") +
                            ' <i class="fa fa-download"></i></button>'),
                        (e += "&nbsp;&nbsp;"),
                        (e +=
                            '<button onclick="modJs.downloadPayrollPdf();return false;" class="btn btn-small btn-primary">' +
                            this.gt("Download(pdf)") +
                            ' <i class="fa fa-download"></i></button>'),
                        (e = e.replace(/__id__/g, this.getTableName())), "" !== (e = "" !== this.currentFilterString && null != this.currentFilterString ? e.replace(/__filterString__/g, this.currentFilterString) : e.replace(/__filterString__/g, "Reset Filters")) && (e = '<div class="row"><div class="col-xs-12">' + e + "</div></div>"), e
                }
            ...
            {
                key: "getTableTopButtonForDeductionGroupHtml",
                value: function () {
                    var e = "";
                    return this.getShowAddNew() && (e = '<button onclick="modJs.renderForm();return false;" class="btn btn-small btn-primary">' +
                        this.gt(this.getAddNewLabel()) + ' <i class="fa fa-plus"></i></button>'),
                        ...
                        (e += "&nbsp;&nbsp;"),
                        (e +=
                            '<button onclick="modJs.downloadDeductionGroupExcel();return false;" class="btn btn-small btn-primary">' +
                            this.gt("Download(Excel)") +
                            ' <i class="fa fa-download"></i></button>'),
                        (e += "&nbsp;&nbsp;"),
                        (e +=
                            '<button onclick="modJs.downloadDeductionGroupPdf();return false;" class="btn btn-small btn-primary">' +
                            this.gt("Download(pdf)") +
                            ' <i class="fa fa-download"></i></button>'),
                        (e = e.replace(/__id__/g, this.getTableName())), "" !== (e = "" !== this.currentFilterString && null != this.currentFilterString ? e.replace(/__filterString__/g, this.currentFilterString) : e.replace(/__filterString__/g, "Reset Filters")) && (e = '<div class="row"><div class="col-xs-12">' + e + "</div></div>"), e
                }
                ...
                {
                    key: "getTableTopButtonForDeductionHtml",
                    value: function () {
                        var e = ""; 
                        return this.getShowAddNew() && (e = '<button onclick="modJs.renderForm();return false;" class="btn btn-small btn-primary">' +
                            this.gt(this.getAddNewLabel()) + ' <i class="fa fa-plus"></i></button>'),
                            ...
                            (e += "&nbsp;&nbsp;"),
                            (e +=
                                '<button onclick="modJs.downloadDeductionExcel();return false;" class="btn btn-small btn-primary">' +
                                this.gt("Download(Excel)") +
                                ' <i class="fa fa-download"></i></button>'),
                            (e += "&nbsp;&nbsp;"),
                            (e +=
                                '<button onclick="modJs.downloadDeductionPdf();return false;" class="btn btn-small btn-primary">' +
                                this.gt("Download(pdf)") +
                                ' <i class="fa fa-download"></i></button>'),
                            (e = e.replace(/__id__/g, this.getTableName())), "" !== (e = "" !== this.currentFilterString && null != this.currentFilterString ? e.replace(/__filterString__/g, this.currentFilterString) : e.replace(/__filterString__/g, "Reset Filters")) && (e = '<div class="row"><div class="col-xs-12">' + e + "</div></div>"), e
                    }
                ...
                {
                    key: "getTableTopButtonForPayslipTemplaleHtml",
                    value: function () {
                        var e = ""; 
                        return this.getShowAddNew() && (e = '<button onclick="modJs.renderForm();return false;" class="btn btn-small btn-primary">' +
                            this.gt(this.getAddNewLabel()) + ' <i class="fa fa-plus"></i></button>'),
                            ...
                            (e += "&nbsp;&nbsp;"),
                            (e +=
                                '<button onclick="modJs.downloadPayTempExcel();return false;" class="btn btn-small btn-primary">' +
                                this.gt("Download(Excel)") +
                                ' <i class="fa fa-download"></i></button>'),
                            (e += "&nbsp;&nbsp;"),
                            (e +=
                                '<button onclick="modJs.downloadPayTempPdf();return false;" class="btn btn-small btn-primary">' +
                                this.gt("Download(pdf)") +
                                ' <i class="fa fa-download"></i></button>'),
                            (e = e.replace(/__id__/g, this.getTableName())), "" !== (e = "" !== this.currentFilterString && null != this.currentFilterString ? e.replace(/__filterString__/g, this.currentFilterString) : e.replace(/__filterString__/g, "Reset Filters")) && (e = '<div class="row"><div class="col-xs-12">' + e + "</div></div>"), e
                    }
            ...
            {
                key: "downloadEmployeePayrollExcel",
                value: function () {
                    window.location.href =
                        "../../../../rokel_hrm/core/appDownloads/employeepayrollDataExcel.php";
                }
            },
            {
                key: "downloadEmployeePayrollPdf",
                value: function () {
                    window.location.href =
                        "../../../../rokel_hrm/core/appDownloads/employeepayrollDataPdf.php";
                }
            },
                {
                    key: "downloadPayTempExcel",
                    value: function () {
                        window.location.href =
                            "../../../../rokel_hrm/core/appDownloads/payTempDataExcel.php";
                    }
                },
                {
                    key: "downloadPayTempPdf",
                    value: function () {
                        window.location.href =
                            "../../../../rokel_hrm/core/appDownloads/payTempDataPdf.php";
                    }
                },
            {
                key: "downloadDeductionGroupExcel",
                value: function () {
                    window.location.href =
                        "../../../../rokel_hrm/core/appDownloads/deductiongroupDataExcel.php";
                }
            },
            {
                key: "downloadDeductionGroupPdf",
                value: function () {
                    window.location.href =
                        "../../../../rokel_hrm/core/appDownloads/deductiongroupDataPdf.php";
                }
            },
                {
                    key: "downloadDeductionExcel",
                    value: function () {
                        window.location.href =
                            "../../../../rokel_hrm/core/appDownloads/deductionDataExcel.php";
                    }
                },
                {
                    key: "downloadDeductionPdf",
                    value: function () {
                        window.location.href =
                            "../../../../rokel_hrm/core/appDownloads/deductionDataPdf.php";
                    }
                },
            {
                key: "downloadPayrollColumnExcel",
                value: function () {
                    window.location.href =
                        "../../../../rokel_hrm/core/appDownloads/payrollcolumnDataExcel.php";
                }
            },
            {
                key: "downloadPayrollColumnPdf",
                value: function () {
                    window.location.href =
                        "../../../../rokel_hrm/core/appDownloads/payrollcolumnDataPdf.php";
                }
            }, {
                key: "downloadPayrollExcel",
                value: function () {
                    window.location.href =
                        "../../../../rokel_hrm/core/appDownloads/payrollDataExcel.php";
                }
            },
            {
                key: "downloadPayrollPdf",
                value: function () {
                    window.location.href =
                        "../../../../rokel_hrm/core/appDownloads/payrollDataPdf.php";
                }
            }, {
                key: "getActionButtonHeader",
                value: function () {
                ...
                value: function (e) {
                    ...
                    if (this.getRemoteTable()) {
                        ...
                        var n;
                        n = this.getTableTopButtonForPayrollEmployeeHtml() + this.getTableHTMLTemplate();
                        ...
                        if (this.showActionButtons() && t.push(this.getActionButtonHeader()), this.showActionButtons())
                            for (var i = 0; i < l.length; i++) l[i].push(this.getActionButtonsHtml(l[i][0], l[i]));
                        var n;
                        n = this.getTableTopButtonForPayrollHtml() + this.getTableHTMLTemplate();
                        var o = $("#" + e + " .dataTables_paginate .active a").html(),
                            r = 0;
                        void 0 !== o && null != o && (r = 15 * parseInt(o, 10) - 15), $("#" + e).html(n);
                        var s = {
                        ...
                        if (this.showActionButtons() && t.push(this.getActionButtonHeader()), this.showActionButtons())
                            for (var i = 0; i < l.length; i++) l[i].push(this.getActionButtonsHtml(l[i][0], l[i]));
                        var n;
                        n = this.getTableTopButtonForDeductionGroupHtml() + this.getTableHTMLTemplate();
                        var o = $("#" + e + " .dataTables_paginate .active a").html(),
                            r = 0;
                        void 0 !== o && null != o && (r = 15 * parseInt(o, 10) - 15), $("#" + e).html(n);
                        var s = {
                        ...
                        if (this.showActionButtons() && t.push(this.getActionButtonHeader()), this.showActionButtons())
                            for (var i = 0; i < l.length; i++) l[i].push(this.getActionButtonsHtml(l[i][0], l[i]));
                        var n;
                        n = this.getTableTopButtonForDeductionHtml() + this.getTableHTMLTemplate();
                        var o = $("#" + e + " .dataTables_paginate .active a").html(),
                            r = 0;
                        void 0 !== o && null != o && (r = 15 * parseInt(o, 10) - 15), $("#" + e).html(n);
                        var s = {
                        ...
                        if (this.showActionButtons() && t.push(this.getActionButtonHeader()), this.showActionButtons())
                            for (var i = 0; i < l.length; i++) l[i].push(this.getActionButtonsHtml(l[i][0], l[i]));
                        var n;
                        n = this.getTableTopButtonForPayslipTemplaleHtml() + this.getTableHTMLTemplate();
                        var o = $("#" + e + " .dataTables_paginate .active a").html(),
                            r = 0;
                        void 0 !== o && null != o && (r = 15 * parseInt(o, 10) - 15), $("#" + e).html(n);
                        var s = {
                ...
                value: function (e) {
                    if (e == 'PayrollColumn') {
                        ...
                        var l;
                        l = this.getTableTopButtonForPayrollColumnHtml() + this.getTableHTMLTemplate();
