...
})()(
    {
        1: [
            function (e, t, a) {
                "use strict";
                var l = e("./lib");
                window.LeaveTimelineAdapter = l.LeaveTimelineAdapter;
            },
            { "./lib": 2 },
        ],
        2: [
            function (e, t, a) {
                    ...
                    return (
                        ...
                        i(t, [
                            ...
                            },
                            {
                                key: "get",
                                value: function () {
                                    null === this.timeline && this.getUpcomingApprovedLeaves({});
                                },
                            },
                            {
                                key: "getUpcomingApprovedLeaves",
                                value: function (e, t) {
                                    var a = JSON.stringify({}),
                                        l = [];
                                    (l.callBackData = []),
                                        (l.callBackSuccess = "getUpcomingApprovedLeavesSuccessCallBack"),
                                        (l.callBackFail = "getUpcomingApprovedLeavesFailCallBack"),
                                        this.customAction("getUpcomingApprovedLeaves", "admin=leave_charts", a, l);
                                },
                            },
                            {
                                key: "getUpcomingApprovedLeavesFailCallBack",
                                value: function (e) {
                                    this.showMessage("Error", e);
                                },
                            },
                            {
                                key: "getUpcomingApprovedLeavesSuccessCallBack",
                                value: function (e) {
                                    var t = Handlebars.compile(document.getElementById("item-template").innerHTML),
                                        a = document.getElementById("visualizationLeaveTimeline"),
                                        l = new vis.DataSet(e),
                                        i = { template: t, zoomable: !1, start: new Date().toDateString(), timeAxis: { scale: "day", step: 7 }, minHeight: "400px", orientation: "top" };
                                    this.timeline = new vis.Timeline(a, l, i);
                                },
                            },
                        ]),
                        t
                ...
                t.exports = { LeaveTimelineAdapter: o };
            },
            { "../../../api/BaseGraphAdapter": 5 },
        ],
        3: [
            function (e, t, a) {
                "use strict";
...
//# sourceMappingURL=leave_charts.js.map
