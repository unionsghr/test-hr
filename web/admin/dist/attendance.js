! function() {
    ...
    1: [function(e, t, a) {
        "use strict";
        var l = e("./lib");
        window.AttendanceAdapter = l.AttendanceAdapter, window.AttendanceStatusAdapter = l.AttendanceStatusAdapter
    }, {
        "./lib": 2
    }],
    2: [function(e, t, a) {
        ...
        var c = function(e) {
                function t(e, a, l, i) {
                    ...
                    return n.photoAttendance = !1, n
                }
                return u(t, i.default), l(t, [{
                    key: "getDataMapping",
                    value: function() {
                        return ["id", "employee", "in_time", "out_time", "note"]
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        return {
                            aoColumnDefs: [{
                                ...
                                fnRender: function(t, a) {
                                    return e.preProcessRemoteTableData(t, a, 4)
                                },
                                aTargets: [4]
                            }, {
                    ...
                    value: function(e, t, a) {
                        return 2 === a ? "0000-00-00 00:00:00" === t || "" === t || void 0 === t || null == t ? "" : Date.parse(t).toString("yyyy MMM d  <b>HH:mm</b>") : 3 === a ? "0000-00-00 00:00:00" === t || "" === t || void 0 === t || null == t ? "" : Date.parse(t).toString("MMM d  <b>HH:mm</b>") : 4 === a ? null != t && t.length > 10 ? t.substring(0, 10) + ".." : t : void 0
                    }
                }, {
                    key: "save",
                    value: function() {
                        ...
                        if (e.checkValues()) {
                            ...
                            if (null == a) {
                                ...
                                null != l && void 0 !== l && "" !== l && (t.id = l);
                                var i = JSON.stringify(t),
                                    r = [];
                                r.callBackData = [], r.callBackSuccess = "saveSuccessCallback", r.callBackFail = "saveFailCallback", this.customAction("savePunch", "admin=attendance", i, r)
                            } else {
                                var s = $("#" + this.getTableName() + "Form .label");
                                s.html(a), s.show()
                            }
                        }
                    }
                    ...
                    value: function(e) {
                        this.showMessage("Error saving attendance entry", e)
                    }
                }, {
                    ...
                    value: function(e) {
                        var t = JSON.stringify({
                            ...
                            a = [];
                        a.callBackData = [], a.callBackSuccess = "getImagesSuccessCallback", a.callBackFail = "getImagesFailCallback", this.customAction("getImages", "admin=attendance", t, a)
                    }
                }, {
                    key: "getImagesSuccessCallback",
                    value: function(e) {
                        if ($("#attendnaceMapCanvasIn").remove(), $("#attendnaceCanvasInWrapper").html('<canvas id="attendnaceCanvasIn" height="156" width="208" style="border: 1px #222 dotted;"></canvas>'), $("#attendnaceCanvasOut").remove(), $("#attendnaceCanvasOutWrapper").html('<canvas id="attendnaceCanvasOut" height="156" width="208" style="border: 1px #222 dotted;"></canvas>'), $("#attendnaceCanvasPunchInTime").html(""), $("#attendnaceCanvasPunchOutTime").html(""), $("#punchInLocation").html(""), $("#punchOutLocation").html(""), $("#punchInIp").html(""), $("#punchOutIp").html(""), $("#attendnaceMapCanvasIn").remove(), $("#attendnaceMapCanvasInWrapper").html('<canvas id="attendnaceMapCanvasIn" height="156" width="208" style="border: 1px #222 dotted;"></canvas>'), $("#attendnaceMapCanvasOut").remove(), $("#attendnaceMapCanvasOutWrapper").html('<canvas id="attendnaceMapCanvasOut" height="156" width="208" style="border: 1px #222 dotted;"></canvas>'), $("#attendancePhotoModel").modal("show"), $("#attendnaceCanvasEmp").html(e.employee_Name), e.in_time && $("#attendnaceCanvasPunchInTime").html(Date.parse(e.in_time).toString("yyyy MMM d  <b>HH:mm</b>")), e.image_in) {
                            $("#attendancePhoto").show();
                            var t = document.getElementById("attendnaceCanvasIn").getContext("2d"),
                                a = new Image;
                            a.onload = function() {
                                t.drawImage(a, 0, 0)
                            }, a.src = e.image_in
                        }
                        if (e.out_time && $("#attendnaceCanvasPunchOutTime").html(Date.parse(e.out_time).toString("yyyy MMM d  <b>HH:mm</b>")), e.image_out) {
                            $("#attendancePhoto").show();
                            var l = document.getElementById("attendnaceCanvasOut").getContext("2d"),
                                i = new Image;
                            i.onload = function() {
                                l.drawImage(i, 0, 0)
                            }, i.src = e.image_out
                        }
                        if (e.map_lat && ($("#attendanceMap").show(), $("#punchInLocation").html(e.map_lat + "," + e.map_lng)), e.map_out_lat && ($("#attendanceMap").show(), $("#punchOutLocation").html(e.map_out_lat + "," + e.map_out_lng)), e.in_ip && $("#punchInIp").html(e.in_ip), e.out_ip && $("#punchOutIp").html(e.out_ip), e.map_snapshot) {
                            $("#attendanceMap").show();
                            var n = document.getElementById("attendnaceMapCanvasIn").getContext("2d"),
                                r = new Image;
                            r.onload = function() {
                                n.drawImage(r, 0, 0)
                            }, r.src = e.map_snapshot
                        }
                        if (e.map_out_snapshot) {
                            $("#attendanceMap").show();
                            var s = document.getElementById("attendnaceMapCanvasOut").getContext("2d"),
                                o = new Image;
                            o.onload = function() {
                                s.drawImage(o, 0, 0)
                            }, o.src = e.map_out_snapshot
                        }
                    }
                }, {
                    key: "getImagesFailCallback",
                    value: function(e) {
                    ...
                    value: function(e, t) {
                        var a = void 0;
                        return a = (a = 1 === this.photoAttendance ? '<div style="width:80px;">_edit__delete__photo_</div>' : '<div style="width:80px;">_edit__delete_</div>').replace("_photo_", '<img class="tableActionButton" src="_BASE_images/map.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Show Photo" onclick="modJs.showPunchImages(_id_);return false;"></img>'), a = this.showDelete ? a.replace("_delete_", '<img class="tableActionButton" src="_BASE_images/delete.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Delete" onclick="modJs.deleteRow(_id_);return false;"></img>') : a.replace("_delete_", ""), a = (a = (a = this.showEdit ? a.replace("_edit_", '<img class="tableActionButton" src="_BASE_images/edit.png" style="cursor:pointer;" rel="tooltip" title="Edit" onclick="modJs.edit(_id_);return false;"></img>') : a.replace("_edit_", "")).replace(/_id_/g, e)).replace(/_BASE_/g, this.baseUrl)
                    }
                }, {
                    key: "getHelpLink",
                    value: function() {
            ...
            d = function(e) {
                ...
                return u(t, i.default), l(t, [{
                    ...
                    key: "getActionButtonsHtml",
                    value: function(e, t) {
                        var a = '<div class="online-button-_COLOR_"></div>';
                        return a = a.replace(/_BASE_/g, this.baseUrl), "Not Clocked In" == t[2] ? a = a.replace(/_COLOR_/g, "gray") : "Clocked Out" == t[2] ? a = a.replace(/_COLOR_/g, "yellow") : "Clocked In" == t[2] && (a = a.replace(/_COLOR_/g, "green")), a
                    }
                }, {
                    key: "isSubProfileTable",
                    value: function() {
        ...
        t.exports = {
            AttendanceAdapter: c,
            AttendanceStatusAdapter: d
        }
    }, {
        "../../../api/AdapterBase": 4,
        "../../../api/FormValidation": 5
    }],
    3: [function(e, t, a) {
        "use strict";
                        ...
                        var a = function(e) {
                                ...
                                if (jQuery.inArray(n, t.inputTypes) >= 0) {
                                    ...
                                    var o = e.attr("validation"),
                                        u = !1;
                                    void 0 !== o && null != o && void 0 !== t.validator[o] && null != t.validator[o] ? u = t.validator[o](a) : (u = !t.validateAll || (void 0 !== o && null != o && "none" === o || t.validator.input(a)), t.formObject[i] = a), u ? (t.clearError(e, null), t.formObject[i] = a) : t.addError(e, null)
                                }
                            },
                            l = $("#" + this.formId + " :input");
            ...
            return i(e, [{
                ...
                value: function(e, t, a) {
                    ...
                    var i = this.getFormFields(),
                        n = this.getFilters();
                    if (null != n)
                        for (var r = 0; r < n.length; r++)(null == (l = this.getMetaFieldValues(n[r][0], i)) || "select" !== l.type && "select2" !== l.type && "select2multi" !== l.type) && i.push(n[r]);
                ...
                value: function(e) {
                    if (this.getRemoteTable()) this.createTableServer(e);
                        ...
                        $.extend(o, u), $("#" + e + " #grid").dataTable(o), $(".dataTables_paginate ul").addClass("pagination"), $(".dataTables_length").hide(), $(".dataTables_filter input").addClass("form-control"), $(".dataTables_filter input").attr("placeholder", "Search"), $(".dataTables_filter label").contents().filter(function() {
                ...
                value: function(e, t) {
                    var a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
                        ...
                        n = this,
                        r = "";
                    r = i ? "#plainMessageModel" : "#messageModel", $(r).off(), i ? this.renderModel("plainMessage", e, t) : this.renderModel("message", e, t), null != a ? ($(r).modal({
                        show: !0
                ...
                value: function(e, t, a, l, i) {
                    var n = this,
                        r = "";
                    r = i ? "#dataMessageModel" : "#messageModel", $(r).unbind("hide"), i ? this.renderModelFromDom("dataMessage", e, t) : this.renderModelFromDom("message", e, t), null != a ? ($(r).modal({
                        show: !0
                    }), $(r).on("hidden.bs.modal", function() {
                        a.apply(n, l), $(".modal-backdrop").remove()
                    })) : $(r).modal({
                    ...
                    for (var u in null == i && (i = []), e)
                        if (e.hasOwnProperty(u)) {
                            if (r = "", s = null, "select" === (i = this.getMetaFieldValues(u, o)).type || "select2" === i.type) {
                                if (void 0 !== i["remote-source"] && null != i["remote-source"]) a = i["remote-source"], "NULL" === e[u] ? r = void 0 !== i["null-label"] && null != i["null-label"] ? i["null-label"] : "Not Selected" : s = r = this.fieldMasterData[a[0] + "_" + a[1] + "_" + a[2]][e[u]];
                ...
                value: function(e) {
                    ...
                    o.attr("id", s), o.html(t), o.find(".datefield").datepicker({
                        viewMode: 2
                    ...
                    }), this.showDomElement("Edit", o, null, null, !0), $(".filterBtn").off(), $(".filterBtn").on("click", function(e) {
                ...
                value: function(e) {
                    ...
                    this.showFormOnPopup ? (o = $('<div class="reviewBlock popupForm" data-content="Form"></div>')).attr("id", u) : o = $("#" + this.getTableName() + "Form"), o.html(a), o.find(".datefield").datepicker({
                        viewMode: 2
                    }), o.find(".timefield").datetimepicker({
                        language: "en",
                        pickDate: !1
                    ...
                    if (!1 === this.showSave ? o.find(".saveBtn").remove() : (o.find(".saveBtn").off(), o.find(".saveBtn").data("modJs", this), o.find(".saveBtn").on("click", function() {
                        ...
                        })), !1 === this.showCancel ? o.find(".cancelBtn").remove() : (o.find(".cancelBtn").off(), o.find(".cancelBtn").data("modJs", this), o.find(".cancelBtn").on("click", function() {
                ...
                value: function(e, t) {
                    ...
                    s.attr("id", r), s.html(a), s.find(".datefield").datepicker({
                        viewMode: 2
                    ...
                    for (var i = 0; i < a.length; i++)
                        ...
                        if ("0000-00-00 00:00:00" !== e[a[i][0]] && "" !== e[a[i][0]] && null != e[a[i][0]] && void 0 !== e[a[i][0]]) {
                            var n = e[a[i][0]].split(" "),
                                r = n[0].split("-"),
                                s = n[1].split(":");
                            $(t + " #" + a[i][0] + "_datetime").data("datetimepicker").setLocalDate(new Date(r[0], parseInt(r[1], 10) - 1, r[2], s[0], s[1], s[2]))
                        }
