! function() {
    ...
    1: [function(e, t, l) {
        "use strict";
        var a = e("./lib");
        window.EmployeeAdapter = a.EmployeeAdapter, window.TerminatedEmployeeAdapter = a.TerminatedEmployeeAdapter, window.ArchivedEmployeeAdapter = a.ArchivedEmployeeAdapter, window.EmployeeSkillAdapter = a.EmployeeSkillAdapter, window.EmployeeEducationAdapter = a.EmployeeEducationAdapter, window.EmployeeCertificationAdapter = a.EmployeeCertificationAdapter, window.EmployeeLanguageAdapter = a.EmployeeLanguageAdapter, window.EmployeeDependentAdapter = a.EmployeeDependentAdapter, window.EmergencyContactAdapter = a.EmergencyContactAdapter, window.EmployeeImmigrationAdapter = a.EmployeeImmigrationAdapter, window.EmployeeSubSkillsAdapter = a.EmployeeSubSkillsAdapter, window.EmployeeSubEducationAdapter = a.EmployeeSubEducationAdapter, window.EmployeeSubCertificationAdapter = a.EmployeeSubCertificationAdapter, window.EmployeeSubLanguageAdapter = a.EmployeeSubLanguageAdapter, window.EmployeeSubDependentAdapter = a.EmployeeSubDependentAdapter, window.EmployeeSubEmergencyContactAdapter = a.EmployeeSubEmergencyContactAdapter, window.EmployeeSubDocumentAdapter = a.EmployeeSubDocumentAdapter, window.EmployeeDocumentAdapter = a.EmployeeDocumentAdapter
    }, {
        "./lib": 2
    }],
    2: [function(e, t, l) {
        ...
        var d = function(e) {
                ...
                return u(t, o.default), a(t, [{
                    ...
                    value: function() {
                        return '<button class="btn btn-small btn-success" onclick="modJs.subModJsList[\'tab' + this.tab + '\'].renderForm();" style="margin-right:10px;"><i class="fa fa-plus"></i></button>' + this.gt("Skills")
                    }
                }, {
                    key: "getSubItemHtml",
                    value: function(e, t, l) {
                        return $('<div class="list-group-item sub-tab-item"><h5 class="list-group-item-heading" style="font-weight:bold;">' + e[2] + t + l + '</h5><p class="list-group-item-text">' + nl2br(e[3]) + "</p></div>")
                    }
                }]), t
            }(),
            c = function(e) {
                ...
                return u(t, o.default), a(t, [{
                    key: "getDataMapping",
                    value: function() {
                        return ["id", "employee", "education_id", "institute", "date_start", "date_end"]
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
                    ...
                    key: "getSubHeaderTitle",
                    value: function() {
                        return '<button class="btn btn-small btn-success" onclick="modJs.subModJsList[\'tab' + this.tab + '\'].renderForm();" style="margin-right:10px;"><i class="fa fa-plus"></i></button>' + this.gt("Education")
                    }
                }, {
                    key: "getSubItemHtml",
                    value: function(e, t, l) {
                        ...
                        return $('<div class="list-group-item sub-tab-item"><h5 class="list-group-item-heading" style="font-weight:bold;">' + e[2] + t + l + '</h5><p class="list-group-item-text"><i class="fa fa-calendar"></i> Start: <b>' + a + '</b></p><p class="list-group-item-text"><i class="fa fa-calendar"></i> Completed: <b>' + i + '</b></p><p class="list-group-item-text"><i class="fa fa-building-o"></i> Institute: <b>' + e[3] + "</b></p></div>")
                    }
                }]), t
            }(),
            p = function(e) {
                ...
                return u(t, o.default), a(t, [{
                    key: "getDataMapping",
                    value: function() {
                        return ["id", "employee", "certification_id", "institute", "date_start", "date_end"]
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
                    ...
                    key: "getSubHeaderTitle",
                    value: function() {
                        return '<button class="btn btn-small btn-success" onclick="modJs.subModJsList[\'tab' + this.tab + '\'].renderForm();" style="margin-right:10px;"><i class="fa fa-plus"></i></button>' + this.gt("Certifications")
                    }
                }, {
                    key: "getSubItemHtml",
                    value: function(e, t, l) {
                        ...
                        return $('<div class="list-group-item sub-tab-item"><h5 class="list-group-item-heading" style="font-weight:bold;">' + e[2] + t + l + '</h5><p class="list-group-item-text"><i class="fa fa-calendar"></i> Granted On: <b>' + a + '</b></p><p class="list-group-item-text"><i class="fa fa-calendar"></i> Valid Thru: <b>' + i + '</b></p><p class="list-group-item-text"><i class="fa fa-building-o"></i> Institute: <b>' + e[3] + "</b></p></div>")
                    }
                }]), t
            }(),
            m = function(e) {
                ...
                return u(t, o.default), a(t, [{
                    key: "getDataMapping",
                    value: function() {
                        return ["id", "employee", "language_id", "reading", "speaking", "writing", "understanding"]
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
                    ...
                    key: "getSubHeaderTitle",
                    value: function() {
                        return '<button class="btn btn-small btn-success" onclick="modJs.subModJsList[\'tab' + this.tab + '\'].renderForm();" style="margin-right:10px;"><i class="fa fa-plus"></i></button>' + this.gt("Languages")
                    }
                }, {
                    key: "getSubItemHtml",
                    value: function(e, t, l) {
                        return $('<div class="list-group-item sub-tab-item"><h5 class="list-group-item-heading" style="font-weight:bold;">' + e[2] + t + l + '</h5><p class="list-group-item-text"><i class="fa fa-asterisk"></i> Reading: <b>' + e[3] + '</b></p><p class="list-group-item-text"><i class="fa fa-asterisk"></i> Speaking: <b>' + e[4] + '</b></p><p class="list-group-item-text"><i class="fa fa-asterisk"></i> Writing: <b>' + e[5] + '</b></p><p class="list-group-item-text"><i class="fa fa-asterisk"></i> Understanding: <b>' + e[6] + "</b></p></div>")
                    }
                }, {
            ...
            h = function(e) {
                ...
                return u(t, o.default), a(t, [{
                    key: "getDataMapping",
                    value: function() {
                        return ["id", "employee", "name", "relationship", "dob", "id_number"]
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
                    ...
                    key: "getSubHeaderTitle",
                    value: function() {
                        return '<button class="btn btn-small btn-success" onclick="modJs.subModJsList[\'tab' + this.tab + '\'].renderForm();" style="margin-right:10px;"><i class="fa fa-plus"></i></button>' + this.gt("Dependents")
                    }
                }, {
                    key: "getSubItemHtml",
                    value: function(e, t, l) {
                        return $('<div class="list-group-item sub-tab-item"><h5 class="list-group-item-heading" style="font-weight:bold;">' + e[2] + t + l + '</h5><p class="list-group-item-text"><i class="fa fa-users"></i> Relationship: <b>' + e[3] + '</b></p><p class="list-group-item-text"><i class="fa fa-user"></i> Name: <b>' + e[2] + "</b></p></div>")
                    }
                }]), t
            }(),
            f = function(e) {
                ...
                return u(t, o.default), a(t, [{
                    key: "getDataMapping",
                    value: function() {
                        return ["id", "employee", "name", "relationship", "home_phone", "work_phone", "mobile_phone"]
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
                    ...
                    key: "getSubHeaderTitle",
                    value: function() {
                        return '<button class="btn btn-small btn-success" onclick="modJs.subModJsList[\'tab' + this.tab + '\'].renderForm();" style="margin-right:10px;"><i class="fa fa-plus"></i></button>' + this.gt("Emergency Contacts")
                    }
                }, {
                    key: "getSubItemHtml",
                    value: function(e, t, l) {
                        return $('<div class="list-group-item sub-tab-item"><h5 class="list-group-item-heading" style="font-weight:bold;">' + e[2] + t + l + '</h5><p class="list-group-item-text"><i class="fa fa-users"></i> Relationship: <b>' + e[3] + '</b></p><p class="list-group-item-text"><i class="fa fa-user"></i> Name: <b>' + e[2] + '</b></p><p class="list-group-item-text"><i class="fa fa-phone"></i> Home Phone: <b>' + e[4] + '</b></p><p class="list-group-item-text"><i class="fa fa-phone"></i> Mobile Phone: <b>' + e[6] + "</b></p></div>")
                    }
                }]), t
            }(),
            y = function(e) {
                ...
                return u(t, o.default), a(t, [{
                    key: "getDataMapping",
                    value: function() {
                        return ["id", "employee", "document", "details", "date_added", "valid_until", "status", "attachment"]
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
                    ...
                    key: "getSubHeaderTitle",
                    value: function() {
                        return '<button class="btn btn-small btn-success" onclick="modJs.subModJsList[\'tab' + this.tab + '\'].renderForm();" style="margin-right:10px;"><i class="fa fa-plus"></i></button>' + this.gt("Documents")
                    }
                }, {
                    key: "getSubItemHtml",
                    value: function(e, t, l) {
                        ...
                        var i = '<button id="#_id_#_download" onclick="download(\'' + e[7] + '\');return false;" type="button" style="position: absolute;bottom: 5px;right: 70px;font-size: 13px;" tooltip="Download"><li class="fa fa-cloud-download"></li></button>';
                        return $('<div class="list-group-item sub-tab-item"><h5 class="list-group-item-heading" style="font-weight:bold;">' + e[2] + i + t + l + '</h5><p class="list-group-item-text">' + nl2br(e[3]) + '</p><p class="list-group-item-text"><i class="fa fa-calendar"></i> Expire On: <b>' + a + "</b></p></div>")
                    }
                }, {
                    key: "isSubProfileTable",
                    value: function() {
            ...
            v = function(e) {
                function t(e, l, a, i) {
                    s(this, t);
                    var o = r(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, l, a, i));
                    return o.fieldNameMap = {}, o.hiddenFields = {}, o.tableFields = {}, o.formOnlyFields = {}, o
                }
                return u(t, b), a(t, [{
                    key: "setFieldNameMap",
                    value: function(e) {
                        for (var t = void 0, l = 0; l < e.length; l++) t = e[l], this.fieldNameMap[t.name] = t, "Hidden" === t.display ? this.hiddenFields[t.name] = t : "Table and Form" === t.display || "Form" === t.display ? this.tableFields[t.name] = t : this.formOnlyFields[t.name] = t
                    }
                }, {
                    ...
                    value: function(e, t, l) {
                        if (1 === l) {
                            return '<img src="_img_" class="img-circle" style="width:45px;height: 45px;" alt="User Image">'.replace("_img_", t)
                        }
                        return t
                    }
                }, {
                    ...
                    key: "getTableFields",
                    value: function() {
                        return ["id", "image", "employee_id", "first_name", "middle_name", "last_name", "mobile_phone", "department", "gender", "supervisor"]
                    }
                }, {
                    key: "getDataMapping",
                    value: function() {
                        for (var e = this.getTableFields(), t = [], l = 0; l < e.length; l++) void 0 !== this.hiddenFields[e[l]] && null !== this.hiddenFields[e[l]] || void 0 !== this.formOnlyFields[e[l]] && null !== this.formOnlyFields[e[l]] || t.push(e[l]);
                        return t
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
                        for (var e = this.getTableFields(), t = [{
                                sTitle: "ID",
                                bVisible: !1
                            }, {
                                sTitle: "",
                                bSortable: !1
                            }], l = "", a = 0; a < e.length; a++) void 0 !== this.hiddenFields[e[a]] && null !== this.hiddenFields[e[a]] || void 0 !== this.formOnlyFields[e[a]] && null !== this.formOnlyFields[e[a]] || void 0 !== this.fieldNameMap[e[a]] && null !== this.fieldNameMap[e[a]] && (null == (l = this.fieldNameMap[e[a]].textMapped) || "" === l ? t.push({
                            sTitle: l
                        }) : "gender" === e[a] ? t.push({
                            sTitle: l,
                            translate: !0
                    ...
                    value: function() {
                        for (var e = [], t = void 0, l = void 0, a = [
                                ...
                                ["immigration_status", {
                                    ...
                                    type: "select2",
                                    "allow-null": !0,
                                    "remote-source": ["ImmigrationStatus", "id", "name"]
                                }],
                                ["ssn_num", {
                                ...
                                ["notches", {
                                    ...
                                    "type": "select2",
                                    "allow-null": true,
                                    "remote-source": ["Notches", "name", "name"]
                                }],
                                ["work_station_id", {
                                    label: "Work Station Id",
                                    type: "text",
                                ...
                                ["branch", {
                                    label: "Branch",
                                    type: "select2",
                                    "remote-source": ["CompanyStructure", "comp_code", "title"]
                                }],
                                ["department", {
                                    label: "Department",
                                    type: "select2",
                                ...
                                ["notes", {
                                    ...
                                    "sort-function": function(e, t) {
                                        return Date.parse(e.date).getTime() < Date.parse(t.date).getTime()
                                    },
                                    "custom-validate-function": function(e) {
                                        var t = {
                                            valid: !0
                                        };
                                        return e.date = (new Date).toString("d-MMM-yyyy hh:mm tt"), t.params = e, t
                                    }
                                }]
                            ], i = 0; i < this.customFields.length; i++) a.push(this.customFields[i]);
                        for (var o = 0; o < a.length; o++) t = a[o], void 0 !== this.hiddenFields[t[0]] && null !== this.hiddenFields[t[0]] || (void 0 !== this.fieldNameMap[t[0]] && null !== this.fieldNameMap[t[0]] && (l = this.fieldNameMap[t[0]].textMapped, t[1].label = l), e.push(t));
                        return e
                    }
                }, {
                    key: "getFilters",
                    ...
                    value: function(e) {
                        var t = '<img class="tableActionButton" src="_BASE_images/connect-no.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Terminate Employee" onclick="modJs.terminateEmployee(_id_);return false;"></img>';
                        !1 === this.showDelete && (t = "");
                        var l = '<div style="width:110px;"><img class="tableActionButton" src="_BASE_images/user.png" style="cursor:pointer;" rel="tooltip" title="Login as this Employee" onclick="modJs.setAdminProfile(_id_);return false;"></img><img class="tableActionButton" src="_BASE_images/view.png" style="cursor:pointer;margin-left:15px;" rel="tooltip" title="View" onclick="modJs.view(_id_);return false;"></img><img class="tableActionButton" src="_BASE_images/edit.png" style="cursor:pointer;margin-left:15px;" rel="tooltip" title="Edit" onclick="modJs.edit(_id_);return false;"></img><img class="tableActionButton" src="_BASE_images/edit.png" style="display:none;cursor:pointer;margin-left:15px;" rel="tooltip" title="Edit" onclick="modJs.edit(_id_);return false;"></img>' + t + "</div>";
                        return l = (l = l.replace(/_id_/g, e)).replace(/_BASE_/g, this.baseUrl)
                    }
                }, {
                    key: "getHelpLink",
                    value: function() {
                    ...
                    value: function(e) {
                        this.lastSavedEmployee = e, null === this.currentId && $("#createUserModel").modal("show")
                    }
                }, {
                    key: "closeCreateUser",
                    value: function() {
                    ...
                    value: function() {
                        var e = {};
                        e.employee = this.lastSavedEmployee.id, e.user_level = "Employee", e.email = this.lastSavedEmployee.work_email, e.username = this.lastSavedEmployee.work_email.split("@")[0], top.location.href = this.getCustomUrl("?g=admin&n=users&m=admin_Admin&action=new&object=" + Base64.encodeURI(JSON.stringify(e)))
                    }
                }, {
                    key: "deleteEmployee",
                    value: function(e) {
                        if (confirm("Are you sure you want to archive this employee? Data for this employee will be saved to an archive table. But you will not be able to covert the archived employee data into a normal employee.")) {
                            var t = [];
                            t.callBackData = [], t.callBackSuccess = "deleteEmployeeSuccessCallback", t.callBackFail = "deleteEmployeeFailCallback", this.customAction("deleteEmployee", "admin=employees", JSON.stringify({
                                id: e
                            }), t)
                        }
                    }
                    ...
                    value: function(e) {
                        this.showMessage("Delete Success", "Employee deleted. You can find archived information for this employee in Archived Employees tab"), this.get([])
                    }
                }, {
                    key: "deleteEmployeeFailCallback",
                    value: function(e) {
                        this.showMessage("Error occurred while deleting Employee", e)
                    }
                }, {
                    ...
                    value: function(e) {
                        if (confirm("Are you sure you want to terminate this employee contract? You will still be able to access all details of this employee.")) {
                            ...
                            var l = JSON.stringify(t),
                                a = [];
                            a.callBackData = [], a.callBackSuccess = "terminateEmployeeSuccessCallback", a.callBackFail = "terminateEmployeeFailCallback", this.customAction("terminateEmployee", "admin=employees", l, a)
                        }
                    }
                }, {
                    key: "terminateEmployeeSuccessCallback",
                    value: function(e) {
                        this.showMessage("Success", "Employee contract terminated. You can find terminated employee information under Terminated Employees menu."), this.get([])
                    }
                }, {
                    key: "terminateEmployeeFailCallback",
                    value: function(e) {
                        this.showMessage("Error occured while terminating Employee", e)
                    }
                }, {
                    ...
                    value: function(e) {
                        if (confirm("Are you sure you want to re-activate this employee contract?")) {
                            ...
                            var l = JSON.stringify(t),
                                a = [];
                            a.callBackData = [], a.callBackSuccess = "activateEmployeeSuccessCallback", a.callBackFail = "activateEmployeeFailCallback", this.customAction("activateEmployee", "admin=employees", l, a)
                        }
                    }
                }, {
                    key: "activateEmployeeSuccessCallback",
                    value: function(e) {
                        this.showMessage("Success", "Employee contract re-activated."), this.get([])
                    }
                }, {
                    key: "activateEmployeeFailCallback",
                    value: function(e) {
                        this.showMessage("Error occurred while activating Employee", e)
                    }
                }, {
                    key: "view",
                    value: function(e) {
                        ...
                        var t = {
                            ...
                            l = JSON.stringify(t),
                            a = [];
                        a.callBackData = [], a.callBackSuccess = "renderEmployee", a.callBackFail = "viewFailCallBack", this.customAction("get", "modules=employees", l, a)
                    }
                }, {
                    ...
                    value: function(e) {
                        ...
                        for (var a = this.getCustomTemplate("myDetails.html"), i = 0; i < l.length; i++) void 0 !== this.fieldNameMap[l[i][0]] && null !== this.fieldNameMap[l[i][0]] && (t = this.gt(this.fieldNameMap[l[i][0]].textMapped), a = a.replace("#_label_" + l[i][0] + "_#", t));
                        a = (a = a.replace(/#_.+_#/gi, "")).replace(/_id_/g, e.id), $("#" + this.getTableName()).html(a);
                        for (var o = 0; o < l.length; o++) $("#" + this.getTableName() + " #" + l[o][0]).html(e[l[o][0]]), $("#" + this.getTableName() + " #" + l[o][0] + "_Name").html(e[l[o][0] + "_Name"]);
                        for (var n = "", s = 0; s < e.subordinates.length; s++) void 0 !== e.subordinates[s].first_name && null !== e.subordinates[s].first_name && (n += e.subordinates[s].first_name + " "), void 0 !== e.subordinates[s].middle_name && null !== e.subordinates[s].middle_name && "" !== e.subordinates[s].middle_name && (n += e.subordinates[s].middle_name + " "), void 0 !== e.subordinates[s].last_name && null !== e.subordinates[s].last_name && "" !== e.subordinates[s].last_name && (n += e.subordinates[s].last_name), n += "<br/>";
                        if ($("#" + this.getTableName() + " #subordinates").html(n), $("#" + this.getTableName() + " #name").html(e.first_name + " " + e.last_name), this.currentUserId = e.id, $("#" + this.getTableName() + " #profile_image_" + e.id).attr("src", e.image), void 0 !== e.customFields && null !== e.customFields && Object.keys(e.customFields).length > 0) {
                            var r = void 0;
                            for (var u in e.customFields) {
                                e.customFields[u][1] || (e.customFields[u][1] = this.gt("Other Details"));
                                var b = e.customFields[u][1].toLocaleLowerCase();
                                if (b = b.replace(" ", "_"), $("#cont_" + b).length <= 0) {
                                    var v = '<div class="panel panel-default" style="width:97.5%;"><div class="panel-heading"><h4>#_section.name_#</h4></div> <div class="panel-body"  id="cont_#_section_#"> </div></div>';
                                    v = (v = v.replace("#_section_#", b)).replace("#_section.name_#", e.customFields[u][1]), $("#customFieldsCont").append($(v))
                                }
                                r = (r = '<div class="col-xs-6 col-md-3" style="font-size:16px;"><label class="control-label col-xs-12" style="font-size:13px;">#_label_#</label><label class="control-label col-xs-12 iceLabel" style="font-size:13px;font-weight: bold;">#_value_#</label></div>').replace("#_label_#", u), r = "fileupload" === e.customFields[u][2] ? r.replace("#_value_#", "<button onclick=\"download('" + e.customFields[u][0] + '\');return false;" class="btn btn-mini btn-inverse" type="button">View: ' + u + "</button>") : r.replace("#_value_#", e.customFields[u][0]), $("#cont_" + b).append($(r))
                            }
                        } else $("#customFieldsCont").remove();
                        for (var g in this.cancel(), this.isModuleInstalled("admin", "documents") || $("#tabDocuments").remove(), window.modJs = this, modJs.subModJsList = [], modJs.subModJsList.tabEmployeeSkillSubTab = new d("EmployeeSkill", "EmployeeSkillSubTab", {
                                employee: e.id
                            }), modJs.subModJsList.tabEmployeeSkillSubTab.parent = this, modJs.subModJsList.tabEmployeeEducationSubTab = new c("EmployeeEducation", "EmployeeEducationSubTab", {
                                employee: e.id
                            }), modJs.subModJsList.tabEmployeeEducationSubTab.parent = this, modJs.subModJsList.tabEmployeeCertificationSubTab = new p("EmployeeCertification", "EmployeeCertificationSubTab", {
                                employee: e.id
                            }), modJs.subModJsList.tabEmployeeCertificationSubTab.parent = this, modJs.subModJsList.tabEmployeeLanguageSubTab = new m("EmployeeLanguage", "EmployeeLanguageSubTab", {
                                employee: e.id
                            }), modJs.subModJsList.tabEmployeeLanguageSubTab.parent = this, modJs.subModJsList.tabEmployeeDependentSubTab = new h("EmployeeDependent", "EmployeeDependentSubTab", {
                                employee: e.id
                            }), modJs.subModJsList.tabEmployeeDependentSubTab.parent = this, modJs.subModJsList.tabEmployeeEmergencyContactSubTab = new f("EmergencyContact", "EmployeeEmergencyContactSubTab", {
                                employee: e.id
                            }), modJs.subModJsList.tabEmployeeEmergencyContactSubTab.parent = this, this.isModuleInstalled("admin", "documents") && (modJs.subModJsList.tabEmployeeDocumentSubTab = new y("EmployeeDocument", "EmployeeDocumentSubTab", {
                                employee: e.id
                            }), modJs.subModJsList.tabEmployeeDocumentSubTab.parent = this), modJs.subModJsList) modJs.subModJsList.hasOwnProperty(g) && (modJs.subModJsList[g].setTranslationsSubModules(this.translations), modJs.subModJsList[g].setPermissions(this.permissions), modJs.subModJsList[g].setFieldTemplates(this.fieldTemplates), modJs.subModJsList[g].setTemplates(this.templates), modJs.subModJsList[g].setCustomTemplates(this.customTemplates), modJs.subModJsList[g].setEmailTemplates(this.emailTemplates), modJs.subModJsList[g].setUser(this.user), modJs.subModJsList[g].initFieldMasterData(), modJs.subModJsList[g].setBaseUrl(this.baseUrl), modJs.subModJsList[g].setCurrentProfile(this.currentProfile), modJs.subModJsList[g].setInstanceId(this.instanceId), modJs.subModJsList[g].setGoogleAnalytics(ga), modJs.subModJsList[g].setNoJSONRequests(this.noJSONRequests));
                        modJs.subModJsList.tabEmployeeSkillSubTab.setShowFormOnPopup(!0), modJs.subModJsList.tabEmployeeSkillSubTab.setShowAddNew(!1), modJs.subModJsList.tabEmployeeSkillSubTab.setShowCancel(!1), modJs.subModJsList.tabEmployeeSkillSubTab.get([]), modJs.subModJsList.tabEmployeeEducationSubTab.setShowFormOnPopup(!0), modJs.subModJsList.tabEmployeeEducationSubTab.setShowAddNew(!1), modJs.subModJsList.tabEmployeeEducationSubTab.setShowCancel(!1), modJs.subModJsList.tabEmployeeEducationSubTab.get([]), modJs.subModJsList.tabEmployeeCertificationSubTab.setShowFormOnPopup(!0), modJs.subModJsList.tabEmployeeCertificationSubTab.setShowAddNew(!1), modJs.subModJsList.tabEmployeeCertificationSubTab.setShowCancel(!1), modJs.subModJsList.tabEmployeeCertificationSubTab.get([]), modJs.subModJsList.tabEmployeeLanguageSubTab.setShowFormOnPopup(!0), modJs.subModJsList.tabEmployeeLanguageSubTab.setShowAddNew(!1), modJs.subModJsList.tabEmployeeLanguageSubTab.setShowCancel(!1), modJs.subModJsList.tabEmployeeLanguageSubTab.get([]), modJs.subModJsList.tabEmployeeDependentSubTab.setShowFormOnPopup(!0), modJs.subModJsList.tabEmployeeDependentSubTab.setShowAddNew(!1), modJs.subModJsList.tabEmployeeDependentSubTab.setShowCancel(!1), modJs.subModJsList.tabEmployeeDependentSubTab.get([]), modJs.subModJsList.tabEmployeeEmergencyContactSubTab.setShowFormOnPopup(!0), modJs.subModJsList.tabEmployeeEmergencyContactSubTab.setShowAddNew(!1), modJs.subModJsList.tabEmployeeEmergencyContactSubTab.setShowCancel(!1), modJs.subModJsList.tabEmployeeEmergencyContactSubTab.get([]), this.isModuleInstalled("admin", "documents") && (modJs.subModJsList.tabEmployeeDocumentSubTab.setShowFormOnPopup(!0), modJs.subModJsList.tabEmployeeDocumentSubTab.setShowAddNew(!1), modJs.subModJsList.tabEmployeeDocumentSubTab.setShowCancel(!1), modJs.subModJsList.tabEmployeeDocumentSubTab.get([])), $("#subModTab a").off().on("click", function(e) {
                    ...
                    value: function(e) {
                        var t = {
                            ...
                            l = JSON.stringify(t),
                            a = [];
                        a.callBackData = [], a.callBackSuccess = "modEmployeeDeleteProfileImageCallBack", a.callBackFail = "modEmployeeDeleteProfileImageCallBack", this.customAction("deleteProfileImage", "modules=employees", l, a)
                    }
                }, {
            ...
            g = function(e) {
                ...
                return u(t, v), a(t, [{
                    ...
                    key: "getActionButtonsHtml",
                    value: function(e) {
                        var t = '<div style="width:110px;"><img class="tableActionButton" src="_BASE_images/edit.png" style="cursor:pointer;margin-left:15px;" rel="tooltip" title="Edit" onclick="modJs.edit(_id_);return false;"></img><img class="tableActionButton" src="_BASE_images/edit.png" style="display:none;cursor:pointer;margin-left:15px;" rel="tooltip" title="Edit" onclick="modJs.edit(_id_);return false;"></img><img class="tableActionButton" src="_BASE_images/delete.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Archive Employee" onclick="modJs.deleteEmployee(_id_);return false;"></img><img class="tableActionButton" src="_BASE_images/redo.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Restore Employee" onclick="modJs.activateEmployee(_id_);return false;"></img></div>';
            ...
            _ = function(e) {
                ...
                return u(t, b), a(t, [{
                    key: "getDataMapping",
                    value: function() {
                        return ["id", "employee_id", "first_name", "last_name", "work_email", "department", "gender", "supervisor"]
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
                    ...
                    key: "getActionButtonsHtml",
                    value: function(e) {
                        var t = '<div style="width:110px;"><img class="tableActionButton" src="_BASE_images/download.png" style="cursor:pointer;" rel="tooltip" title="Download Archived Data" onclick="modJs.download(_id_);return false;"></img><img class="tableActionButton" src="_BASE_images/delete.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Remove Archived Data" onclick="modJs.deleteRow(_id_);return false;"></img></div>';
                        return t = (t = t.replace(/_id_/g, e)).replace(/_BASE_/g, this.baseUrl)
                    }
                }, {
                    key: "download",
            ...
            F = function(e) {
                ...
                return u(t, b), a(t, [{
                    key: "getDataMapping",
                    value: function() {
                        return ["id", "employee", "document", "doc_number", "issued", "expiry", "status", "details"]
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
            ...
            M = function(e) {
                ...
                return u(t, i.default), a(t, [{
                    key: "getDataMapping",
                    value: function() {
                        return ["id", "employee", "document", "details", "date_added", "status", "attachment"]
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
                    ...
                    key: "getActionButtonsHtml",
                    value: function(e, t) {
                        var l = '<div style="width:80px;"><img class="tableActionButton" src="_BASE_images/edit.png" style="cursor:pointer;" rel="tooltip" title="Edit" onclick="modJs.edit(_id_);return false;"></img><img class="tableActionButton" src="_BASE_images/download.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Download Document" onclick="download(\'_attachment_\');return false;"></img><img class="tableActionButton" src="_BASE_images/delete.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Delete" onclick="modJs.deleteRow(_id_);return false;"></img></div>';
                        return l = (l = (l = l.replace(/_id_/g, e)).replace(/_attachment_/g, t[6])).replace(/_BASE_/g, this.baseUrl)
                    }
                }, {
                    key: "isSubProfileTable",
                    value: function() {
    ...
    4: [function(e, t, l) {
        ...
        var s = function(e) {
            function t(e, l, a, i) {
                ...
                return o.moduleRelativeURL = null, o.tableData = [], o.sourceData = [], o.filter = null, o.origFilter = null, o.orderBy = null, o.currentElement = null, o.initAdapter(e, l, a, i), o
            }
            return function(e, t) {
                if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
                e.prototype = Object.create(t && t.prototype, {
                ...
                value: function(e, t, l, a) {
                    this.moduleRelativeURL = baseUrl, this.table = e, this.tab = null == t ? e : t, this.filter = null == l ? null : l, this.origFilter = this.filter, this.orderBy = null == a ? null : a, this.trackEvent("initAdapter", t), this.requestCache = new o.default
                }
            }, {
                key: "setFilter",
                value: function(e) {
                ...
                value: function(e, t, l, a) {
                    var i = this;
                    null == l && (l = !0), $(e).attr("a", "add"), $(e).attr("t", this.table), i.showLoader(), this.requestCache.invalidateTable(this.table), $.post(this.moduleRelativeURL, e, function(e) {
                ...
                value: function(e, t) {
                    var l = this;
                    l.showLoader(), this.requestCache.invalidateTable(this.table), $.post(this.moduleRelativeURL, {
                        t: this.table,
                        a: "delete",
                        id: e
                    }, function(e) {
                ...
                value: function(e) {
                    ...
                    var i = "";
                    null !== this.getOrderBy() && (i = this.getOrderBy()), l = this.fixJSON(l), a = this.fixJSON(a), t.showLoader(), $.post(this.moduleRelativeURL, {
                        t: this.table,
                        a: "get",
                        sm: l,
                        ft: a,
                ...
                value: function(e) {
                    ...
                    var o = this.moduleRelativeURL.replace("service.php", "data.php");
                    return o = (o = (o = (o = (o = o + "?t=" + this.table) + "&sm=" + this.fixJSON(t)) + "&cl=" + this.fixJSON(l)) + "&ft=" + this.fixJSON(a)) + "&ob=" + i, this.isSubProfileTable() && (o += "&type=sub"), this.remoteTableSkipProfileRestriction() && (o += "&skip=1"), o
                }
            }, {
                key: "isSubProfileTable",
                value: function() {
                ...
                value: function(e, t) {
                    for (var l = [], a = this.getDataMapping(), i = 0; i < t.length; i++) {
                        for (var o = [], n = 0; n < a.length; n++) o[n] = t[i][a[n]];
                        l.push(this.preProcessTableData(o))
                    }
                    this.sourceData = t, void 0 !== e.callBack && null !== e.callBack && (void 0 !== e.callBackData && null !== e.callBackData || (e.callBackData = []), e.callBackData.push(t), e.callBackData.push(l), this.callFunction(e.callBack, e.callBackData)), this.tableData = l, void 0 !== e.noRender && null !== e.noRender && !0 === e.noRender || (this.createTable(this.getTableName()), $("#" + this.getTableName() + "Form").hide(), $("#" + this.getTableName()).show())
                }
            }, {
                key: "getFailCallBack",
                value: function(e, t) {}
                ...
                value: function(e, t, l) {
                    ...
                    i = this.fixJSON(i), a.showLoader(), $.post(this.moduleRelativeURL, {
                        t: this.table,
                        a: "getElement",
                        id: e,
                        sm: i
                ...
                value: function(e, t) {
                    ...
                    null != n && "SUCCESS" === n.status && (t.callBackData.push(n.data), null !== t.callBackSuccess && void 0 !== t.callBackSuccess && t.callBackData.push(t.callBackSuccess), l.callFunction(t.callBack, t.callBackData));
                    var s = function e(a) {
                        if ("SUCCESS" === a.status) {
                            l.requestCache.setData(this.success.key, a);
                            var i = t;
                            i.callBackData = [t.callBackData[0]], i.callBackData.push(a.data), null !== i.callBackSuccess && void 0 !== i.callBackSuccess && i.callBackData.push(t.callBackSuccess), l.callFunction(i.callBack, i.callBackData)
                        } else "Access violation" === a.message && alert("Error : " + e.table + " " + a.message)
                    };
                    s.key = o, s.table = e[0], $.post(this.moduleRelativeURL, {
                        t: e[0],
                        key: e[1],
                        value: e[2],
                        method: a,
                ...
                value: function(e, t, l, a, i) {
                    var o = this;
                    l = this.fixJSON(l), i ? $.post(this.moduleRelativeURL, {
                        t: this.table,
                        a: "ca",
                        sa: e,
                        mod: t,
                        ...
                        "SUCCESS" === e.status ? (a.callBackData.push(e.data), o.callFunction(a.callBackSuccess, a.callBackData)) : (a.callBackData.push(e.data), o.callFunction(a.callBackFail, a.callBackData))
        ...
        var i = {
            ...
            o = function() {
                function e(t, l, a) {
                    ! function(e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                    }(this, e), this.tempOptions = {}, this.formId = t, this.formError = !1, this.formObject = null, this.errorMessages = "", this.popupDialog = null, this.validateAll = l, this.errorMap = [], this.settings = {
                        thirdPartyPopup: null,
                        LabelErrorClass: !1,
                        ShowPopup: !0
                    }, this.settings = jQuery.extend(this.settings, a), this.inputTypes = ["text", "radio", "checkbox", "file", "password", "select-one", "select-multi", "textarea", "fileupload", "signature"], this.validator = i
                }
                return a(e, [{
                    key: "clearError",
                    value: function(e, t) {
                    ...
                    value: function(e, t) {
                        ...
                        var l = e.attr("id"),
                            a = e.attr("validation"),
                            i = e.attr("validation");
                        $("#" + this.formId + " #field_" + l).addClass("error"), void 0 === i || null == i || "" === i ? $("#" + this.formId + " #help_err_" + l).html(i) : void 0 === a || null == a || "" === a ? $("#" + this.formId + " #help_err_" + l).html("Required") : "float" === a || "number" === a ? $("#" + this.formId + " #help_err_" + l).html("Number required") : "email" === a ? $("#" + this.formId + " #help_err_" + l).html("Email required") : $("#" + this.formId + " #help_err_" + l).html("Required")
                    }
                }, {
                    key: "showErrors",
                    value: function() {
                    ...
                    value: function(e) {
                        ...
                        var l = function(e) {
                                ...
                                if (jQuery.inArray(o, t.inputTypes) >= 0) {
                                    if (e.hasClass("uploadInput")) l = e.attr("val");
                                    else if ("radio" === o || "checkbox" === o) l = $("input[name='" + a + "']:checked").val();
                                    else if (e.hasClass("select2Field")) l = null != $("#" + t.formId + " #" + i).select2("data") && void 0 !== $("#" + t.formId + " #" + i).select2("data") ? $("#" + t.formId + " #" + i).select2("data").id : "";
                                        ...
                                        if (null != $("#" + t.formId + " #" + i).select2("data") && void 0 !== $("#" + t.formId + " #" + i).select2("data")) {
                                            ...
                                            l = [];
                                            for (var s = 0; s < n.length; s++) l.push(n[s].id);
                                            l = JSON.stringify(l)
                                        } else l = "";
                                    else l = e.hasClass("signatureField") ? $("#" + t.formId + " #" + i).data("signaturePad").isEmpty() ? "" : $("#" + i).data("signaturePad").toDataURL() : e.hasClass("simplemde") ? $("#" + t.formId + " #" + i).data("simplemde").value() : e.hasClass("tinymce") ? tinyMCE.get(i).getContent({
                                        format: "raw"
                                    }) : e.val();
                                    var r = e.attr("validation"),
                                        u = !1;
                                    void 0 !== r && null != r && void 0 !== t.validator[r] && null != t.validator[r] ? u = t.validator[r](l) : (u = !t.validateAll || (void 0 !== r && null != r && "none" === r || t.validator.input(l)), t.formObject[i] = l), u ? (t.clearError(e, null), t.formObject[i] = l) : t.addError(e, null)
                                }
                            },
                            a = $("#" + this.formId + " :input");
    ...
    6: [function(e, t, l) {
        ...
        var s = function() {
            ...
            return i(e, [{
                ...
                value: function(e, t, l) {
                    try {
                        void 0 === t || null == t ? this.ga.push(["_trackEvent", this.instanceId, e]) : void 0 === l || null == l ? this.ga.push(["_trackEvent", this.instanceId, e, t]) : this.ga.push(["_trackEvent", this.instanceId, e, t, l])
                    } catch (e) {}
                }
            }, {
                ...
                value: function(e, t, l) {
                    var a = void 0;
                    void 0 !== this.showAddNew && null != this.showAddNew || (this.showAddNew = !0), this.fieldMasterData = {}, this.fieldMasterDataKeys = {}, this.fieldMasterDataCallback = t, this.fieldMasterDataCallbackData = l, this.sourceMapping = {};
                    var i = this.getFormFields(),
                        o = this.getFilters();
                    if (null != o)
                        for (var n = 0; n < o.length; n++)(null == (a = this.getMetaFieldValues(o[n][0], i)) || "select" !== a.type && "select2" !== a.type && "select2multi" !== a.type) && i.push(o[n]);
                    for (var s = [], r = [], u = null, d = null, c = 0; c < i.length; c++)
                        ...
                        for (var m = 0; m < u[1].form.length; m++)
                            if (void 0 !== (d = u[1].form[m])[1]["remote-source"] && null !== d[1]["remote-source"]) {
                                var h = d[1]["remote-source"][0] + "_" + d[1]["remote-source"][1] + "_" + d[1]["remote-source"][2];
                                r.indexOf(h) < 0 && (s.push(d), r.push(h))
                            }
                    for (var f = 0; f < s.length; f++) {
                        var y = s[f];
                        if (void 0 !== y[1]["remote-source"] && null != y[1]["remote-source"]) {
                            var b = y[1]["remote-source"][0] + "_" + y[1]["remote-source"][1] + "_" + y[1]["remote-source"][2];
                            this.fieldMasterDataKeys[b] = !1, this.sourceMapping[y[0]] = y[1]["remote-source"];
                            var v = {
                                callBack: "initFieldMasterDataResponse"
                            };
                            v.callBackData = [b], null != e && (v.callBackSuccess = e), this.getFieldValues(y[1]["remote-source"], v)
                        }
                    }
                }
            }, {
                ...
                value: function(e) {
                    if (this.getRemoteTable()) this.createTableServer(e);
                        ...
                        if (this.showActionButtons() && t.push(this.getActionButtonHeader()), this.showActionButtons())
                            for (var i = 0; i < a.length; i++) a[i].push(this.getActionButtonsHtml(a[i][0], a[i]));
                        var o;
                        o = this.getTableTopButtonHtml() + this.getTableHTMLTemplate();
                        var n = $("#" + e + " .dataTables_paginate .active a").html(),
                            s = 0;
                        void 0 !== n && null != n && (s = 15 * parseInt(n, 10) - 15), $("#" + e).html(o);
                        var r = {
                                oLanguage: {
                        ...
                        $.extend(r, u), $("#" + e + " #grid").dataTable(r), $(".dataTables_paginate ul").addClass("pagination"), $(".dataTables_length").hide(), $(".dataTables_filter input").addClass("form-control"), $(".dataTables_filter input").attr("placeholder", "Search"), $(".dataTables_filter label").contents().filter(function() {
                ...
                value: function(e) {
                    ...
                    $.extend(n, s), $("#" + e + " #grid").dataTable(n), $(".dataTables_paginate ul").addClass("pagination"), $(".dataTables_length").hide(), $(".dataTables_filter input").addClass("form-control"), $(".dataTables_filter input").attr("placeholder", "Search"), $(".dataTables_filter label").contents().filter(function() {
                        return 3 === this.nodeType
                    }).remove(), $(".tableActionButton").tooltip()
                }
            }, {
                ...
                value: function(e, t, l, a, i, o) {
                    var n = this,
                        s = "#yesnoModel";
                    void 0 !== t && null != t || (t = ""), $(s + "Label").html(e), $(s + "Body").html(t), null != l && $(s + "YesBtn").html(l), null != a && $(s + "NoBtn").html(a), $(s + "YesBtn").off().on("click", function() {
                        void 0 !== i && null != i && (i.apply(n, o), n.cancelYesno())
                    }), $(s).modal({
                        backdrop: "static"
                    })
                }
                ...
                value: function(e, t) {
                    var l = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
                        ...
                        o = this,
                        n = "";
                    n = i ? "#plainMessageModel" : "#messageModel", $(n).off(), i ? this.renderModel("plainMessage", e, t) : this.renderModel("message", e, t), null != l ? ($(n).modal({
                        show: !0
                ...
                value: function(e, t, l, a, i) {
                    var o = this,
                        n = "";
                    n = i ? "#dataMessageModel" : "#messageModel", $(n).unbind("hide"), i ? this.renderModelFromDom("dataMessage", e, t) : this.renderModelFromDom("message", e, t), null != l ? ($(n).modal({
                        show: !0
                    }), $(n).on("hidden.bs.modal", function() {
                        l.apply(o, a), $(".modal-backdrop").remove()
                    })) : $(n).modal({
                ...
                value: function(e, t) {
                    ...
                    if (l.checkValues()) {
                        ...
                        if (null == i) {
                            ...
                            var o = $("#" + this.getTableName() + "_submit #id").val();
                            null != o && void 0 !== o && "" !== o && (a.id = o), a = this.makeEmptyDateFieldsNull(a), this.add(a, [], e, t)
                ...
                value: function(e) {
                    ...
                    for (var u in null == i && (i = []), e)
                        if (e.hasOwnProperty(u)) {
                            if (n = "", s = null, "select" === (i = this.getMetaFieldValues(u, r)).type || "select2" === i.type) {
                                if (void 0 !== i["remote-source"] && null != i["remote-source"]) l = i["remote-source"], "NULL" === e[u] ? n = void 0 !== i["null-label"] && null != i["null-label"] ? i["null-label"] : "Not Selected" : s = n = this.fieldMasterData[l[0] + "_" + l[1] + "_" + l[2]][e[u]];
                ...
                value: function(e) {
                    for (var t = this.templates.filterTemplate, l = "", a = this.getFilters(), i = 0; i < a.length; i++) {
                        ...
                        if ("" === o || void 0 === o) l += this.renderFormField(a[i]);
                        else {
                            var n = e[o];
                ...
                value: function(e) {
                    ...
                    for (var l = this.templates.formTemplate, a = "", i = this.getFormFields(), o = 0; o < i.length; o++) {
                        var n = this.getMetaFieldForRendering(i[o][0]);
                        if ("" === n || void 0 === n) a += this.renderFormField(i[o]);
                        else {
                            var s = e[n];
                            "" !== s && null != s && void 0 !== s && "" !== s.trim() ? a += this.renderFormField(JSON.parse(s)) : a += this.renderFormField(i[o])
                        }
                    }
                    l = (l = l.replace(/_id_/g, this.getTableName() + "_submit")).replace(/_fields_/g, a);
                    var r = void 0,
                        u = this.generateRandom(14);
                    this.showFormOnPopup ? (r = $('<div class="reviewBlock popupForm" data-content="Form"></div>')).attr("id", u) : r = $("#" + this.getTableName() + "Form"), r.html(l), r.find(".datefield").datepicker({
                        viewMode: 2
                    }), r.find(".timefield").datetimepicker({
                        language: "en",
                        pickDate: !1
                    ...
                    for (var d = 0; d < i.length; d++) "datagroup" === i[d][1].type && r.find("#" + i[d][0]).data("field", i[d]);
                ...
                value: function(e, t) {
                    ...
                    for (var r = $('<div id="' + t[0] + '_div_inner"></div>'), u = 0; u < l.length; u++) {
                        for (var d in i = l[u], void 0 !== t[1]["pre-format-function"] && null != t[1]["pre-format-function"] && (i = t[1]["pre-format-function"].apply(this, [i])), a = (a = (a = (a = s).replace("#_delete_#", '<a id="#_id_#_delete" onclick="modJs.deleteDataGroupItem(\'#_id_#\');return false;" type="button" style="float:right;margin-right:3px;" tooltip="Delete"><li class="fa fa-times"></li></a>')).replace("#_edit_#", '<a id="#_id_#_edit" onclick="modJs.editDataGroupItem(\'#_id_#\');return false;" type="button" style="float:right;margin-right:5px;" tooltip="Edit"><li class="fa fa-edit"></li></a>')).replace(/#_id_#/g, i.id), i) void 0 !== (n = i[d]) && null != n && "string" == typeof n && (n = n.replace(/(?:\r\n|\r|\n)/g, "<br />")), a = a.replace("#_" + d + "_#", n);
                        void 0 !== t[1].render && null != t[1].render && (a = a.replace("#_renderFunction_#", t[1].render(i))), (o = $(a)).attr("fieldId", t[0] + "_div"), r.append(o)
                    }
                    return r
                }
            }, {
                ...
                value: function(e, t) {
                    ...
                    for (var o = 0; o < i.length; o++) a += this.renderFormField(i[o]);
                    ...
                    s.attr("id", n), s.html(l), s.find(".datefield").datepicker({
                        viewMode: 2
                ...
                value: function() {
                    ...
                    var l = new n.default(this.getTableName() + "_field_" + e[0], !0, {
                        ShowPopup: !1,
                        LabelErrorClass: "error"
                    });
                    if (l.checkValues()) {
                        ...
                        if (void 0 !== e[1]["custom-validate-function"] && null != e[1]["custom-validate-function"]) {
                            if (!(t = e[1]["custom-validate-function"].apply(this, [a])).valid) return $("#" + this.getTableName() + "_field_" + e[0] + "_error").html(t.message), $("#" + this.getTableName() + "_field_" + e[0] + "_error").show(), !1;
                            a = t.params
                        }
                        var i = $("#" + e[0]).val();
                        "" === i && (i = "[]");
                        var o = JSON.parse(i);
                        a.id = e[0] + "_" + this.dataGroupGetNextAutoIncrementId(o), o.push(a), void 0 !== e[1]["sort-function"] && null != e[1]["sort-function"] && o.sort(e[1]["sort-function"]), i = JSON.stringify(o);
                ...
                value: function(e, t) {
                    var l = "";
                    try {
                        for (var a = e.split(" "), i = 0, o = 0; o < a.length; o++)(i += a[o].length + 1) > t ? (l += a[o] + "<br/>", i = 0) : l += a[o] + " "
                    } catch (e) {}
                    return l
                }
            }, {
                ...
                value: function() {
                    var e = this.currentDataGroupField,
                        ...
                        l = new n.default(this.getTableName() + "_field_" + e[0], !0, {
                            ShowPopup: !1,
                            LabelErrorClass: "error"
                        });
                    if (l.checkValues()) {
                        ...
                        if (this.doCustomFilterValidation(a)) {
                            var o = $("#" + e[0]).val();
                            "" === o && (o = "[]");
                            for (var s = JSON.parse(o), r = {}, u = -1, d = [], c = 0; c < s.length; c++) {
                                var p = s[c];
                                p.id === t && (r = p, u = c), d.push(p)
                            }
                            a.id = r.id, d[u] = a, void 0 !== e[1]["sort-function"] && null != e[1]["sort-function"] && d.sort(e[1]["sort-function"]), o = JSON.stringify(d), $("#" + e[0]).val(o);
                            var m = this.dataGroupToHtml(o, e);
                            this.orderDataGroup(e), $("#" + e[0] + "_div").html(""), $("#" + e[0] + "_div").append(m), this.makeDataGroupSortable(e, $("#" + e[0] + "_div_inner")), this.closeDataMessage(), this.showMessage("Item Edited", "This change will be effective only when you save the form")
                        }
                    }
                    return !0
                }
                ...
                value: function(e) {
                    for (var t = e.substring(0, e.lastIndexOf("_")), l = $("#" + t).val(), a = JSON.parse(l), i = {}, o = 0; o < a.length; o++) {
                        var n = a[o];
                        n.id === e && (i = n)
                    }
                    ...
                    for (var i = 0; i < l.length; i++)
                        ...
                        if ("0000-00-00 00:00:00" !== e[l[i][0]] && "" !== e[l[i][0]] && null != e[l[i][0]] && void 0 !== e[l[i][0]]) {
                            var o = e[l[i][0]].split(" "),
                                n = o[0].split("-"),
                                s = o[1].split(":");
                            $(t + " #" + l[i][0] + "_datetime").data("datetimepicker").setLocalDate(new Date(n[0], parseInt(n[1], 10) - 1, n[2], s[0], s[1], s[2]))
                        }
                        ...
                        if (void 0 !== l[i][1]["remote-source"] && null != l[i][1]["remote-source"]) {
                            var r = l[i][1]["remote-source"][0] + "_" + l[i][1]["remote-source"][1] + "_" + l[i][1]["remote-source"][2];
                        ...
                        if (void 0 !== l[i][1].formatter && l[i][1].formatter && $.isFunction(l[i][1].formatter)) try {
                            a = l[i][1].formatter(a)
                        } catch (e) {}
                        $(t + " #" + l[i][0]).html(a)
                    } else if ("fileupload" === l[i][1].type) null != e[l[i][0]] && void 0 !== e[l[i][0]] && "" !== e[l[i][0]] && ($(t + " #" + l[i][0]).html(e[l[i][0]]), $(t + " #" + l[i][0]).attr("val", e[l[i][0]]), $(t + " #" + l[i][0]).show(), $(t + " #" + l[i][0] + "_download").show(), $(t + " #" + l[i][0] + "_remove").show()), !0 === l[i][1].readonly && $(t + " #" + l[i][0] + "_upload").remove();
                        ...
                        var u = [];
                        if (void 0 !== e[l[i][0]] && null != e[l[i][0]] && "" !== e[l[i][0]]) try {
                            u = JSON.parse(e[l[i][0]])
                        } catch (e) {}
                        $(t + " #" + l[i][0]).select2("val", u);
                        var d = $(t + " #" + l[i][0]).find(".select2-choices").height();
                        $(t + " #" + l[i][0]).find(".controls").css("min-height", d + "px"), $(t + " #" + l[i][0]).css("min-height", d + "px")
                    } else if ("datagroup" === l[i][1].type) try {
                        var c = this.dataGroupToHtml(e[l[i][0]], l[i]);
                        $(t + " #" + l[i][0]).val(e[l[i][0]]), $(t + " #" + l[i][0] + "_div").html(""), $(t + " #" + l[i][0] + "_div").append(c), this.makeDataGroupSortable(l[i], $(t + " #" + l[i][0] + "_div_inner"))
                    } catch (e) {} else "signature" === l[i][1].type ? "" === e[l[i][0]] && void 0 === e[l[i][0]] && null == e[l[i][0]] || $(t + " #" + l[i][0]).data("signaturePad").fromDataURL(e[l[i][0]]) : "simplemde" === l[i][1].type ? $(t + " #" + l[i][0]).data("simplemde").value(e[l[i][0]]) : $(t + " #" + l[i][0]).val(e[l[i][0]])
                }
            }, {
                key: "cancel",
                value: function() {
                ...
                value: function(e) {
                    ...
                    if ("text" === e[1].type || "textarea" === e[1].type || "hidden" === e[1].type || "label" === e[1].type || "placeholder" === e[1].type) l = (l = l.replace(/_id_/g, e[0])).replace(/_label_/g, e[1].label);
                        ...
                        t = null != i && void 0 !== i ? i.id : -1 * this.getUser().id, l = (l = l.replace(/_userId_/g, t)).replace(/_group_/g, this.tab), l = (l = void 0 !== e[1].filetypes && null != e[1].filetypes ? l.replace(/_filetypes_/g, e[1].filetypes) : l.replace(/_filetypes_/g, "all")).replace(/_rand_/g, this.generateRandom(14))
                    } else "datagroup" === e[1].type ? l = (l = l.replace(/_id_/g, e[0])).replace(/_label_/g, e[1].label) : "signature" === e[1].type ? l = (l = l.replace(/_id_/g, e[0])).replace(/_label_/g, e[1].label) : "tinymce" !== e[1].type && "simplemde" !== e[1].type || (l = (l = l.replace(/_id_/g, e[0])).replace(/_label_/g, e[1].label));
                    return l = void 0 !== e[1].validation && null != e[1].validation && "" !== e[1].validation ? l.replace(/_validation_/g, 'validation="' + e[1].validation + '"') : l.replace(/_validation_/g, ""), l = void 0 !== e[1].help && null !== e[1].help ? (l = l.replace(/_helpline_/g, e[1].help)).replace(/_hidden_class_help_/g, "") : (l = l.replace(/_helpline_/g, "")).replace(/_hidden_class_help_/g, "hide"), l = void 0 !== e[1].placeholder && null !== e[1].placeholder ? l.replace(/_placeholder_/g, 'placeholder="' + e[1].placeholder + '"') : l.replace(/_placeholder_/g, ""), l = void 0 !== e[1].mask && null !== e[1].mask ? l.replace(/_mask_/g, 'mask="' + e[1].mask + '"') : l.replace(/_mask_/g, "")
                }
            }, {
                key: "renderFormSelectOptions",
                value: function(e, t) {
                    var l = "";
                    null != t && void 0 !== t && !0 === t[1]["allow-null"] && (void 0 !== t[1]["null-label"] && null != t[1]["null-label"] ? l += '<option value="NULL">' + this.gt(t[1]["null-label"]) + "</option>" : l += '<option value="NULL">Select</option>');
                    var a = [];
                    for (var i in e) a.push(e[i]);
                    !0 === t[1].sort && a.sort(function(e, t) {
                    ...
                    for (var o = 0; o < a.length; o++) {
                        ...
                        l += r = (r = r.replace("_id_", n)).replace("_val_", this.gt(s))
                    }
                    return l
                }
            }, {
                ...
                value: function(e, t) {
                    var l = "";
                    !0 === t[1]["allow-null"] && (void 0 !== t[1]["null-label"] && null != t[1]["null-label"] ? l += '<option value="NULL">' + this.gt(t[1]["null-label"]) + "</option>" : l += '<option value="NULL">Select</option>');
                    var a = [];
                    for (var i in e) a.push([i, e[i]]);
                    "true" === t[1].sort && a.sort(function(e, t) {
                        return (e = e[1]) < (t = t[1]) ? -1 : e > t ? 1 : 0
                    });
                    for (var o = 0; o < a.length; o++) {
                        var n = a[o][0],
                ...
                value: function(e, t) {
                    ...
                    return l = this.showAddNew ? l.replace("_clone_", '<img class="tableActionButton" src="_BASE_images/clone.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Copy" onclick="modJs.copyRow(_id_);return false;"></img>') : l.replace("_clone_", ""), l = this.showDelete ? l.replace("_delete_", '<img class="tableActionButton" src="_BASE_images/delete.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Delete" onclick="modJs.deleteRow(_id_);return false;"></img>') : l.replace("_delete_", ""), l = (l = (l = this.showEdit ? l.replace("_edit_", '<img class="tableActionButton" src="_BASE_images/edit.png" style="cursor:pointer;" rel="tooltip" title="Edit" onclick="modJs.edit(_id_);return false;"></img>') : l.replace("_edit_", "")).replace(/_id_/g, e)).replace(/_BASE_/g, this.baseUrl)
                }
            }, {
                key: "generateRandom",
                value: function(e) {
                ...
                value: function(e, t) {
                    var l = document.getElementById(e),
                        a = "";
                    return l.value.lastIndexOf(".") > 0 && (a = l.value.substring(l.value.lastIndexOf(".") + 1, l.value.length)), a = a.toLowerCase(), !(t.split(",").indexOf(a) < 0) || (l.value = "", this.showMessage("File Type Error", "Selected file type is not supported"), this.clearFileElement(e), !1)
                }
            }, {
                ...
                value: function(e) {
                    for (var t = void 0, l = void 0, a = 0; a < e.length; a++)
                        if ("Hidden" !== (t = e[a]).display && "" !== t.data && void 0 !== t.data) try {
            ...
            return function(e, t) {
                ...
                value: function(e) {
                    var t = void 0,
                        ...
                        i = void 0,
                        o = this.getTableData(),
                        n = '<button id="#_id_#_delete" onclick="modJs.subModJsList[\'tab' + e + '\'].deleteRow(\'_id_\');return false;" type="button" style="position: absolute;bottom: 5px;right: 5px;font-size: 13px;" tooltip="Delete"><li class="fa fa-times"></li></button>',
                        ...
                        u = this.getSubHeader();
                    if (r.append(u), 0 === o.length) r.append('<a href="#" class="list-group-item">' + this.getNoDataMessage() + "</a>");
                    else
                        for (var d = 0; d < o.length; d++) t = o[d], a = n.replace(/_id_/g, t[0]), i = s.replace(/_id_/g, t[0]), l = this.getSubItemHtml(t, a, i), r.append(l);
