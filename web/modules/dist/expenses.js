...
})()(
    {
        1: [
            function (e, t, a) {
                ...
                var l = (function () {
                    ...
                    i = r(e("../../../api/IdNameAdapter")),
                    n = r(e("../../../api/ApproveAdminAdapter"));
                function r(e) {
                ...
                var c = (function (e) {
                    ...
                    h = (function (e) {
                        function t(e, a, l, i) {
                            o(this, t);
                            var n = s(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, a, l, i));
                            return (n.itemName = "Expense"), (n.itemNameLower = "expense"), (n.modulePathName = "expenses"), n;
                        }
                        return (
                            u(t, n.default),
                            l(t, [
                                {
                                    key: "getDataMapping",
                                    value: function () {
                                        return ["id", "employee", "expense_date", "payment_method", "payee", "category", "amount", "currency", "status"];
                                    },
                                },
                                {
                                    key: "getHeaders",
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        return [
                                            ...
                                            ["employee", { label: "Employee", type: "select2", sort: "none", "allow-null": !1, "remote-source": ["Employee", "id", "first_name+middle_name+last_name", "getActiveSubordinateEmployees"] }],
                                            ["expense_date", { label: "Date", type: "date", validation: "" }],
                                            ["payment_method", { label: "Payment Method", type: "select2", "remote-source": ["ExpensesPaymentMethod", "id", "name"] }],
                                            ["transaction_no", { label: "Transaction / Ref No", type: "text", validation: "none" }],
                                            ["payee", { label: "Payee", type: "text", validation: "" }],
                                            ["category", { label: "Expense Category", type: "select2", "remote-source": ["ExpensesCategory", "id", "name"] }],
                                            ["notes", { label: "Notes", type: "textarea", validation: "" }],
                                            ["currency", { label: "Currency", type: "select2", "allow-null": !1, "remote-source": ["CurrencyType", "id", "code"] }],
                                            ["amount", { label: "Amount", type: "text", validation: "float" }],
                                            ["attachment1", { label: "Receipt", type: "fileupload", validation: "none" }],
                ...
                t.exports = { ExpensesCategoryAdapter: c, ExpensesPaymentMethodAdapter: d, EmployeeExpenseAdminAdapter: h };
            },
            { "../../../api/ApproveAdminAdapter": 4, "../../../api/IdNameAdapter": 7 },
        ],
        2: [
            function (e, t, a) {
                "use strict";
                        ...
                        l(t, [
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    ...
                                    (o.key = n), (o.table = e[0]), $.post(this.moduleRelativeURL, { t: e[0], key: e[1], value: e[2], method: l, methodParams: i, a: "getFieldValues" }, o, "json");
                                },
                            },
                            {
                                key: "setAdminProfile",
                    ...
                    return (
                        ...
                        i(t, [
                            ...
                            },
                            {
                                key: "getHeaders",
                                value: function () {
                                    return [{ sTitle: "ID", bVisible: !1 }, { sTitle: "Name" }];
                                },
                            },
                            {
                                key: "getFormFields",
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    for (
                                        ...
                                        var r = '<tr><td><span class="logTime label label-default">_date_</span>&nbsp;&nbsp;<b>_status_</b><br/>_note_</td></tr>';
                                        i += r = (r = (r = r.replace(/_date_/g, a[n].time)).replace(/_status_/g, a[n].status_from + " -> " + a[n].status_to)).replace(/_note_/g, a[n].note);
                                    }
                                ...
                                value: function (e) {
                                    ...
                                    for (var u in (null == i && (i = []), e))
                                        if (e.hasOwnProperty(u)) {
                                            if (((r = ""), (o = null), "select" === (i = this.getMetaFieldValues(u, s)).type || "select2" === i.type)) {
                                                if (void 0 !== i["remote-source"] && null != i["remote-source"])
                                                    (a = i["remote-source"]),
                                                        "NULL" === e[u] ? (r = void 0 !== i["null-label"] && null != i["null-label"] ? i["null-label"] : "Not Selected") : (o = r = this.fieldMasterData[a[0] + "_" + a[1] + "_" + a[2]][e[u]]);
                                ...
                                value: function (e) {
                                    ...
                                    for (var a = this.templates.formTemplate, l = "", i = this.getFormFields(), n = 0; n < i.length; n++) {
                                        ...
                                        if ("" === r || void 0 === r) l += this.renderFormField(i[n]);
                                            ...
                                            var o = e[r];
                                            "" !== o && null != o && void 0 !== o && "" !== o.trim() ? (l += this.renderFormField(JSON.parse(o))) : (l += this.renderFormField(i[n]));
                                        }
                                    }
                                ...
                                value: function () {
                                    ...
                                    if (a.checkValues()) {
                                        ...
                                        if (this.doCustomFilterValidation(l)) {
                                            ...
                                            (l.id = s.id), (c[u] = l), void 0 !== e[1]["sort-function"] && null != e[1]["sort-function"] && c.sort(e[1]["sort-function"]), (n = JSON.stringify(c)), $("#" + e[0]).val(n);
                                    ...
                                    for (var i = 0; i < a.length; i++)
                                        if ("date" === a[i][1].type) "0000-00-00" !== e[a[i][0]] && "" !== e[a[i][0]] && null != e[a[i][0]] && void 0 !== e[a[i][0]] && $(t + " #" + a[i][0] + "_date").datepicker("setValue", e[a[i][0]]);
                                            ...
                                            if ("0000-00-00 00:00:00" !== e[a[i][0]] && "" !== e[a[i][0]] && null != e[a[i][0]] && void 0 !== e[a[i][0]]) {
                                                ...
                                                $(t + " #" + a[i][0] + "_datetime")
                                                    .data("datetimepicker")
                                                    .setLocalDate(new Date(r[0], parseInt(r[1], 10) - 1, r[2], o[0], o[1], o[2]));
                                            }
        ...
        10: [
            function (e, t, a) {
                "use strict";
                var l = e("./lib");
                (window.EmployeeExpenseAdapter = l.EmployeeExpenseAdapter), (window.EmployeeExpenseApproverAdapter = l.EmployeeExpenseApproverAdapter), (window.SubordinateEmployeeExpenseAdapter = l.SubordinateEmployeeExpenseAdapter);
            },
            { "./lib": 11 },
        ],
        11: [
            function (e, t, a) {
                ...
                var l,
                    ...
                    n = e("../../../api/ApproveModuleAdapter"),
                    r = (l = n) && l.__esModule ? l : { default: l },
                    o = e("../../../admin/src/expenses/lib");
                function s(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
                }
                function u(e, t) {
                ...
                var d = (function (e) {
                            ...
                            i(t, [
                                {
                                    key: "getDataMapping",
                                    value: function () {
                                        return ["id", "expense_date", "payment_method", "payee", "category", "amount", "currency", "status"];
                                    },
                                },
                                {
                                    key: "getHeaders",
                    ...
                    h = (function (e) {
                        ...
                        return (
                            c(t, o.EmployeeExpenseAdminAdapter),
                            i(t, [
                                {
                                    key: "getActionButtonsHtml",
                                    value: function (e, t) {
                    ...
                    f = (function (e) {
                        ...
                        return c(t, o.EmployeeExpenseAdminAdapter), t;
                    })();
                t.exports = { EmployeeExpenseAdapter: d, EmployeeExpenseApproverAdapter: h, SubordinateEmployeeExpenseAdapter: f };
            },
            { "../../../admin/src/expenses/lib": 1, "../../../api/ApproveModuleAdapter": 5 },
        ],
    },
    {},
    [10]
