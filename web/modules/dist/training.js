...
})()(
    {
                                ...
                                value: function (e, t, a) {
                                    ...
                                    for (var o = [], s = [], u = null, c = null, d = 0; d < i.length; d++)
                                        if (void 0 !== (u = i[d])[1]["remote-source"] && null !== u[1]["remote-source"]) {
                                            ...
                                            for (var p = 0; p < u[1].form.length; p++)
                                                if (void 0 !== (c = u[1].form[p])[1]["remote-source"] && null !== c[1]["remote-source"]) {
                                                    var f = c[1]["remote-source"][0] + "_" + c[1]["remote-source"][1] + "_" + c[1]["remote-source"][2];
                                ...
                                value: function () {
                                    ...
                                    if (a.checkValues()) {
                                        ...
                                        if (this.doCustomFilterValidation(l)) {
                                            ...
                                            var p = this.dataGroupToHtml(r, e);
                                            this.orderDataGroup(e),
                                                $("#" + e[0] + "_div").html(""),
                                                $("#" + e[0] + "_div").append(p),
                                                this.makeDataGroupSortable(e, $("#" + e[0] + "_div_inner")),
        ...
        5: [
            function (e, t, a) {
                "use strict";
                var l = e("./lib");
                (window.EmployeeTrainingSessionAdapter = l.EmployeeTrainingSessionAdapter),
                    (window.TrainingSessionAdapter = l.TrainingSessionAdapter),
                    (window.CoordinatedTrainingSessionAdapter = l.CoordinatedTrainingSessionAdapter),
                    (window.SubEmployeeTrainingSessionAdapter = l.SubEmployeeTrainingSessionAdapter);
            },
            { "./lib": 6 },
        ],
        6: [
            function (e, t, a) {
                            ...
                            i(t, [
                                {
                                    key: "getDataMapping",
                                    value: function () {
                                        return ["id", "trainingSession", "status", "courseId"];
                                    },
                                },
                                {
                                    key: "getHeaders",
                                    value: function () {
                                        return [{ sTitle: "ID", bVisible: !1 }, { sTitle: "Training Session" }, { sTitle: "Status" }, { sTitle: "Course ID", bVisible: !1 }];
                                    },
                                },
                                {
                                    key: "getFormFields",
                                    value: function () {
                                        return [
                                            ...
                                            ["trainingSession", { label: "Training Session", type: "placeholder", "allow-null": !1, "remote-source": ["TrainingSession", "id", "name"] }],
                                            [
                                                "status",
                                                {
                                                    label: "Status",
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        var a = JSON.stringify(t),
                                            l = [];
                                        (l.callBackData = []), (l.callBackSuccess = "completedSuccessCallBack"), (l.callBackFail = "completedFailCallBack"), this.customAction("sessionAttended", "modules=training", a, l);
                                    },
                                },
                                {
                                    key: "completedSuccessCallBack",
                                    value: function (e) {
                                        this.showMessage("Successful", e), this.get([]);
                                    },
                                },
                                {
                                    key: "completedFailCallBack",
                                    value: function (e) {
                                        this.showMessage("Error Occurred while completing training session", e);
                                    },
                                },
                                {
                                    key: "getActionButtonsHtml",
                                    value: function (e, t) {
                                        var a = '<div style="width:100px;">_edit__course__delete__completed_</div>';
                                        return (
                                            (a = this.showDelete
                                                ? "No" === this.checkPermission("Delete Assigned Training Sessions") && "Assign" === t[3]
                                                    ? a.replace("_delete_", "")
                                                    : a.replace(
                                                          "_delete_",
                                                          '<img class="tableActionButton" src="_BASE_images/delete.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Delete" onclick="modJs.deleteRow(_id_);return false;"></img>'
                                            ...
                                            (a = this.showEdit
                                                ? a.replace(
                                                      "_edit_",
                                                      '<img class="tableActionButton" src="_BASE_images/edit.png" style="cursor:pointer;" rel="tooltip" title="Provide Feedback" onclick="modJs.edit(_id_);return false;"></img>'
                                                  )
                                                : a.replace("_edit_", "")),
                                            (a = (a = (a = (a = (a =
                                                "Scheduled" === t[2]
                                                    ? a.replace(
                                                          "_completed_",
                                                          '<img class="tableActionButton" src="_BASE_images/check_icon.png" style="cursor:pointer;margin-left:10px;" rel="tooltip" title="Completed" onclick="modJs.completed(_id_);return false;"></img>'
                                                      )
                                                    : a.replace("_completed_", "")).replace(
                                                "_course_",
                                                '<img class="tableActionButton" src="_BASE_images/view.png" style="cursor:pointer;margin-left:10px;" rel="tooltip" title="Course Information" onclick="modJsList[\'tabTrainingSession\'].edit(_cid_);return false;"></img>'
                                            )).replace(/_id_/g, e)).replace(/_cid_/g, t._org.trainingSession_id)).replace(/_BASE_/g, this.baseUrl))
                                        );
                                    },
                                },
                            ]),
                            ...
                            i(t, [
                                {
                                    key: "getDataMapping",
                                    value: function () {
                                        return ["id", "name", "course", "scheduled", "deliveryMethod", "deliveryLocation"];
                                    },
                                },
                                {
                                    key: "getHeaders",
                                    value: function () {
                                        return [{ sTitle: "ID", bVisible: !1 }, { sTitle: "Name" }, { sTitle: "Course" }, { sTitle: "Scheduled Time" }, { sTitle: "Delivery Method" }, { sTitle: "Delivery Location" }];
                                    },
                                },
                                {
                                    key: "getFormFields",
                                    value: function () {
                                        return [
                                            ...
                                            ["coordinator", { label: "Coordinator", type: "placeholder", "allow-null": !1, "remote-source": ["Employee", "id", "first_name+last_name"] }],
                                            ...
                                            ["description", { label: "Training Details", type: "placeholder", validation: "none" }],
                                            ...
                                            ["deliveryLocation", { label: "Delivery Location", type: "placeholder", validation: "none" }],
                                            [
                                                "status",
                                                {
                                                    label: "Status",
                                            ...
                                            ["attachment", { label: "Attachment", type: "fileupload", validation: "none", readonly: !0 }],
                                        ];
                                    },
                                },
                                {
                                    key: "postRenderForm",
                                    value: function (e, t) {
                                        t.find(".cancelBtn").remove(), t.find("#attachment_remove").remove();
                                    },
                                },
                                {
                                    key: "signUp",
                                    value: function (e) {
                                        ...
                                        var a = JSON.stringify(t),
                                            l = [];
                                        (l.callBackData = []), (l.callBackSuccess = "signUpSuccessCallBack"), (l.callBackFail = "signUpFailCallBack");
                                        this.renderYesNoModel(
                                            "Confirm Sign Up",
                                            "Are you sure that you want to sign up for this course?",
                                            "Yes",
                                            "No",
                                            function (e, t) {
                                                this.customAction("signup", "modules=training", e, t);
                                            },
                                            [a, l]
                                        );
                                    },
                                ...
                                {
                                    key: "signUpSuccessCallBack",
                                    value: function (e) {
                                        this.showMessage("Successful", e);
                                    },
                                },
                                {
                                    key: "signUpFailCallBack",
                                    value: function (e) {
                                        this.showMessage("Error Occurred while signing up to training session", e);
                                    },
                                },
                                {
                                    key: "getActionButtonsHtml",
                                    value: function (e, t) {
                                        var a = '<div style="width:80px;">_edit__signup_</div>';
                                        return (a = (a = (a = (a = a.replace(
                                            "_edit_",
                                            '<img class="tableActionButton" src="_BASE_images/view.png" style="cursor:pointer;" rel="tooltip" title="View" onclick="modJs.edit(_id_);return false;"></img>'
                                        )).replace(
                                            "_signup_",
                                            '<img class="tableActionButton" src="_BASE_images/run.png" style="cursor:pointer;margin-left:10px;" rel="tooltip" title="Sign Up" onclick="modJs.signUp(_id_);return false;"></img>'
                                        )).replace(/_id_/g, e)).replace(/_BASE_/g, this.baseUrl));
                                    },
                                },
                            ]),
                            t
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        return [
                                            ...
                                            ["deliveryLocation", { label: "Delivery Location", type: "text", validation: "none" }],
                                            [
                                                "attendanceType",
                                                {
                                                    label: "Attendance Type",
                        ...
                        return (
                            ...
                            i(t, [
                                ...
                                },
                                {
                                    key: "getDataMapping",
                                    value: function () {
                                        return ["id", "employee", "trainingSession", "status", "courseId"];
                                    },
                                },
                                {
                                    key: "getHeaders",
                                    value: function () {
                                        return [{ sTitle: "ID", bVisible: !1 }, { sTitle: "Employee" }, { sTitle: "Training Session" }, { sTitle: "Status" }, { sTitle: "Course ID", bVisible: !1 }];
                                    },
                                },
                                {
                                    key: "getFormFields",
                                    value: function () {
                                        return [
                                            ["id", { label: "ID", type: "hidden" }],
                                            ["employee", { label: "Employee", type: "placeholder", "allow-null": !1, "remote-source": ["Employee", "id", "first_name+last_name"] }],
                                            ["trainingSession", { label: "Training Session", type: "placeholder", "allow-null": !1, "remote-source": ["TrainingSession", "id", "name"] }],
                                            [
                                                "status",
                                                {
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        var a = JSON.stringify(t),
                                            l = [];
                                        (l.callBackData = []), (l.callBackSuccess = "completedSuccessCallBack"), (l.callBackFail = "completedFailCallBack"), this.customAction("sessionCompleted", "modules=training", a, l);
                                    },
                                },
                                {
                                    key: "getActionButtonsHtml",
                                    value: function (e, t) {
                                        ...
                                        return (
                                            (a = this.showDelete
                                                ? "No" === this.checkPermission("Delete Training Sessions of Direct Reports")
                                                    ? a.replace("_delete_", "")
                                                    : a.replace(
                                                          "_delete_",
                                                          '<img class="tableActionButton" src="_BASE_images/delete.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Delete" onclick="modJs.deleteRow(_id_);return false;"></img>'
                                            ...
                                            (a = this.showEdit
                                                ? a.replace(
                                                      "_edit_",
                                                      '<img class="tableActionButton" src="_BASE_images/edit.png" style="cursor:pointer;" rel="tooltip" title="Review Feedback" onclick="modJs.edit(_id_);return false;"></img>'
                                                  )
                                                : a.replace("_edit_", "")),
                                            (a = (a = (a = (a = (a =
                                                "Attended" === t[3]
                                                    ? a.replace(
                                                          "_completed_",
                                                          '<img class="tableActionButton" src="_BASE_images/check_icon.png" style="cursor:pointer;margin-left:10px;" rel="tooltip" title="Approve Completed Status" onclick="modJs.completed(_id_);return false;"></img>'
                                                      )
                                                    : a.replace("_completed_", "")).replace(
                                                "_course_",
                                                '<img class="tableActionButton" src="_BASE_images/view.png" style="cursor:pointer;margin-left:10px;" rel="tooltip" title="Course Information" onclick="modJsList[\'tabTrainingSession\'].edit(_cid_);return false;"></img>'
                ...
                t.exports = { EmployeeTrainingSessionAdapter: c, TrainingSessionAdapter: d, CoordinatedTrainingSessionAdapter: h, SubEmployeeTrainingSessionAdapter: p };
            },
            { "../../../api/AdapterBase": 2 },
        ],
    },
