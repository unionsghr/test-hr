!(function () {
    return function e(t, a, l) {
        ...
        for (var n = "function" == typeof require && require, r = 0; r < l.length; r++) i(l[r]);
        return i;
    };
})()(
    {
                        ...
                        l(t, [
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    return (
                                        (n = (n = (n = (n = (n = n + "?t=" + this.table) + "&sm=" + this.fixJSON(t)) + "&cl=" + this.fixJSON(a)) + "&ft=" + this.fixJSON(l)) + "&ob=" + i),
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    for (var a = [], l = this.getDataMapping(), i = 0; i < t.length; i++) {
                                        for (var n = [], r = 0; r < l.length; r++) n[r] = t[i][l[r]];
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    ...
                                    var n = this.requestCache.getKey(this.moduleRelativeURL, { t: e[0], key: e[1], value: e[2], method: l, methodParams: i, a: "getFieldValues" }),
                                        r = this.requestCache.getData(n);
                                    null != r &&
                                        "SUCCESS" === r.status &&
                                        (t.callBackData.push(r.data), null !== t.callBackSuccess && void 0 !== t.callBackSuccess && t.callBackData.push(t.callBackSuccess), a.callFunction(t.callBack, t.callBackData));
                                    var s = function e(l) {
                                        if ("SUCCESS" === l.status) {
                                    ...
                                    (s.key = n), (s.table = e[0]), $.post(this.moduleRelativeURL, { t: e[0], key: e[1], value: e[2], method: l, methodParams: i, a: "getFieldValues" }, s, "json");
                                },
                            },
                            {
                                key: "setAdminProfile",
                                                    ...
                                                    if (jQuery.inArray(n, t.inputTypes) >= 0) {
                                                        if (e.hasClass("uploadInput")) a = e.attr("val");
                                                            ...
                                                            if (null != $("#" + t.formId + " #" + i).select2("data") && void 0 !== $("#" + t.formId + " #" + i).select2("data")) {
                                                                var r = $("#" + t.formId + " #" + i).select2("data");
                                                                a = [];
                                                                for (var s = 0; s < r.length; s++) a.push(r[s].id);
                                                                a = JSON.stringify(a);
                                                            } else a = "";
                                                        else
                        ...
                        i(e, [
                            ...
                            },
                            {
                                ...
                                value: function (e, t, a) {
                                    ...
                                    var i = this.getFormFields(),
                                        n = this.getFilters();
                                    if (null != n) for (var r = 0; r < n.length; r++) (null == (l = this.getMetaFieldValues(n[r][0], i)) || ("select" !== l.type && "select2" !== l.type && "select2multi" !== l.type)) && i.push(n[r]);
                                    for (var s = [], o = [], u = null, c = null, d = 0; d < i.length; d++)
                                ...
                                value: function (e) {
                                    if (this.getRemoteTable()) this.createTableServer(e);
                                        ...
                                        var r = $("#" + e + " .dataTables_paginate .active a").html(),
                                            s = 0;
                                        void 0 !== r && null != r && (s = 15 * parseInt(r, 10) - 15), $("#" + e).html(n);
                                        var o = { oLanguage: { sLengthMenu: "_MENU_ records per page" }, aaData: l, aoColumns: t, bSort: this.isSortable(), iDisplayLength: 15, iDisplayStart: s },
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    this.showActionButtons() && (r.aoColumnDefs = [{ fnRender: this.getActionButtons, aTargets: [this.getDataMapping().length] }]);
                                ...
                                value: function (e, t, a, l, i, n) {
                                    ...
                                    (void 0 !== t && null != t) || (t = ""),
                                        ...
                                        $(s + "YesBtn")
                                            .off()
                                            .on("click", function () {
                                                void 0 !== i && null != i && (i.apply(r, n), r.cancelYesno());
                                            }),
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    var a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
                                        ...
                                        n = this,
                                        r = "";
                                    (r = i ? "#plainMessageModel" : "#messageModel"),
                                        $(r).off(),
                            ...
                            },
                            {
                                ...
                                value: function (e, t, a, l, i) {
                                    var n = this,
                                        r = "";
                                    (r = i ? "#dataMessageModel" : "#messageModel"),
                                        $(r).unbind("hide"),
                            ...
                            },
                            {
                                key: "save",
                                value: function (e, t) {
                                    var a = new r.default(this.getTableName() + "_submit", !0, { ShowPopup: !1, LabelErrorClass: "error" });
                                    if (a.checkValues()) {
                            ...
                            },
                            {
                                key: "filterQuery",
                                value: function () {
                                    var e = new r.default(this.getTableName() + "_filter", !0, { ShowPopup: !1, LabelErrorClass: "error" });
                                    if (e.checkValues()) {
                                ...
                                value: function (e) {
                                    ...
                                    for (var u in (null == i && (i = []), e))
                                        if (e.hasOwnProperty(u)) {
                                            if (((r = ""), (s = null), "select" === (i = this.getMetaFieldValues(u, o)).type || "select2" === i.type)) {
                                                if (void 0 !== i["remote-source"] && null != i["remote-source"])
                                                    (a = i["remote-source"]),
                                                        "NULL" === e[u] ? (r = void 0 !== i["null-label"] && null != i["null-label"] ? i["null-label"] : "Not Selected") : (s = r = this.fieldMasterData[a[0] + "_" + a[1] + "_" + a[2]][e[u]]);
                                                else if (((l = i.source[0]), "NULL" === e[u])) r = void 0 !== i["null-label"] && null != i["null-label"] ? i["null-label"] : "Not Selected";
                                                else
                                ...
                                value: function (e) {
                                    for (var t = this.templates.filterTemplate, a = "", l = this.getFilters(), i = 0; i < l.length; i++) {
                                        ...
                                        if ("" === n || void 0 === n) a += this.renderFormField(l[i]);
                                            ...
                                            var r = e[n];
                                            "" !== r && null != r && void 0 !== r && "" !== r.trim() ? (a += this.renderFormField(JSON.parse(r))) : (a += this.renderFormField(l[i]));
                                        }
                                    }
                            ...
                            { key: "preRenderForm", value: function (e) {} },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    for (var a = this.templates.formTemplate, l = "", i = this.getFormFields(), n = 0; n < i.length; n++) {
                                        var r = this.getMetaFieldForRendering(i[n][0]);
                                        if ("" === r || void 0 === r) l += this.renderFormField(i[n]);
                                        else {
                                            var s = e[r];
                            ...
                            { key: "postRenderForm", value: function (e, t) {} },
                            {
                                ...
                                value: function (e, t) {
                                    ...
                                    for (var o = $('<div id="' + t[0] + '_div_inner"></div>'), u = 0; u < a.length; u++) {
                                        ...
                                        i))
                                            void 0 !== (r = i[c]) && null != r && "string" == typeof r && (r = r.replace(/(?:\r\n|\r|\n)/g, "<br />")), (l = l.replace("#_" + c + "_#", r));
                                        void 0 !== t[1].render && null != t[1].render && (l = l.replace("#_renderFunction_#", t[1].render(i))), (n = $(l)).attr("fieldId", t[0] + "_div"), o.append(n);
                                    }
                                    return o;
                                },
                            },
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    var a = new r.default(this.getTableName() + "_field_" + e[0], !0, { ShowPopup: !1, LabelErrorClass: "error" });
                                    if (a.checkValues()) {
                                        var l = a.getFormParameters();
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    var e = this.currentDataGroupField,
                                        ...
                                        a = new r.default(this.getTableName() + "_field_" + e[0], !0, { ShowPopup: !1, LabelErrorClass: "error" });
                                    if (a.checkValues()) {
                                        var l = a.getFormParameters();
                                        if (void 0 !== e[1]["custom-validate-function"] && null != e[1]["custom-validate-function"]) {
                                        ...
                                        if (this.doCustomFilterValidation(l)) {
                                            var n = $("#" + e[0]).val();
                                            "" === n && (n = "[]");
                                            for (var s = JSON.parse(n), o = {}, u = -1, c = [], d = 0; d < s.length; d++) {
                                                var h = s[d];
                                                h.id === t && ((o = h), (u = d)), c.push(h);
                                            }
                                            (l.id = o.id), (c[u] = l), void 0 !== e[1]["sort-function"] && null != e[1]["sort-function"] && c.sort(e[1]["sort-function"]), (n = JSON.stringify(c)), $("#" + e[0]).val(n);
                                    ...
                                    for (var i = 0; i < a.length; i++)
                                        if ("date" === a[i][1].type) "0000-00-00" !== e[a[i][0]] && "" !== e[a[i][0]] && null != e[a[i][0]] && void 0 !== e[a[i][0]] && $(t + " #" + a[i][0] + "_date").datepicker("setValue", e[a[i][0]]);
                                            ...
                                            if ("0000-00-00 00:00:00" !== e[a[i][0]] && "" !== e[a[i][0]] && null != e[a[i][0]] && void 0 !== e[a[i][0]]) {
                                                ...
                                                $(t + " #" + a[i][0] + "_datetime")
                                                    .data("datetimepicker")
                                                    .setLocalDate(new Date(r[0], parseInt(r[1], 10) - 1, r[2], s[0], s[1], s[2]));
                                            }
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    ...
                                    for (var n = 0; n < l.length; n++) {
                                        ...
                                        a += o = (o = o.replace("_id_", r)).replace("_val_", this.gt(s));
                                    }
                                    return a;
                                },
                            },
        ...
        5: [
            function (e, t, a) {
                "use strict";
                var l = e("./lib");
                (window.AttendanceAdapter = l.AttendanceAdapter), (window.EmployeeAttendanceSheetAdapter = l.EmployeeAttendanceSheetAdapter);
            },
            { "./lib": 6 },
        ],
        6: [
            function (e, t, a) {
                ...
                var l = (function () {
                    ...
                    i = r(e("../../../api/AdapterBase")),
                    n = r(e("../../../api/FormValidation"));
                function r(e) {
                    return e && e.__esModule ? e : { default: e };
                }
                function s(e, t) {
                ...
                var c = (function (e) {
                        function t(e, a, l, i) {
                            s(this, t);
                            var n = o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, a, l, i));
                            return (n.punch = null), (n.useServerTime = 0), (n.photoTaken = 0), (n.photoAttendance = 0), n;
                        }
                        return (
                            u(t, i.default),
                            l(t, [
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        this.useServerTime = e;
                                    },
                                },
                                {
                                    key: "setPhotoAttendance",
                                    value: function (e) {
                                        this.photoAttendance = parseInt(e, 10);
                                    },
                                },
                                {
                                    key: "getDataMapping",
                                ...
                                },
                                {
                                    key: "getHeaders",
                                    value: function () {
                                        return [{ sTitle: "ID", bVisible: !1 }, { sTitle: "Time-In" }, { sTitle: "Time-Out" }, { sTitle: "Note" }];
                                    },
                                },
                                {
                                    key: "getFormFields",
                                    value: function () {
                                        return 0 === this.useServerTime
                                            ? [
                                ...
                                },
                                {
                                    ...
                                    value: function (e, t, a) {
                                        return 1 === a
                                            ? "0000-00-00 00:00:00" === t || "" === t || null == t
                                                ? ""
                                                : Date.parse(t).toString("yyyy MMM d  <b>HH:mm</b>")
                                            : 2 === a
                                            ? "0000-00-00 00:00:00" === t || "" === t || null == t
                                                ? ""
                                                : Date.parse(t).toString("MMM d  <b>HH:mm</b>")
                                            : 3 === a && null != t && t.length > 20
                                            ? t.substring(0, 20) + ".."
                                            : t;
                                    },
                                },
                                ...
                                },
                                {
                                    key: "getTableTopButtonHtml",
                                    value: function () {
                                        return null === this.punch || void 0 === this.punch
                                            ? '<button id="punchButton" style="float:right;" onclick="modJs.showPunchDialog();return false;" class="btn btn-small">Punch-in <span class="icon-time"></span></button>'
                                            : '<button id="punchButton" style="float:right;" onclick="modJs.showPunchDialog();return false;" class="btn btn-small">Punch-out <span class="icon-time"></span></button>';
                                    },
                                },
                                {
                                    key: "save",
                                    value: function () {
                                        var e = new n.default(this.getTableName() + "_submit", !0, { ShowPopup: !1, LabelErrorClass: "error" });
                                        if (e.checkValues()) {
                                            var t = this.doCustomValidation();
                                            if (null == t) {
                                                var a = e.getFormParameters();
                                                ...
                                                var l = JSON.stringify(a),
                                                    i = [];
                                                (i.callBackData = []), (i.callBackSuccess = "saveSuccessCallback"), (i.callBackFail = "getPunchFailCallBack"), this.customAction("savePunch", "modules=attendance", l, i, !0);
                                            } else $("#" + this.getTableName() + "Form .label").html(t), $("#" + this.getTableName() + "Form .label").show();
                                        }
                                    },
                                },
                                {
                                    ...
                                    value: function (e) {
                                        (this.punch = e), this.getPunch("changePunchButtonSuccessCallBack"), $("#PunchModel").modal("hide"), this.get([]);
                                    },
                                },
                                {
                                    key: "cancel",
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        var t = {};
                                        (t.date = this.getClientDate(new Date()).toISOString().slice(0, 19).replace("T", " ")), (t.offset = this.getClientGMTOffset());
                                        var a = JSON.stringify(t),
                                            l = [];
                                        (l.callBackData = []), (l.callBackSuccess = e), (l.callBackFail = "getPunchFailCallBack"), this.customAction("getPunch", "modules=attendance", a, l);
                                    },
                                },
                                {
                                    ...
                                    value: function (e) {
                                        (this.punch = e),
                                            ...
                                            null === this.punch ? ($("#PunchModel").find("h3").html("Punch Time-in"), modJs.renderForm()) : ($("#PunchModel").find("h3").html("Punch Time-out"), modJs.renderForm(this.punch)),
                                            $("#Attendance").show(),
                                            $("#time_datetime").data("datetimepicker").setLocalDate(new Date());
                                    },
                                },
                                {
                                    key: "changePunchButtonSuccessCallBack",
                                    value: function (e) {
                                        (this.punch = e), null === this.punch ? $("#punchButton").html('Punch-in <span class="icon-time"></span>') : $("#punchButton").html('Punch-out <span class="icon-time"></span>');
                                    },
                                },
                                {
                                    key: "getPunchFailCallBack",
                                    value: function (e) {
                                        this.showMessage("Error Occured while Time Punch", e);
                                    },
                                },
                                {
                                    key: "getClientDate",
                                ...
                                },
                                {
                                    key: "doCustomValidation",
                                    value: function (e) {
                                        return 1 !== this.photoAttendance || this.photoTaken ? null : "Please attach a photo before submitting";
                                    },
                                },
                                {
                                    key: "forceInjectValuesBeforeSave",
                                    value: function (e) {
                                        if (1 === this.photoAttendance) {
                                            var t = document.getElementById("attendnaceCanvas");
                                            e.image = t.toDataURL();
                                        }
                                        return e;
                                    },
                                },
                                {
                                    ...
                                    value: function () {
                                        if (1 === this.photoAttendance) {
                                            ...
                                            var e = document.getElementById("attendnaceVideo");
                                            navigator.mediaDevices &&
                                                navigator.mediaDevices.getUserMedia &&
                                                navigator.mediaDevices.getUserMedia({ video: !0 }).then(function (t) {
                                                    (e.srcObject = t), e.play();
                                                }),
                                                (this.photoTaken = !1),
                                                this.configureEvents();
                                        } else $(".photoAttendance").remove();
                                    },
                                },
                                {
                                    key: "configureEvents",
                                    value: function () {
                                        var e = this,
                                            t = document.getElementById("attendnaceCanvas").getContext("2d"),
                                            a = document.getElementById("attendnaceVideo");
                                        $(".attendnaceSnap").click(function () {
                                            return t.drawImage(a, 0, 0, 208, 156), (e.photoTaken = !0), !1;
                                        });
                                    },
                                },
                            ]),
                    ...
                    d = (function (e) {
                        function t(e, a, l, i) {
                            s(this, t);
                            var n = o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, a, l, i));
                            return (n.currentTimesheetId = null), (n.currentTimesheet = null), n;
                        }
                        return (
                            u(t, i.default),
                            l(t, [
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        $("#" + this.getTableName() + "Form").html(t),
                                            ...
                                            $("#attendnacesheet_start").html(Date.parse(e.date_start).toString("MMM d, yyyy (dddd)")),
                                            $("#attendnacesheet_end").html(Date.parse(e.date_end).toString("MMM d, yyyy (dddd)")),
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        var e = this.currentId,
                                            t = JSON.stringify(modJsList.tabEmployeeTimeEntry.getSourceMapping()),
                                            a = JSON.stringify({ id: e, sm: t }),
                                            l = [];
                                        (l.callBackData = []), (l.callBackSuccess = "getTimeEntriesSuccessCallBack"), (l.callBackFail = "getTimeEntriesFailCallBack"), this.customAction("getTimeEntries", "modules=time_sheets", a, l);
                                    },
                                },
                                {
                                    ...
                                    value: function (e) {
                                        for (var t = e, a = "", l = 0; l < t.length; l++)
                                            try {
                                                ...
                                                i = (i = i.replace(/_start_/g, Date.parse(t[l].date_start).toString("MMM d, yyyy [hh:mm tt]"))).replace(/_end_/g, Date.parse(t[l].date_end).toString("MMM d, yyyy [hh:mm tt]"));
                                                var n = Date.parse(t[l].date_end) - Date.parse(t[l].date_start),
                                                    r = Math.round(n / 6e4),
                                                    s = r % 60,
                                                    o = (r - s) / 60;
                                                (i = i.replace(/_duration_/g, "Hours (" + o + ") - Min (" + s + ")")),
                                                    (a += i = (i = (i = (i = (i =
                                                        "null" === t[l].project || null === t[l].project || void 0 === t[l].project ? i.replace(/_project_/g, "None") : i.replace(/_project_/g, t[l].project)).replace(
                                                        /_project_/g,
                                                        t[l].project
                                                    )).replace(/_details_/g, t[l].details)).replace(/_id_/g, t[l].id)).replace(/_BASE_/g, this.baseUrl));
                                            } catch (e) {}
                                        $(".timesheet_entries_table_body").html(a),
                                            "SubEmployeeTimeSheetAll" === modJs.getTableName()
                                                ? ($("#submit_sheet").hide(), $("#add_time_sheet_entry").hide())
                                                : "Approved" === this.currentElement.status
                                                ? ($("#submit_sheet").hide(), $("#add_time_sheet_entry").hide())
                                                : ($("#submit_sheet").show(), $("#add_time_sheet_entry").show());
                                    },
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        var t = JSON.stringify({ id: e }),
                                            a = [];
                                        (a.callBackData = []),
                                            (a.callBackSuccess = "createPreviousAttendnacesheetSuccessCallBack"),
                                            (a.callBackFail = "createPreviousAttendnacesheetFailCallBack"),
                                            this.customAction("createPreviousAttendnaceSheet", "modules=attendnace", t, a);
                                    },
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    value: function (e, t) {
                                        return ("EmployeeTimeSheetAll" === this.getTableName()
                                            ? '<div style="width:80px;"><img class="tableActionButton" src="_BASE_images/view.png" style="cursor:pointer;" rel="tooltip" title="Edit Timesheet Entries" onclick="modJs.edit(_id_);return false;"></img><img class="tableActionButton" src="_BASE_images/redo.png" style="cursor:pointer;margin-left:15px;" rel="tooltip" title="Create previous time sheet" onclick="modJs.createPreviousAttendnacesheet(_id_);return false;"></img></div>'
                                            : '<div style="width:80px;"><img class="tableActionButton" src="_BASE_images/view.png" style="cursor:pointer;" rel="tooltip" title="Edit Timesheet Entries" onclick="modJs.edit(_id_);return false;"></img></div>'
                                        )
                                            .replace(/_id_/g, e)
                ...
                t.exports = { AttendanceAdapter: c, EmployeeAttendanceSheetAdapter: d };
            },
