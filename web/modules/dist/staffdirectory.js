...
})()(
    {
                ...
                var o = (function (e) {
                    ...
                    return (
                        ...
                        i(t, [
                            ...
                            { key: "addDomEvents", value: function (e) {} },
                            {
                                key: "getTemplateName",
                                value: function () {
                                    return "";
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    var a = this;
                                    this.hideLoadError(),
                                        t || ((this.currentPage = 1), null != this.container && this.container.html(""), (this.hasMoreData = !0), (this.tableData = [])),
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    ...
                                    if (0 !== t.length || "" !== this.container.html()) {
                                        try {
                                            null == this.getFilters()
                                                ? ($("#" + this.getTableName() + "_filterBtn").hide(), $("#" + this.getTableName() + "_resetFilters").hide())
                                                : ($("#" + this.getTableName() + "_filterBtn").show(),
                                                  $("#" + this.getTableName() + "_resetFilters").show(),
                                                  "" !== this.currentFilterString && null != this.currentFilterString
                                                      ? $("#" + this.getTableName() + "_resetFilters").html(this.currentFilterString + '<i class="fa fa-times"></i>')
                                                      : ($("#" + this.getTableName() + "_resetFilters").html("Reset Filters"), $("#" + this.getTableName() + "_resetFilters").hide()));
                                        } catch (e) {}
                                        $("#" + this.getTableName())
                                            .find(".search-controls")
                                            .show(),
                                            t.length > this.pageSize
                                                ? ((this.hasMoreData = !0), t.pop(), null !== this.loadMoreButton && (this.loadMoreButton.removeAttr("disabled"), this.loadMoreButton.show()))
                                                : ((this.hasMoreData = !1), null !== this.loadMoreButton && this.loadMoreButton.hide()),
                                        ...
                                        if (
                                            ...
                                            void 0 !== e.callBack &&
                                                ...
                                                ((void 0 !== e.callBackData && null != e.callBackData) || (e.callBackData = []), e.callBackData.push(t), e.callBackData.push(a), this.callFunction(e.callBack, e.callBackData)),
                                            (this.tableData = a),
                                            void 0 === e.noRender || null == e.noRender || !0 !== e.noRender)
                                        )
        ...
        6: [
            function (e, t, a) {
                "use strict";
                var l = e("./lib");
                (window.StaffDirectoryAdapter = l.StaffDirectoryAdapter), (window.StaffDirectoryObjectAdapter = l.StaffDirectoryObjectAdapter);
            },
            { "./lib": 7 },
        ],
        7: [
            function (e, t, a) {
                        ...
                        return (
                            ...
                            l(t, [
                                        ...
                                        return {
                                            aoColumnDefs: [
                                                ...
                                                },
                                                {
                                                    fnRender: function (t, a) {
                                                        try {
                                                            return e.preProcessRemoteTableData(t, a, 8);
                                                        } catch (e) {
                                                            return a;
                                                        }
                                                    },
                                ...
                                },
                                {
                                    ...
                                    value: function (e, t, a) {
                                        if (8 === a) return "0000-00-00 00:00:00" === t || "" === t || null == t ? "" : Date.parse(t).toString("yyyy MMM d");
                                        if (1 === a) {
                        ...
                        return (
                            ...
                            l(t, [
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        var t = e;
                                        return (t.color = this.getColorByRandomString(t.first_name)), t;
                                    },
                                },
                                {
                                    key: "getFilters",
                                    value: function () {
                                        return [
                                            ["job_title", { label: "Job Title", type: "select2", "allow-null": !0, "null-label": "All Job Titles", "remote-source": ["JobTitle", "id", "name"] }],
                                            ["department", { label: "Department", type: "select2", "allow-null": !0, "null-label": "All Departments", "remote-source": ["CompanyStructure", "id", "title"] }],
                                        ];
                                    },
                                },
                            ]),
                ...
                t.exports = { StaffDirectoryAdapter: c, StaffDirectoryObjectAdapter: d };
            },
            { "../../../api/AdapterBase": 2, "../../../api/ObjectAdapter": 5 },
        ],
    },
    {},
    [6]
