! function() {
        ...
        var d = function(e) {
                ...
                return u(t, n.default), i(t, [{
                    ...
                    value: function(e) {
                        ...
                        var a = this._formFileds.length,
                            l = [];
                        this.remoteFieldsExists = !1;
                        for (var i = 0; i < a; i++)
                            if ("fieldset" === this._formFileds[i][1].type) {
                                var r = JSON.parse(e[this._formFileds[i][0]]);
                                l.push(this._formFileds[i][0]), r.forEach(function(e) {
                                    t._formFileds.push(e), void 0 !== e[1]["remote-source"] && null != e[1]["remote-source"] && (t.remoteFieldsExists = !0)
                                })
                            }
                        var n = [];
                        t._formFileds.forEach(function(e) {
                            jQuery.inArray(e[0], l) < 0 && n.push(e)
                        }), t._formFileds = n
                    }
                }, {
                    key: "renderForm",
                    value: function(e) {
                        var t = this;
                        if (this.processFormFieldsWithObject(e), this.remoteFieldsExists) {
                            this.initFieldMasterData(function() {
                                t.renderFormNew(e)
                            })
                        } else this.initFieldMasterData(), t.renderFormNew(e);
                    ...
                    value: function(e) {
                        ...
                        for (var a = this.templates.formTemplate, l = "", i = this.getFormFields(), r = 0; r < i.length; r++) {
                            ...
                            if ("" === n || void 0 === n) l += this.renderFormField(i[r]);
                                ...
                                var s = e[n];
                                "" !== s && null != s && void 0 !== s && "" !== s.trim() ? l += this.renderFormField(JSON.parse(s)) : l += this.renderFormField(i[r])
                            }
                        }
                        ...
                        this.showFormOnPopup ? (o = $('<div class="reviewBlock popupForm" data-content="Form"></div>')).attr("id", u) : o = $("#" + this.getTableName() + "Form"), o.html(a), o.find(".datefield").datepicker({
                            ...
                            language: "en"
                        }), o.find(".colorpick").colorpicker(), o.find(".select2Field").each(function() {
                        ...
                        for (var d = 0; d < i.length; d++) "datagroup" === i[d][1].type && o.find("#" + i[d][0]).data("field", i[d]);
                        if (!1 === this.showSave ? o.find(".saveBtn").remove() : (o.find(".saveBtn").off(), o.find(".saveBtn").data("modJs", this), o.find(".saveBtn").on("click", function() {
                            ...
                            void 0 !== e && null != e && this.fillForm(e, "#" + u)
                        } else {
                            ...
                            void 0 !== e && null != e && this.fillForm(e)
                        }
                    ...
                    value: function(e, t) {
                        var a = '<div style="width:80px;"><img class="tableActionButton" src="_BASE_images/download.png" style="cursor:pointer;" rel="tooltip" title="Download" onclick="modJs.edit(_id_);return false;"></img></div>';
                    ...
                    value: function(e, t) {
                        ...
                        // }) + '" target="_blank" style="font-size:14px;font-weight:bold;">Download Report <img src="_BASE_images/download.png"></img> </a>').replace(/_BASE_/g, this.baseUrl), "PDF" === output || "JSON" === output) this.showMessage("Download Report", l);
                            ...
                            $("#tempReportTable").dataTable(s), $(".dataTables_paginate ul").addClass("pagination"), $(".dataTables_length").hide(), $(".dataTables_filter input").addClass("form-control"), $(".dataTables_filter input").attr("placeholder", "Search"), $(".dataTables_filter label").contents().filter(function() {
                    ...
                    key: "fillForm",
                    value: function(e) {
                        for (var t = this.getFormFields(), a = 0; a < t.length; a++) "label" === t[a][1].type ? $("#" + this.getTableName() + "Form #" + t[a][0]).html(e[t[a][0]]) : $("#" + this.getTableName() + "Form #" + t[a][0]).val(e[t[a][0]])
                    }
                }]), t
            }(),
            c = function(e) {
                ...
                return u(t, n.default), i(t, [{
                    ...
                    key: "getActionButtonsHtml",
                    value: function(e, t) {
                        var a = '<div style="width:80px;"><img class="tableActionButton" src="_BASE_images/download.png" style="cursor:pointer;" rel="tooltip" title="Download" onclick="download(_name_);return false;"></img></div>';
                        return a = (a = (a = a.replace(/_id_/g, e)).replace(/_name_/g, t[1])).replace(/_BASE_/g, this.baseUrl)
                    }
                }]), t
            }();
        t.exports = {
        ...
        var s = function(e) {
            ...
            return function(e, t) {
                ...
                value: function(e, t) {
                    ...
                    s.key = r, s.table = e[0], $.post(this.moduleRelativeURL, {
                        t: e[0],
                        key: e[1],
                        value: e[2],
                        method: l,
                                ...
                                if (jQuery.inArray(r, t.inputTypes) >= 0) {
                                    if (e.hasClass("uploadInput")) a = e.attr("val");
                                        ...
                                        if (null != $("#" + t.formId + " #" + i).select2("data") && void 0 !== $("#" + t.formId + " #" + i).select2("data")) {
                                            ...
                                            a = [];
                                            for (var s = 0; s < n.length; s++) a.push(n[s].id);
                                            a = JSON.stringify(a)
                                        } else a = "";
        ...
        var s = function() {
            ...
            return i(e, [{
                ...
                value: function(e, t, a) {
                    ...
                    for (var s = [], o = [], u = null, d = null, c = 0; c < i.length; c++)
                        ...
                        for (var f = 0; f < u[1].form.length; f++)
                            if (void 0 !== (d = u[1].form[f])[1]["remote-source"] && null !== d[1]["remote-source"]) {
                                ...
                                o.indexOf(p) < 0 && (s.push(d), o.push(p))
                            }
                ...
                value: function(e) {
                    if (this.getRemoteTable()) this.createTableServer(e);
                        ...
                        var n = $("#" + e + " .dataTables_paginate .active a").html(),
                            s = 0;
                        void 0 !== n && null != n && (s = 15 * parseInt(n, 10) - 15), $("#" + e).html(r);
                        var o = {
                                oLanguage: {
                                    sLengthMenu: "_MENU_ records per page"
                                },
                ...
                value: function(e) {
                    ...
                    for (var u in null == i && (i = []), e)
                        if (e.hasOwnProperty(u)) {
                            if (n = "", s = null, "select" === (i = this.getMetaFieldValues(u, o)).type || "select2" === i.type) {
                                if (void 0 !== i["remote-source"] && null != i["remote-source"]) a = i["remote-source"], "NULL" === e[u] ? n = void 0 !== i["null-label"] && null != i["null-label"] ? i["null-label"] : "Not Selected" : s = n = this.fieldMasterData[a[0] + "_" + a[1] + "_" + a[2]][e[u]];
                ...
                value: function(e, t) {
                    ...
                    s.attr("id", n), s.html(a), s.find(".datefield").datepicker({
                        viewMode: 2
                ...
                value: function() {
                    ...
                    if (a.checkValues()) {
                        ...
                        if (this.doCustomFilterValidation(l)) {
                            var r = $("#" + e[0]).val();
                            "" === r && (r = "[]");
                            for (var s = JSON.parse(r), o = {}, u = -1, d = [], c = 0; c < s.length; c++) {
                                var h = s[c];
                                h.id === t && (o = h, u = c), d.push(h)
                            }
                            l.id = o.id, d[u] = l, void 0 !== e[1]["sort-function"] && null != e[1]["sort-function"] && d.sort(e[1]["sort-function"]), r = JSON.stringify(d), $("#" + e[0]).val(r);
                    ...
                    for (var i = 0; i < a.length; i++)
                        ...
                        if ("0000-00-00 00:00:00" !== e[a[i][0]] && "" !== e[a[i][0]] && null != e[a[i][0]] && void 0 !== e[a[i][0]]) {
                            var r = e[a[i][0]].split(" "),
                                n = r[0].split("-"),
                                s = r[1].split(":");
                            $(t + " #" + a[i][0] + "_datetime").data("datetimepicker").setLocalDate(new Date(n[0], parseInt(n[1], 10) - 1, n[2], s[0], s[1], s[2]))
                        }
                ...
                value: function(e, t) {
                    ...
                    for (var r = 0; r < l.length; r++) {
                        ...
                        a += o = (o = o.replace("_id_", n)).replace("_val_", this.gt(s))
                    }
                    return a
                }
            }, {
    ...
    6: [function(e, t, a) {
        "use strict";
        var l = e("./lib");
        window.UserReportAdapter = l.UserReportAdapter
    }, {
        "./lib": 7
    }],
    7: [function(e, t, a) {
