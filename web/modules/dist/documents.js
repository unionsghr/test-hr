! function () {
    ...
    var s = function (e) {
      ...
      return function (e, t) {
        ...
        value: function (e, t) {
          ...
          "" !== this.searchTerm && void 0 !== this.searchTerm && null != this.searchTerm && (l += "&sSearch=" + this.searchTerm),
           $.post(l, function (t) {
             console.log(l);
             console.log(t);
  ...
  6: [function (e, t, a) {
    "use strict";
    var l = e("./lib");
    window.EmployeeDocumentAdapter = l.EmployeeDocumentAdapter, window.EmployeeCompanyDocumentAdapter = l.EmployeeCompanyDocumentAdapter
  }, {
    "./lib": 7
  }],
  7: [function (e, t, a) {
    ...
    var c = function (e) {
      ...
      return u(t, i.default), l(t, [{
        ...
        key: "getActionButtonsHtml",
        value: function (e, t) {
          var a = '<div style="width:80px;">_edit__download__delete_</div>';
          return a = a.replace("_download_", '<img class="tableActionButton" src="_BASE_images/download.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Download Document" onclick="download(\'_attachment_\');return false;"></img>'), a = this.showDelete ? a.replace("_delete_", '<img class="tableActionButton" src="_BASE_images/delete.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Delete" onclick="modJs.deleteRow(_id_);return false;"></img>') : a.replace("_delete_", ""), a = (a = (a = (a = this.showEdit ? a.replace("_edit_", '<img class="tableActionButton" src="_BASE_images/edit.png" style="cursor:pointer;" rel="tooltip" title="Edit" onclick="modJs.edit(_id_);return false;"></img>') : a.replace("_edit_", "")).replace(/_id_/g, e)).replace(/_attachment_/g, t[5])).replace(/_BASE_/g, this.baseUrl)
        }
      }]), t
    }(),
      d = function (e) {
        ...
        return u(t, r.default), l(t, [{
          ...
          key: "preProcessTableData",
          value: function (e) {
            return e.color = this.getColorByFileType(e.type), e.icon = this.getIconByFileType(e.type), e.details_long = this.nl2br(e.details), e.details.length > 30 && (e.details = e.details.substring(0, 30)), void 0 !== e.size && null != e.size || (e.size = ""), e
          }
        }]), t
      }();
    t.exports = {
      EmployeeDocumentAdapter: c,
      EmployeeCompanyDocumentAdapter: d
    }
  }, {
    "../../../api/AdapterBase": 2,
    "../../../api/ObjectAdapter": 5
