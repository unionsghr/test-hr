! function() {
        ...
        var c = function(e) {
                    ...
                    value: function() {
                        return [
                            ...
                            ["items", {
                                label: "Fields",
                                type: "datagroup",
                                help: "At least one field should be added",
                                form: [
                                    ["name", {
                                        label: "Name",
                                        type: "text",
                                ...
                                html: '<div id="#_id_#" class="panel panel-default"><div class="panel-heading"><b>#_field_label_#</b> #_delete_##_edit_#</div><div class="panel-body">Type: <b>#_field_type_#</b><br/>Validation: <b>#_field_validation_#</b><br/>Help Text: <b>#_field_help_#</b></div></div>',
                                validation: "",
                                "custom-validate-function": function(e) {
                                    var t, l = {
                                        valid: !0
                                    };
                                    if (null != (t = e.name) && /^[a-z][a-z0-9._]+$/.test(t) || (l.message = "Invalid name, should have lower case letters, numbers or _", l.valid = !1), ["select", "select2", "select2multi"].indexOf(e.field_type) >= 0 && ("" !== e.field_options && void 0 !== e.field_options && null !== e.field_options || (l.message = "Please type in option to be added to select field. Input one option per line", l.valid = !1)), ["id", "form", "employee", "status", "created", "updated"].indexOf(e.name) >= 0 && (l.message = "Selected name is not allowed", l.valid = !1), !1 === l.valid) return l;
                                    var a = [e.name];
                                    if (a.push({}), a[1].label = e.field_label, a[1].type = e.field_type, a[1].validation = e.field_validation, void 0 !== e.field_help && null !== e.field_help && "" !== e.field_help && (a[1].help = e.field_help), ["select", "select2", "select2multi"].indexOf(e.field_type) >= 0) {
                                        "" !== e.field_options && void 0 !== e.field_options && null !== e.field_options || (l.message = "Please type in option to be added to select field. Input one option per line", l.valid = !1);
                                        for (var i = [], r = e.field_options.split(/\r?\n/), n = 0; n < r.length; n++) i.push([r[n], r[n]]);
                                        a[1].source = i
                                    }
                                    return null !== e.field_validation && void 0 !== e.field_validation || (a[1].validation = "", e.field_validation = ""), e.data = JSON.stringify(a), l.params = e, l
                                }
                            }]
                        ]
                    }
            ...
            d = function(e) {
                ...
                return u(t, n.default), i(t, [{
                    key: "getDataMapping",
                    value: function() {
                        return ["id", "employee", "form", "status"]
                    }
                }, {
                    key: "getHeaders",
                    value: function() {
                    ...
                    value: function(e) {
                        var t = {
                            ...
                            l = JSON.stringify(t),
                            a = [];
                        a.callBackData = [], a.callBackSuccess = "showConfigViewSuccessCallBack", a.callBackFail = "showConfigViewFailCallBack", this.customAction("getFormData", "admin=forms", l, a)
                    }
                }, {
                    key: "showConfigViewSuccessCallBack",
                    value: function(e, t) {
                        var l = e.form,
                            a = e.data;
                        this.renderConfigForm(l, a)
                    }
                }, {
                    key: "showConfigViewFailCallBack",
                    value: function(e, t) {
                        this.showMessage("Error", e)
                    }
                }, {
                    key: "getMergedConfigFields",
                    value: function(e) {
                        var t = this.getPlaceHolderFormFields(),
                            l = [],
                            a = JSON.parse(e.items);
                        for (var i in a) l.push(JSON.parse(a[i].data));
                        return t.concat(l)
                    }
                }, {
                    ...
                    key: "renderConfigForm",
                    value: function(e, t) {
                        var l = t;
                        this.preRenderForm(l);
                        for (var a = this.templates.formTemplate, i = "", r = this.getMergedConfigFields(e), n = 0; n < r.length; n++) {
                            var o = this.getMetaFieldForRendering(r[n][0]);
                            if ("" === o || void 0 === o) i += this.renderFormField(r[n]);
                            else {
                                var s = l[o];
                                "" !== s && null != s && void 0 !== s && "" !== s.trim() ? i += this.renderFormField(JSON.parse(s)) : i += this.renderFormField(r[n])
                            }
                        }
                        a = (a = a.replace(/_id_/g, this.getTableName() + "_submit")).replace(/_fields_/g, i);
                        var u = void 0,
                            c = this.generateRandom(14);
                        this.showFormOnPopup ? (u = $('<div class="reviewBlock popupForm" data-content="Form"></div>')).attr("id", c) : u = $("#" + this.getTableName() + "Form"), u.html(a), u.find(".datefield").datepicker({
                            viewMode: 2
                        }), u.find(".timefield").datetimepicker({
                            language: "en",
                            pickDate: !1
                        }), u.find(".datetimefield").datetimepicker({
                            language: "en"
                        }), u.find(".select2Field").each(function() {
                            $(this).select2().select2("val", $(this).find("option:eq(0)").val())
                        }), u.find(".select2Multi").each(function() {
                        ...
                        for (var d = 0; d < r.length; d++) "datagroup" === r[d][1].type && u.find("#" + r[d][0]).data("field", r[d]);
                        !1 === this.showSave ? u.find(".saveBtn").remove() : (u.find(".saveBtn").off(), u.find(".saveBtn").data("modJs", this), u.find(".saveBtn").on("click", function() {
                            return $(this).data("modJs").save(), !1
                        })), !1 === this.showCancel ? u.find(".cancelBtn").remove() : (u.find(".cancelBtn").off(), u.find(".cancelBtn").data("modJs", this), u.find(".cancelBtn").on("click", function() {
                            return $(this).data("modJs").cancel(), !1
                        })), this.showFormOnPopup ? (this.showMessage("Edit", "", null, null, !0), $("#plainMessageModel .modal-body").html(""), $("#plainMessageModel .modal-body").append(u), null != l && this.fillForm(l, "#" + c, r)) : ($("#" + this.getTableName() + "Form").show(), $("#" + this.getTableName()).hide(), null != l && this.fillForm(l, null, r)), this.postRenderForm(l, u)
                    }
                }, {
                    key: "getActionButtonsHtml",
                    value: function(e, t) {
                        var l = '<div style="width:120px;">_edit__configure__delete__clone_</div>';
                        return l = this.showAddNew ? l.replace("_clone_", '<img class="tableActionButton" src="_BASE_images/clone.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Copy" onclick="modJs.copyRow(_id_);return false;"></img>') : l.replace("_clone_", ""), l = this.showDelete ? l.replace("_delete_", '<img class="tableActionButton" src="_BASE_images/delete.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Delete" onclick="modJs.deleteRow(_id_);return false;"></img>') : l.replace("_delete_", ""), this.showConfigure = !0, l = this.showConfigure ? l.replace("_configure_", '<img class="tableActionButton" src="_BASE_images/run.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Fill Form" onclick="modJs.showConfigView(\'_id_\');return false;"></img>') : l.replace("_configure_", ""), l = (l = (l = this.showEdit ? l.replace("_edit_", '<img class="tableActionButton" src="_BASE_images/edit.png" style="cursor:pointer;" rel="tooltip" title="Edit" onclick="modJs.edit(_id_);return false;"></img>') : l.replace("_edit_", "")).replace(/_id_/g, e)).replace(/_BASE_/g, this.baseUrl)
                    }
                }, {
        ...
        var o = function(e) {
            ...
            return function(e, t) {
                ...
                value: function(e, t, l, a) {
                    this.moduleRelativeURL = baseUrl, this.table = e, this.tab = null == t ? e : t, this.filter = null == l ? null : l, this.origFilter = this.filter, this.orderBy = null == a ? null : a, this.trackEvent("initAdapter", t), this.requestCache = new r.default
                }
            }, {
                key: "setFilter",
                value: function(e) {
                ...
                value: function(e) {
                    ...
                    return r = (r = (r = (r = (r = r + "?t=" + this.table) + "&sm=" + this.fixJSON(t)) + "&cl=" + this.fixJSON(l)) + "&ft=" + this.fixJSON(a)) + "&ob=" + i, this.isSubProfileTable() && (r += "&type=sub"), this.remoteTableSkipProfileRestriction() && (r += "&skip=1"), r
                }
            }, {
                key: "isSubProfileTable",
                value: function() {
                        ...
                        var l = function(e) {
                                ...
                                if (jQuery.inArray(r, t.inputTypes) >= 0) {
                                    ...
                                    var s = e.attr("validation"),
                                        u = !1;
                                    void 0 !== s && null != s && void 0 !== t.validator[s] && null != t.validator[s] ? u = t.validator[s](l) : (u = !t.validateAll || (void 0 !== s && null != s && "none" === s || t.validator.input(l)), t.formObject[i] = l), u ? (t.clearError(e, null), t.formObject[i] = l) : t.addError(e, null)
                                }
                            },
                            a = $("#" + this.formId + " :input");
            ...
            return i(e, [{
                ...
                value: function(e, t, l) {
                    ...
                    var i = this.getFormFields(),
                        r = this.getFilters();
                    if (null != r)
                        for (var n = 0; n < r.length; n++)(null == (a = this.getMetaFieldValues(r[n][0], i)) || "select" !== a.type && "select2" !== a.type && "select2multi" !== a.type) && i.push(r[n]);
                ...
                value: function(e, t, l, a, i, r) {
                    var n = this,
                        o = "#yesnoModel";
                    void 0 !== t && null != t || (t = ""), $(o + "Label").html(e), $(o + "Body").html(t), null != l && $(o + "YesBtn").html(l), null != a && $(o + "NoBtn").html(a), $(o + "YesBtn").off().on("click", function() {
                    ...
                    for (var u in null == i && (i = []), e)
                        if (e.hasOwnProperty(u)) {
                            if (n = "", o = null, "select" === (i = this.getMetaFieldValues(u, s)).type || "select2" === i.type) {
                                if (void 0 !== i["remote-source"] && null != i["remote-source"]) l = i["remote-source"], "NULL" === e[u] ? n = void 0 !== i["null-label"] && null != i["null-label"] ? i["null-label"] : "Not Selected" : o = n = this.fieldMasterData[l[0] + "_" + l[1] + "_" + l[2]][e[u]];
                ...
                value: function(e) {
                    ...
                    this.showFormOnPopup ? (s = $('<div class="reviewBlock popupForm" data-content="Form"></div>')).attr("id", u) : s = $("#" + this.getTableName() + "Form"), s.html(l), s.find(".datefield").datepicker({
                        viewMode: 2
                    }), s.find(".timefield").datetimepicker({
                        language: "en",
                        pickDate: !1
                ...
                value: function(e, t) {
                    ...
                    o.attr("id", n), o.html(l), o.find(".datefield").datepicker({
                        viewMode: 2
                ...
                value: function() {
                    ...
                    if (l.checkValues()) {
                        ...
                        if (this.doCustomFilterValidation(a)) {
                            ...
                            var h = this.dataGroupToHtml(r, e);
                    ...
                    for (var i = 0; i < l.length; i++)
                        ...
                        if ("0000-00-00 00:00:00" !== e[l[i][0]] && "" !== e[l[i][0]] && null != e[l[i][0]] && void 0 !== e[l[i][0]]) {
                            var r = e[l[i][0]].split(" "),
                                n = r[0].split("-"),
                                o = r[1].split(":");
                            $(t + " #" + l[i][0] + "_datetime").data("datetimepicker").setLocalDate(new Date(n[0], parseInt(n[1], 10) - 1, n[2], o[0], o[1], o[2]))
                        }
                        ...
                        var c = $(t + " #" + l[i][0]).find(".select2-choices").height();
                        $(t + " #" + l[i][0]).find(".controls").css("min-height", c + "px"), $(t + " #" + l[i][0]).css("min-height", c + "px")
                    } else if ("datagroup" === l[i][1].type) try {
                        var d = this.dataGroupToHtml(e[l[i][0]], l[i]);
                        $(t + " #" + l[i][0]).val(e[l[i][0]]), $(t + " #" + l[i][0] + "_div").html(""), $(t + " #" + l[i][0] + "_div").append(d), this.makeDataGroupSortable(l[i], $(t + " #" + l[i][0] + "_div_inner"))
    ...
    6: [function(e, t, l) {
        "use strict";
        var a = e("./lib");
        window.EmployeeFormAdapter = a.EmployeeFormAdapter
    }, {
        "./lib": 7
    }],
    7: [function(e, t, l) {
        ...
        var r = function(e) {
            ...
            return function(e, t) {
            ...
            }(t, i.EmployeeFormAdminAdapter), a(t, [{
                key: "getDataMapping",
                value: function() {
                    return ["id", "form", "status"]
                }
            }, {
                key: "getHeaders",
                value: function() {
                ...
                key: "getActionButtonsHtml",
                value: function(e, t) {
                    var l = '<div style="width:80px;">_configure_</div>';
                    return this.showConfigure = !0, l = (l = (l = this.showConfigure ? l.replace("_configure_", '<img class="tableActionButton" src="_BASE_images/run.png" style="margin-left:15px;cursor:pointer;" rel="tooltip" title="Fill Form" onclick="modJs.showConfigView(\'_id_\');return false;"></img>') : l.replace("_configure_", "")).replace(/_id_/g, e)).replace(/_BASE_/g, this.baseUrl)
                }
            }, {
                key: "forceInjectValuesBeforeSave",
                value: function(e) {
        ...
        t.exports = {
            EmployeeFormAdapter: r
        }
    }, {
        "../../../admin/src/forms/lib": 1
    }]
}, {}, [6]);
