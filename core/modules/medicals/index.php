...
modJsList['tabStaffMedical'] = new StaffMedicalAdapter('StaffMedical','StaffMedicals');
modJsList['tabStaffMedical'].setRemoteTable(true);
modJsList['tabDependantMedical'] = new DependantMedicalAdapter('DependantMedical','DependantMedicals');
