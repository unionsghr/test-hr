...
class PayrollReportPermanent extends ClassBasedReportBuilder implements ReportBuilderInterface
...
// class PayrollReport extends ReportBuilder
{
    ...
    public function getData($report, $request)
    {
        ...
        $customFieldsList = BaseService::getInstance()->getCustomFields('Salaries_permanent');
        ...
        $entries = BaseService::getInstance()->get('Salaries_permanent', null, $filters);
    ...
    // LogManager::getInstance()->info("=========>".implode(",", $entries)."<========");
        ...
        foreach ($entries as $item) {
            ...
            $item =  BaseService::getInstance()->enrichObjectCustomFields('Salaries_permanent', $item);
            $data[] = $item;
        }
