					...
					<form id="loginForm" action="login.php" method="POST">
						...
						<fieldset>
							...
							<?php if (isset($_REQUEST['f'])) {?>
								<div class="clearfix alert alert-error" style="font-size:15px;width:147px;margin-bottom: 10px;">
									Login failed
							...
							<?php if (isset($_REQUEST['c'])) {?>
								<div class="clearfix alert alert-info" style="font-size:15px;width:147px;margin-bottom: 10px;">
					...
					<form id="requestPasswordChangeForm" style="display:none;" action="">
						<fieldset>
							<div class="clearfix">
								<div class="input-prepend">
									<!-- <span class="add-on"><i class="icon-user"></i></span> -->
									<input class="span2" style="width:80%;font-size:20px;" type="text" id="usernameChange" name="usernameChange" placeholder="Username or Email">
								</div>
							</div>
					...
					<form id="newPasswordForm" action="">
						<fieldset>
							<div class="clearfix">
								<div class="input-prepend">
									<!-- <span class="add-on"><i class="icon-lock"></i></span> -->
									<input class="span2" style="width:73%;font-size:20px;" type="password" id="password" name="password" placeholder="New Password">
								</div>
							</div>
