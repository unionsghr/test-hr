...
function payroll()
{
  ...
  curl_setopt_array($curl, array(
    ...
    CURLOPT_URL => "http://10.93.101.144:9091/core/api/v1.0/account/performBulkPayment",
...
function email()
{
  ...
  $employee_id = $first_name = $middle_name = $last_name = $bank_acc_no = $tin_no = $ssn_num = $nassit_num = $job_title = $pay_grade = $notch = $department = $branch = $email = $username = array();
  ...
  while ($row = mysqli_fetch_assoc($res)) {
    ...
    $branch[] = $row['branch'];
    $payslip_no = $row['documentRef'];

    $basic[] = $row['basic'];
    $car[] = $row['car_allowance'];
    $casual_labour[] = $row['casual_labour'];
  ...
  $casual_labour = array_merge($casual_labour);
  ...
  $query1 = "SELECT * From settings where id = '1'";
  ...
  <div class="salary-slip" >
            <table class="empDetail">
              <tr height="100px" style="background-color: #c2d69b">
                <td colspan="4">
                  <img src="logo11.jpg"/></td>
                <td colspan="4" class="companyName" style = "color:black; text-align:right; padding-right:15%">PAYSLIP FOR ' . $pay_month . '</td>
              </tr>';
    $pdf .= '
              <tr>
                <th>
             ...
             <tr>
              ...
              <tr class="myBackground">
                <th colspan="2" style = "color:#0080B2">
                  PAYMENTS:
      </th>
                <th >
                  ...
                  <th style="text-align: right; color:#0080B2">
                  AMOUNT (SLL)
      </th>
                <th colspan="2" style = "color:#0080B2">
                  DEDUCTIONS:
              ...
              <tr>
                ...
                <td class="myAlign">
                  ' . number_format($casual_labour[$i], 2) . '
      </td>
                <th colspan="2" >
                  Medical Excess
      </th >
              ...
              <tr>
                ...
                <td class="myAlign">
                  ' . number_format($rent[$i], 2) . '
      </td>
              <tr class="myBackground">
                <th colspan="3">
                  Total Payments
      </th>
                <td class="myAlign" style = "font-weight: bold">
    ...
    while ($i <= $email_count) {
      ...
      $subject = "Payslip for " . $pay_month;
      $body = "Dear " . $final_username . "," . "

<p> Be informed that your payslip for " . $pay_month . " is ready. Kindly download the attachment. </p>

<p> You can also Login to Download here: http://localhost/rokel_hrm/app/?g=modules&n=reports&m=module_User_Reports </p>


<p> If you have any questions, do not hesitate to contact HR. </p>

<p> Best regards, </p>
<p> HR - ROKEL COMMERCIAL BANK (SL) LTD </p>

";
      $headers = "From: HR - Rokel Commercial Bank (SL) Ltd";
      $semi_rand = md5(time());
...
/*
        ...
        // echo json_encode($email_count); die();
        ...
        while ($i < $email_count) {
            ...
            // echo $pay_month; die();
            $final_username = $username[$i];
            // echo json_encode($email)." ". json_encode($username); die();
            # code...
            $file = $pdf_file_url;
            $to_email = $final_email;
            $subject = "Monthly Payslip";
            $body = "Dear " . $first_name[$i] . " " . $middle_name[$i] . " " . $last_name[$i] . "," . "


<p> Please be informed that your payslip for " . $pay_month . " is ready. Kindly download the attachment. </p>

<p> You can also Login to Download using this link: http://localhost/rokel_hrm/app/?g=modules&n=reports&m=module_User_Reports </p>


<p> If you have any questions, do not hesitate to contact HR. </p>

<p> Best Regards, </p>
<p> HR - ROKEL COMMERCIAL BANK. </p>

";
            $headers = "From: HR - Rokel Commercial Bank";
            $semi_rand = md5(time());
            $mime_boundary = "==Multipart_Boundary_x{$semi_rand}x";
