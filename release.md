 ...
 * Support for Serbian, Swedish, Portuguese, Norwegian and Dutch languages
...
------------------------
### Features
 * Support multiple leave groups ([more info](https://thilinah.gitbooks.io/icehrm-guide/content/advanced-leave-policy.html))
 ...
 * Unlimited leave carry forwarding
